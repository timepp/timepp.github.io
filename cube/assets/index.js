...
void main() {
	...
	`}function fv(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,u=l===Aa||l===wa,h=l===wr||l===Rr;if(u||h)if(o.isRenderTargetTexture&&o.needsPMREMUpdate===!0){o.needsPMREMUpdate=!1;let d=e.get(o);return t===null&&(t=new hu(i)),d=u?t.fromEquirectangular(o,d):t.fromCubemap(o,d),e.set(o,d),d.texture}else{if(e.has(o))return e.get(o).texture;{const d=o.image;if(u&&d&&d.height>0||h&&d&&r(d)){t===null&&(t=new hu(i));const f=u?t.fromEquirectangular(o):t.fromCubemap(o);return e.set(o,f),o.addEventListener("dispose",s),f.texture}else return null}}}return o}function r(o){let l=0;const u=6;for(let h=0;h<u;h++)o[h]!==void 0&&l++;return l===u}function s(o){const l=o.target;l.removeEventListener("dispose",s);const u=e.get(l);u!==void 0&&(e.delete(l),u.dispose())}function c(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:c}}function pv(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?t("EXT_color_buffer_float"):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const r=t(n);return r===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function mv(i,e,t,n){const r={},s=new WeakMap;function c(d){const f=d.target;f.index!==null&&e.remove(f.index);for(const v in f.attributes)e.remove(f.attributes[v]);for(const v in f.morphAttributes){const M=f.morphAttributes[v];for(let g=0,m=M.length;g<m;g++)e.remove(M[g])}f.removeEventListener("dispose",c),delete r[f.id];const _=s.get(f);_&&(e.remove(_),s.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(d,f){return r[f.id]===!0||(f.addEventListener("dispose",c),r[f.id]=!0,t.memory.geometries++),f}function l(d){const f=d.attributes;for(const v in f)e.update(f[v],i.ARRAY_BUFFER);const _=d.morphAttributes;for(const v in _){const M=_[v];for(let g=0,m=M.length;g<m;g++)e.update(M[g],i.ARRAY_BUFFER)}}function u(d){const f=[],_=d.index,v=d.attributes.position;let M=0;if(_!==null){const D=_.array;M=_.version;for(let T=0,C=D.length;T<C;T+=3){const A=D[T+0],L=D[T+1],w=D[T+2];f.push(A,L,L,w,w,A)}}else if(v!==void 0){const D=v.array;M=v.version;for(let T=0,C=D.length/3-1;T<C;T+=3){const A=T+0,L=T+1,w=T+2;f.push(A,L,L,w,w,A)}}else return;const g=new(rh(f)?dh:hh)(f,1);g.version=M;const m=s.get(d);m&&e.remove(m),s.set(d,g)}function h(d){const f=s.get(d);if(f){const _=d.index;_!==null&&f.version<_.version&&u(d)}else u(d);return s.get(d)}return{get:o,update:l,getWireframeAttribute:h}}function gv(i,e,t,n){const r=n.isWebGL2;let s;function c(f){s=f}let o,l;function u(f){o=f.type,l=f.bytesPerElement}function h(f,_){i.drawElements(s,_,o,f*l),t.update(_,s,1)}function d(f,_,v){if(v===0)return;let M,g;if(r)M=i,g="drawElementsInstanced";else if(M=e.get("ANGLE_instanced_arrays"),g="drawElementsInstancedANGLE",M===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}M[g](s,_,o,f*l,v),t.update(_,s,v)}this.setMode=c,this.setIndex=u,this.render=h,this.renderInstances=d}function _v(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,c,o){switch(t.calls++,c){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",c);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function vv(i,e){return i[0]-e[0]}function xv(i,e){return Math.abs(e[1])-Math.abs(i[1])}function Mv(i,e,t){const n={},r=new Float32Array(8),s=new WeakMap,c=new zt,o=[];for(let u=0;u<8;u++)o[u]=[u,0];function l(u,h,d){const f=u.morphTargetInfluences;if(e.isWebGL2===!0){const v=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,M=v!==void 0?v.length:0;let g=s.get(h);if(g===void 0||g.count!==M){let $=function(){G.dispose(),s.delete(h),h.removeEventListener("dispose",$)};var _=$;g!==void 0&&g.texture.dispose();const T=h.morphAttributes.position!==void 0,C=h.morphAttributes.normal!==void 0,A=h.morphAttributes.color!==void 0,L=h.morphAttributes.position||[],w=h.morphAttributes.normal||[],N=h.morphAttributes.color||[];let y=0;T===!0&&(y=1),C===!0&&(y=2),A===!0&&(y=3);let S=h.attributes.position.count*y,V=1;S>e.maxTextureSize&&(V=Math.ceil(S/e.maxTextureSize),S=e.maxTextureSize);const Z=new Float32Array(S*V*4*M),G=new ah(Z,S,V,M);G.type=mi,G.needsUpdate=!0;const j=y*4;for(let re=0;re<M;re++){const H=L[re],U=w[re],se=N[re],ie=S*V*4*re;for(let Y=0;Y<H.count;Y++){const ee=Y*j;T===!0&&(c.fromBufferAttribute(H,Y),Z[ie+ee+0]=c.x,Z[ie+ee+1]=c.y,Z[ie+ee+2]=c.z,Z[ie+ee+3]=0),C===!0&&(c.fromBufferAttribute(U,Y),Z[ie+ee+4]=c.x,Z[ie+ee+5]=c.y,Z[ie+ee+6]=c.z,Z[ie+ee+7]=0),A===!0&&(c.fromBufferAttribute(se,Y),Z[ie+ee+8]=c.x,Z[ie+ee+9]=c.y,Z[ie+ee+10]=c.z,Z[ie+ee+11]=se.itemSize===4?c.w:1)}}g={count:M,texture:G,size:new Re(S,V)},s.set(h,g),h.addEventListener("dispose",$)}let m=0;for(let T=0;T<f.length;T++)m+=f[T];const D=h.morphTargetsRelative?1:1-m;d.getUniforms().setValue(i,"morphTargetBaseInfluence",D),d.getUniforms().setValue(i,"morphTargetInfluences",f),d.getUniforms().setValue(i,"morphTargetsTexture",g.texture,t),d.getUniforms().setValue(i,"morphTargetsTextureSize",g.size)}else{const v=f===void 0?0:f.length;let M=n[h.id];if(M===void 0||M.length!==v){M=[];for(let C=0;C<v;C++)M[C]=[C,0];n[h.id]=M}for(let C=0;C<v;C++){const A=M[C];A[0]=C,A[1]=f[C]}M.sort(xv);for(let C=0;C<8;C++)C<v&&M[C][1]?(o[C][0]=M[C][0],o[C][1]=M[C][1]):(o[C][0]=Number.MAX_SAFE_INTEGER,o[C][1]=0);o.sort(vv);const g=h.morphAttributes.position,m=h.morphAttributes.normal;let D=0;for(let C=0;C<8;C++){const A=o[C],L=A[0],w=A[1];L!==Number.MAX_SAFE_INTEGER&&w?(g&&h.getAttribute("morphTarget"+C)!==g[L]&&h.setAttribute("morphTarget"+C,g[L]),m&&h.getAttribute("morphNormal"+C)!==m[L]&&h.setAttribute("morphNormal"+C,m[L]),r[C]=w,D+=w):(g&&h.hasAttribute("morphTarget"+C)===!0&&h.deleteAttribute("morphTarget"+C),m&&h.hasAttribute("morphNormal"+C)===!0&&h.deleteAttribute("morphNormal"+C),r[C]=0)}const T=h.morphTargetsRelative?1:1-D;d.getUniforms().setValue(i,"morphTargetBaseInfluence",T),d.getUniforms().setValue(i,"morphTargetInfluences",r)}}return{update:l}}function yv(i,e,t,n){let r=new WeakMap;function s(l){const u=n.render.frame,h=l.geometry,d=e.get(l,h);if(r.get(d)!==u&&(e.update(d),r.set(d,u)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==u&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,u))),l.isSkinnedMesh){const f=l.skeleton;r.get(f)!==u&&(f.update(),r.set(f,u))}return d}function c(){r=new WeakMap}function o(l){const u=l.target;u.removeEventListener("dispose",o),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:s,dispose:c}}const vh=new on,xh=new ah,Mh=new am,yh=new mh,mu=[],gu=[],_u=new Float32Array(16),vu=new Float32Array(9),xu=new Float32Array(4);function Ur(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=mu[r];if(s===void 0&&(s=new Float32Array(r),mu[r]=s),e!==0){n.toArray(s,0);for(let c=1,o=0;c!==e;++c)o+=t,i[c].toArray(s,o)}return s}function It(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Nt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function mo(i,e){let t=gu[e];t===void 0&&(t=new Int32Array(e),gu[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Ev(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Sv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(It(t,e))return;i.uniform2fv(this.addr,e),Nt(t,e)}}function bv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(It(t,e))return;i.uniform3fv(this.addr,e),Nt(t,e)}}function Tv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(It(t,e))return;i.uniform4fv(this.addr,e),Nt(t,e)}}function Av(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(It(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Nt(t,e)}else{if(It(t,n))return;xu.set(n),i.uniformMatrix2fv(this.addr,!1,xu),Nt(t,n)}}function wv(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(It(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Nt(t,e)}else{if(It(t,n))return;vu.set(n),i.uniformMatrix3fv(this.addr,!1,vu),Nt(t,n)}}function Rv(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(It(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Nt(t,e)}else{if(It(t,n))return;_u.set(n),i.uniformMatrix4fv(this.addr,!1,_u),Nt(t,n)}}function Cv(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Lv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(It(t,e))return;i.uniform2iv(this.addr,e),Nt(t,e)}}function Pv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(It(t,e))return;i.uniform3iv(this.addr,e),Nt(t,e)}}function Dv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(It(t,e))return;i.uniform4iv(this.addr,e),Nt(t,e)}}function Uv(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Iv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(It(t,e))return;i.uniform2uiv(this.addr,e),Nt(t,e)}}function Nv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(It(t,e))return;i.uniform3uiv(this.addr,e),Nt(t,e)}}function Ov(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(It(t,e))return;i.uniform4uiv(this.addr,e),Nt(t,e)}}function Fv(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2D(e||vh,r)}function Bv(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Mh,r)}function zv(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||yh,r)}function Hv(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||xh,r)}function kv(i){switch(i){case 5126:return Ev;case 35664:return Sv;case 35665:return bv;case 35666:return Tv;case 35674:return Av;case 35675:return wv;case 35676:return Rv;case 5124:case 35670:return Cv;case 35667:case 35671:return Lv;case 35668:case 35672:return Pv;case 35669:case 35673:return Dv;case 5125:return Uv;case 36294:return Iv;case 36295:return Nv;case 36296:return Ov;case 35678:case 36198:case 36298:case 36306:case 35682:return Fv;case 35679:case 36299:case 36307:return Bv;case 35680:case 36300:case 36308:case 36293:return zv;case 36289:case 36303:case 36311:case 36292:return Hv}}function Gv(i,e){i.uniform1fv(this.addr,e)}function Vv(i,e){const t=Ur(e,this.size,2);i.uniform2fv(this.addr,t)}function Wv(i,e){const t=Ur(e,this.size,3);i.uniform3fv(this.addr,t)}function Xv(i,e){const t=Ur(e,this.size,4);i.uniform4fv(this.addr,t)}function qv(i,e){const t=Ur(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Yv(i,e){const t=Ur(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function jv(i,e){const t=Ur(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function $v(i,e){i.uniform1iv(this.addr,e)}function Kv(i,e){i.uniform2iv(this.addr,e)}function Zv(i,e){i.uniform3iv(this.addr,e)}function Jv(i,e){i.uniform4iv(this.addr,e)}function Qv(i,e){i.uniform1uiv(this.addr,e)}function e0(i,e){i.uniform2uiv(this.addr,e)}function t0(i,e){i.uniform3uiv(this.addr,e)}function n0(i,e){i.uniform4uiv(this.addr,e)}function i0(i,e,t){const n=this.cache,r=e.length,s=mo(t,r);It(n,s)||(i.uniform1iv(this.addr,s),Nt(n,s));for(let c=0;c!==r;++c)t.setTexture2D(e[c]||vh,s[c])}function r0(i,e,t){const n=this.cache,r=e.length,s=mo(t,r);It(n,s)||(i.uniform1iv(this.addr,s),Nt(n,s));for(let c=0;c!==r;++c)t.setTexture3D(e[c]||Mh,s[c])}function s0(i,e,t){const n=this.cache,r=e.length,s=mo(t,r);It(n,s)||(i.uniform1iv(this.addr,s),Nt(n,s));for(let c=0;c!==r;++c)t.setTextureCube(e[c]||yh,s[c])}function o0(i,e,t){const n=this.cache,r=e.length,s=mo(t,r);It(n,s)||(i.uniform1iv(this.addr,s),Nt(n,s));for(let c=0;c!==r;++c)t.setTexture2DArray(e[c]||xh,s[c])}function a0(i){switch(i){case 5126:return Gv;case 35664:return Vv;case 35665:return Wv;case 35666:return Xv;case 35674:return qv;case 35675:return Yv;case 35676:return jv;case 5124:case 35670:return $v;case 35667:case 35671:return Kv;case 35668:case 35672:return Zv;case 35669:case 35673:return Jv;case 5125:return Qv;case 36294:return e0;case 36295:return t0;case 36296:return n0;case 35678:case 36198:case 36298:case 36306:case 35682:return i0;case 35679:case 36299:case 36307:return r0;case 35680:case 36300:case 36308:case 36293:return s0;case 36289:case 36303:case 36311:case 36292:return o0}}class c0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.setValue=kv(t.type)}}class l0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.size=t.size,this.setValue=a0(t.type)}}class u0{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,c=r.length;s!==c;++s){const o=r[s];o.setValue(e,t[o.id],n)}}}const ga=/(\w+)(\])?(\[|\.)?/g;function Mu(i,e){i.seq.push(e),i.map[e.id]=e}function h0(i,e,t){const n=i.name,r=n.length;for(ga.lastIndex=0;;){const s=ga.exec(n),c=ga.lastIndex;let o=s[1];const l=s[2]==="]",u=s[3];if(l&&(o=o|0),u===void 0||u==="["&&c+2===r){Mu(t,u===void 0?new c0(o,i,e):new l0(o,i,e));break}else{let d=t.map[o];d===void 0&&(d=new u0(o),Mu(t,d)),t=d}}}class to{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),c=e.getUniformLocation(t,s.name);h0(s,c,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,c=t.length;s!==c;++s){const o=t[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const c=e[r];c.id in t&&n.push(c)}return n}}function yu(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}let d0=0;function f0(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let c=r;c<s;c++){const o=c+1;n.push(`${o===e?">":" "} ${o}: ${t[c]}`)}return n.join(`
`)}function p0(i){switch(i){case Bn:return["Linear","( value )"];case Et:return["sRGB","( value )"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),["Linear","( value )"]}}function Eu(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const c=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+f0(i.getShaderSource(e),c)}else return r}function m0(i,e){const t=p0(e);return"vec4 "+i+"( vec4 value ) { return LinearTo"+t[0]+t[1]+"; }"}function g0(i,e){let t;switch(e){case cp:t="Linear";break;case lp:t="Reinhard";break;case up:t="OptimizedCineon";break;case hp:t="ACESFilmic";break;case dp:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function _0(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Xr).join(`
`)}function v0(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function x0(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),c=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),t[c]={type:s.type,location:i.getAttribLocation(e,c),locationSize:o}}return t}function Xr(i){return i!==""}function Su(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function bu(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const M0=/^[ \t]*#include +<([\w\d./]+)>/gm;function Da(i){return i.replace(M0,E0)}const y0=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function E0(i,e){let t=Je[e];if(t===void 0){const n=y0.get(e);if(n!==void 0)t=Je[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Da(t)}const S0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Tu(i){return i.replace(S0,b0)}function b0(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Au(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function T0(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===qu?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Hf?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Kn&&(e="SHADOWMAP_TYPE_VSM"),e}function A0(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case wr:case Rr:e="ENVMAP_TYPE_CUBE";break;case uo:e="ENVMAP_TYPE_CUBE_UV";break}return e}function w0(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Rr:e="ENVMAP_MODE_REFRACTION";break}return e}function R0(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case $u:e="ENVMAP_BLENDING_MULTIPLY";break;case op:e="ENVMAP_BLENDING_MIX";break;case ap:e="ENVMAP_BLENDING_ADD";break}return e}function C0(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function L0(i,e,t,n){const r=i.getContext(),s=t.defines;let c=t.vertexShader,o=t.fragmentShader;const l=T0(t),u=A0(t),h=w0(t),d=R0(t),f=C0(t),_=t.isWebGL2?"":_0(t),v=v0(s),M=r.createProgram();let g,m,D=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+m);const T=D+g+c,C=D+m+o,A=yu(r,r.VERTEX_SHADER,T),L=yu(r,r.FRAGMENT_SHADER,C);if(r.attachShader(M,A),r.attachShader(M,L),t.index0AttributeName!==void 0?r.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M),i.debug.checkShaderErrors){const y=r.getProgramInfoLog(M).trim(),S=r.getShaderInfoLog(A).trim(),V=r.getShaderInfoLog(L).trim();let Z=!0,G=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,M,A,L);else{const j=Eu(r,A,"vertex"),$=Eu(r,L,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`

Program Info Log: `+y+`
`+j+`
`+$)}else y!==""?console.warn("THREE.WebGLProgram: Program Info Log:",y):(S===""||V==="")&&(G=!1);G&&(this.diagnostics={runnable:Z,programLog:y,vertexShader:{log:S,prefix:g},fragmentShader:{log:V,prefix:m}})}r.deleteShader(A),r.deleteShader(L);let w;this.getUniforms=function(){return w===void 0&&(w=new to(r,M)),w};let N;return this.getAttributes=function(){return N===void 0&&(N=x0(r,M)),N},this.destroy=function(){n.releaseStatesOfProgram(this),r.deleteProgram(M),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=d0++,this.cacheKey=e,this.usedTimes=1,this.program=M,this.vertexShader=A,this.fragmentShader=L,this}let P0=0;class D0{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(n),c=this._getShaderCacheForMaterial(e);return c.has(r)===!1&&(c.add(r),r.usedTimes++),c.has(s)===!1&&(c.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new U0(e),t.set(e,n)),n}}class U0{constructor(e){this.id=P0++,this.code=e,this.usedTimes=0}}function I0(i,e,t,n,r,s,c){const o=new lh,l=new D0,u=[],h=r.isWebGL2,d=r.logarithmicDepthBuffer,f=r.vertexTextures;let _=r.precision;const v={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function M(y){return y===0?"uv":`uv${y}`}function g(y,S,V,Z,G){const j=Z.fog,$=G.geometry,re=y.isMeshStandardMaterial?Z.environment:null,H=(y.isMeshStandardMaterial?t:e).get(y.envMap||re),U=H&&H.mapping===uo?H.image.height:null,se=v[y.type];y.precision!==null&&(_=r.getMaxPrecision(y.precision),_!==y.precision&&console.warn("THREE.WebGLProgram.getParameters:",y.precision,"not supported, using",_,"instead."));const ie=$.morphAttributes.position||$.morphAttributes.normal||$.morphAttributes.color,Y=ie!==void 0?ie.length:0;let ee=0;$.morphAttributes.position!==void 0&&(ee=1),$.morphAttributes.normal!==void 0&&(ee=2),$.morphAttributes.color!==void 0&&(ee=3);let ve,_e,Te,ce;if(se){const mt=On[se];ve=mt.vertexShader,_e=mt.fragmentShader}else ve=y.vertexShader,_e=y.fragmentShader,l.update(y),Te=l.getVertexShaderID(y),ce=l.getFragmentShaderID(y);const Ue=i.getRenderTarget(),De=G.isInstancedMesh===!0,rt=!!y.map,Dt=!!y.matcap,He=!!H,W=!!y.aoMap,Mt=!!y.lightMap,Le=!!y.bumpMap,Ge=!!y.normalMap,Be=!!y.displacementMap,pt=!!y.emissiveMap,$e=!!y.metalnessMap,Ve=!!y.roughnessMap,st=y.anisotropy>0,Rt=y.clearcoat>0,St=y.iridescence>0,P=y.sheen>0,b=y.transmission>0,q=st&&!!y.anisotropyMap,ue=Rt&&!!y.clearcoatMap,le=Rt&&!!y.clearcoatNormalMap,de=Rt&&!!y.clearcoatRoughnessMap,Ce=St&&!!y.iridescenceMap,fe=St&&!!y.iridescenceThicknessMap,J=P&&!!y.sheenColorMap,I=P&&!!y.sheenRoughnessMap,oe=!!y.specularMap,Ee=!!y.specularColorMap,me=!!y.specularIntensityMap,ye=b&&!!y.transmissionMap,ze=b&&!!y.thicknessMap,Ke=!!y.gradientMap,O=!!y.alphaMap,xe=y.alphaTest>0,Q=!!y.alphaHash,he=!!y.extensions,pe=!!$.attributes.uv1,Qe=!!$.attributes.uv2,it=!!$.attributes.uv3;let at=_i;return y.toneMapped&&(Ue===null||Ue.isXRRenderTarget===!0)&&(at=i.toneMapping),{isWebGL2:h,shaderID:se,shaderType:y.type,shaderName:y.name,vertexShader:ve,fragmentShader:_e,defines:y.defines,customVertexShaderID:Te,customFragmentShaderID:ce,isRawShaderMaterial:y.isRawShaderMaterial===!0,glslVersion:y.glslVersion,precision:_,instancing:De,instancingColor:De&&G.instanceColor!==null,supportsVertexTextures:f,outputColorSpace:Ue===null?i.outputColorSpace:Ue.isXRRenderTarget===!0?Ue.texture.colorSpace:Bn,map:rt,matcap:Dt,envMap:He,envMapMode:He&&H.mapping,envMapCubeUVHeight:U,aoMap:W,lightMap:Mt,bumpMap:Le,normalMap:Ge,displacementMap:f&&Be,emissiveMap:pt,normalMapObjectSpace:Ge&&y.normalMapType===Ap,normalMapTangentSpace:Ge&&y.normalMapType===Tp,metalnessMap:$e,roughnessMap:Ve,anisotropy:st,anisotropyMap:q,clearcoat:Rt,clearcoatMap:ue,clearcoatNormalMap:le,clearcoatRoughnessMap:de,iridescence:St,iridescenceMap:Ce,iridescenceThicknessMap:fe,sheen:P,sheenColorMap:J,sheenRoughnessMap:I,specularMap:oe,specularColorMap:Ee,specularIntensityMap:me,transmission:b,transmissionMap:ye,thicknessMap:ze,gradientMap:Ke,opaque:y.transparent===!1&&y.blending===Er,alphaMap:O,alphaTest:xe,alphaHash:Q,combine:y.combine,mapUv:rt&&M(y.map.channel),aoMapUv:W&&M(y.aoMap.channel),lightMapUv:Mt&&M(y.lightMap.channel),bumpMapUv:Le&&M(y.bumpMap.channel),normalMapUv:Ge&&M(y.normalMap.channel),displacementMapUv:Be&&M(y.displacementMap.channel),emissiveMapUv:pt&&M(y.emissiveMap.channel),metalnessMapUv:$e&&M(y.metalnessMap.channel),roughnessMapUv:Ve&&M(y.roughnessMap.channel),anisotropyMapUv:q&&M(y.anisotropyMap.channel),clearcoatMapUv:ue&&M(y.clearcoatMap.channel),clearcoatNormalMapUv:le&&M(y.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:de&&M(y.clearcoatRoughnessMap.channel),iridescenceMapUv:Ce&&M(y.iridescenceMap.channel),iridescenceThicknessMapUv:fe&&M(y.iridescenceThicknessMap.channel),sheenColorMapUv:J&&M(y.sheenColorMap.channel),sheenRoughnessMapUv:I&&M(y.sheenRoughnessMap.channel),specularMapUv:oe&&M(y.specularMap.channel),specularColorMapUv:Ee&&M(y.specularColorMap.channel),specularIntensityMapUv:me&&M(y.specularIntensityMap.channel),transmissionMapUv:ye&&M(y.transmissionMap.channel),thicknessMapUv:ze&&M(y.thicknessMap.channel),alphaMapUv:O&&M(y.alphaMap.channel),vertexTangents:!!$.attributes.tangent&&(Ge||st),vertexColors:y.vertexColors,vertexAlphas:y.vertexColors===!0&&!!$.attributes.color&&$.attributes.color.itemSize===4,vertexUv1s:pe,vertexUv2s:Qe,vertexUv3s:it,pointsUvs:G.isPoints===!0&&!!$.attributes.uv&&(rt||O),fog:!!j,useFog:y.fog===!0,fogExp2:j&&j.isFogExp2,flatShading:y.flatShading===!0,sizeAttenuation:y.sizeAttenuation===!0,logarithmicDepthBuffer:d,skinning:G.isSkinnedMesh===!0,morphTargets:$.morphAttributes.position!==void 0,morphNormals:$.morphAttributes.normal!==void 0,morphColors:$.morphAttributes.color!==void 0,morphTargetsCount:Y,morphTextureStride:ee,numDirLights:S.directional.length,numPointLights:S.point.length,numSpotLights:S.spot.length,numSpotLightMaps:S.spotLightMap.length,numRectAreaLights:S.rectArea.length,numHemiLights:S.hemi.length,numDirLightShadows:S.directionalShadowMap.length,numPointLightShadows:S.pointShadowMap.length,numSpotLightShadows:S.spotShadowMap.length,numSpotLightShadowsWithMaps:S.numSpotLightShadowsWithMaps,numClippingPlanes:c.numPlanes,numClipIntersection:c.numIntersection,dithering:y.dithering,shadowMapEnabled:i.shadowMap.enabled&&V.length>0,shadowMapType:i.shadowMap.type,toneMapping:at,useLegacyLights:i._useLegacyLights,decodeVideoTexture:rt&&y.map.isVideoTexture===!0&&y.map.colorSpace===Et,premultipliedAlpha:y.premultipliedAlpha,doubleSided:y.side===Jn,flipSided:y.side===sn,useDepthPacking:y.depthPacking>=0,depthPacking:y.depthPacking||0,index0AttributeName:y.index0AttributeName,extensionDerivatives:he&&y.extensions.derivatives===!0,extensionFragDepth:he&&y.extensions.fragDepth===!0,extensionDrawBuffers:he&&y.extensions.drawBuffers===!0,extensionShaderTextureLOD:he&&y.extensions.shaderTextureLOD===!0,rendererExtensionFragDepth:h||n.has("EXT_frag_depth"),rendererExtensionDrawBuffers:h||n.has("WEBGL_draw_buffers"),rendererExtensionShaderTextureLod:h||n.has("EXT_shader_texture_lod"),customProgramCacheKey:y.customProgramCacheKey()}}function m(y){const S=[];if(y.shaderID?S.push(y.shaderID):(S.push(y.customVertexShaderID),S.push(y.customFragmentShaderID)),y.defines!==void 0)for(const V in y.defines)S.push(V),S.push(y.defines[V]);return y.isRawShaderMaterial===!1&&(D(S,y),T(S,y),S.push(i.outputColorSpace)),S.push(y.customProgramCacheKey),S.join()}function D(y,S){y.push(S.precision),y.push(S.outputColorSpace),y.push(S.envMapMode),y.push(S.envMapCubeUVHeight),y.push(S.mapUv),y.push(S.alphaMapUv),y.push(S.lightMapUv),y.push(S.aoMapUv),y.push(S.bumpMapUv),y.push(S.normalMapUv),y.push(S.displacementMapUv),y.push(S.emissiveMapUv),y.push(S.metalnessMapUv),y.push(S.roughnessMapUv),y.push(S.anisotropyMapUv),y.push(S.clearcoatMapUv),y.push(S.clearcoatNormalMapUv),y.push(S.clearcoatRoughnessMapUv),y.push(S.iridescenceMapUv),y.push(S.iridescenceThicknessMapUv),y.push(S.sheenColorMapUv),y.push(S.sheenRoughnessMapUv),y.push(S.specularMapUv),y.push(S.specularColorMapUv),y.push(S.specularIntensityMapUv),y.push(S.transmissionMapUv),y.push(S.thicknessMapUv),y.push(S.combine),y.push(S.fogExp2),y.push(S.sizeAttenuation),y.push(S.morphTargetsCount),y.push(S.morphAttributeCount),y.push(S.numDirLights),y.push(S.numPointLights),y.push(S.numSpotLights),y.push(S.numSpotLightMaps),y.push(S.numHemiLights),y.push(S.numRectAreaLights),y.push(S.numDirLightShadows),y.push(S.numPointLightShadows),y.push(S.numSpotLightShadows),y.push(S.numSpotLightShadowsWithMaps),y.push(S.shadowMapType),y.push(S.toneMapping),y.push(S.numClippingPlanes),y.push(S.numClipIntersection),y.push(S.depthPacking)}function T(y,S){o.disableAll(),S.isWebGL2&&o.enable(0),S.supportsVertexTextures&&o.enable(1),S.instancing&&o.enable(2),S.instancingColor&&o.enable(3),S.matcap&&o.enable(4),S.envMap&&o.enable(5),S.normalMapObjectSpace&&o.enable(6),S.normalMapTangentSpace&&o.enable(7),S.clearcoat&&o.enable(8),S.iridescence&&o.enable(9),S.alphaTest&&o.enable(10),S.vertexColors&&o.enable(11),S.vertexAlphas&&o.enable(12),S.vertexUv1s&&o.enable(13),S.vertexUv2s&&o.enable(14),S.vertexUv3s&&o.enable(15),S.vertexTangents&&o.enable(16),S.anisotropy&&o.enable(17),y.push(o.mask),o.disableAll(),S.fog&&o.enable(0),S.useFog&&o.enable(1),S.flatShading&&o.enable(2),S.logarithmicDepthBuffer&&o.enable(3),S.skinning&&o.enable(4),S.morphTargets&&o.enable(5),S.morphNormals&&o.enable(6),S.morphColors&&o.enable(7),S.premultipliedAlpha&&o.enable(8),S.shadowMapEnabled&&o.enable(9),S.useLegacyLights&&o.enable(10),S.doubleSided&&o.enable(11),S.flipSided&&o.enable(12),S.useDepthPacking&&o.enable(13),S.dithering&&o.enable(14),S.transmission&&o.enable(15),S.sheen&&o.enable(16),S.opaque&&o.enable(17),S.pointsUvs&&o.enable(18),S.decodeVideoTexture&&o.enable(19),y.push(o.mask)}function C(y){const S=v[y.type];let V;if(S){const Z=On[S];V=Mm.clone(Z.uniforms)}else V=y.uniforms;return V}function A(y,S){let V;for(let Z=0,G=u.length;Z<G;Z++){const j=u[Z];if(j.cacheKey===S){V=j,++V.usedTimes;break}}return V===void 0&&(V=new L0(i,S,y,s),u.push(V)),V}function L(y){if(--y.usedTimes===0){const S=u.indexOf(y);u[S]=u[u.length-1],u.pop(),y.destroy()}}function w(y){l.remove(y)}function N(){l.dispose()}return{getParameters:g,getProgramCacheKey:m,getUniforms:C,acquireProgram:A,releaseProgram:L,releaseShaderCache:w,programs:u,dispose:N}}function N0(){let i=new WeakMap;function e(s){let c=i.get(s);return c===void 0&&(c={},i.set(s,c)),c}function t(s){i.delete(s)}function n(s,c,o){i.get(s)[c]=o}function r(){i=new WeakMap}return{get:e,remove:t,update:n,dispose:r}}function O0(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function wu(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Ru(){const i=[];let e=0;const t=[],n=[],r=[];function s(){e=0,t.length=0,n.length=0,r.length=0}function c(d,f,_,v,M,g){let m=i[e];return m===void 0?(m={id:d.id,object:d,geometry:f,material:_,groupOrder:v,renderOrder:d.renderOrder,z:M,group:g},i[e]=m):(m.id=d.id,m.object=d,m.geometry=f,m.material=_,m.groupOrder=v,m.renderOrder=d.renderOrder,m.z=M,m.group=g),e++,m}function o(d,f,_,v,M,g){const m=c(d,f,_,v,M,g);_.transmission>0?n.push(m):_.transparent===!0?r.push(m):t.push(m)}function l(d,f,_,v,M,g){const m=c(d,f,_,v,M,g);_.transmission>0?n.unshift(m):_.transparent===!0?r.unshift(m):t.unshift(m)}function u(d,f){t.length>1&&t.sort(d||O0),n.length>1&&n.sort(f||wu),r.length>1&&r.sort(f||wu)}function h(){for(let d=e,f=i.length;d<f;d++){const _=i[d];if(_.id===null)break;_.id=null,_.object=null,_.geometry=null,_.material=null,_.group=null}}return{opaque:t,transmissive:n,transparent:r,init:s,push:o,unshift:l,finish:h,sort:u}}function F0(){let i=new WeakMap;function e(n,r){const s=i.get(n);let c;return s===void 0?(c=new Ru,i.set(n,[c])):r>=s.length?(c=new Ru,s.push(c)):c=s[r],c}function t(){i=new WeakMap}return{get:e,dispose:t}}function B0(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new F,color:new _t};break;case"SpotLight":t={position:new F,direction:new F,color:new _t,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new F,color:new _t,distance:0,decay:0};break;case"HemisphereLight":t={direction:new F,skyColor:new _t,groundColor:new _t};break;case"RectAreaLight":t={color:new _t,position:new F,halfWidth:new F,halfHeight:new F};break}return i[e.id]=t,t}}}function z0(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Re};break;case"SpotLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Re};break;case"PointLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Re,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let H0=0;function k0(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function G0(i,e){const t=new B0,n=z0(),r={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0};for(let h=0;h<9;h++)r.probe.push(new F);const s=new F,c=new Pt,o=new Pt;function l(h,d){let f=0,_=0,v=0;for(let V=0;V<9;V++)r.probe[V].set(0,0,0);let M=0,g=0,m=0,D=0,T=0,C=0,A=0,L=0,w=0,N=0;h.sort(k0);const y=d===!0?Math.PI:1;for(let V=0,Z=h.length;V<Z;V++){const G=h[V],j=G.color,$=G.intensity,re=G.distance,H=G.shadow&&G.shadow.map?G.shadow.map.texture:null;if(G.isAmbientLight)f+=j.r*$*y,_+=j.g*$*y,v+=j.b*$*y;else if(G.isLightProbe)for(let U=0;U<9;U++)r.probe[U].addScaledVector(G.sh.coefficients[U],$);else if(G.isDirectionalLight){const U=t.get(G);if(U.color.copy(G.color).multiplyScalar(G.intensity*y),G.castShadow){const se=G.shadow,ie=n.get(G);ie.shadowBias=se.bias,ie.shadowNormalBias=se.normalBias,ie.shadowRadius=se.radius,ie.shadowMapSize=se.mapSize,r.directionalShadow[M]=ie,r.directionalShadowMap[M]=H,r.directionalShadowMatrix[M]=G.shadow.matrix,C++}r.directional[M]=U,M++}else if(G.isSpotLight){const U=t.get(G);U.position.setFromMatrixPosition(G.matrixWorld),U.color.copy(j).multiplyScalar($*y),U.distance=re,U.coneCos=Math.cos(G.angle),U.penumbraCos=Math.cos(G.angle*(1-G.penumbra)),U.decay=G.decay,r.spot[m]=U;const se=G.shadow;if(G.map&&(r.spotLightMap[w]=G.map,w++,se.updateMatrices(G),G.castShadow&&N++),r.spotLightMatrix[m]=se.matrix,G.castShadow){const ie=n.get(G);ie.shadowBias=se.bias,ie.shadowNormalBias=se.normalBias,ie.shadowRadius=se.radius,ie.shadowMapSize=se.mapSize,r.spotShadow[m]=ie,r.spotShadowMap[m]=H,L++}m++}else if(G.isRectAreaLight){const U=t.get(G);U.color.copy(j).multiplyScalar($),U.halfWidth.set(G.width*.5,0,0),U.halfHeight.set(0,G.height*.5,0),r.rectArea[D]=U,D++}else if(G.isPointLight){const U=t.get(G);if(U.color.copy(G.color).multiplyScalar(G.intensity*y),U.distance=G.distance,U.decay=G.decay,G.castShadow){const se=G.shadow,ie=n.get(G);ie.shadowBias=se.bias,ie.shadowNormalBias=se.normalBias,ie.shadowRadius=se.radius,ie.shadowMapSize=se.mapSize,ie.shadowCameraNear=se.camera.near,ie.shadowCameraFar=se.camera.far,r.pointShadow[g]=ie,r.pointShadowMap[g]=H,r.pointShadowMatrix[g]=G.shadow.matrix,A++}r.point[g]=U,g++}else if(G.isHemisphereLight){const U=t.get(G);U.skyColor.copy(G.color).multiplyScalar($*y),U.groundColor.copy(G.groundColor).multiplyScalar($*y),r.hemi[T]=U,T++}}D>0&&(e.isWebGL2||i.has("OES_texture_float_linear")===!0?(r.rectAreaLTC1=Me.LTC_FLOAT_1,r.rectAreaLTC2=Me.LTC_FLOAT_2):i.has("OES_texture_half_float_linear")===!0?(r.rectAreaLTC1=Me.LTC_HALF_1,r.rectAreaLTC2=Me.LTC_HALF_2):console.error("THREE.WebGLRenderer: Unable to use RectAreaLight. Missing WebGL extensions.")),r.ambient[0]=f,r.ambient[1]=_,r.ambient[2]=v;const S=r.hash;(S.directionalLength!==M||S.pointLength!==g||S.spotLength!==m||S.rectAreaLength!==D||S.hemiLength!==T||S.numDirectionalShadows!==C||S.numPointShadows!==A||S.numSpotShadows!==L||S.numSpotMaps!==w)&&(r.directional.length=M,r.spot.length=m,r.rectArea.length=D,r.point.length=g,r.hemi.length=T,r.directionalShadow.length=C,r.directionalShadowMap.length=C,r.pointShadow.length=A,r.pointShadowMap.length=A,r.spotShadow.length=L,r.spotShadowMap.length=L,r.directionalShadowMatrix.length=C,r.pointShadowMatrix.length=A,r.spotLightMatrix.length=L+w-N,r.spotLightMap.length=w,r.numSpotLightShadowsWithMaps=N,S.directionalLength=M,S.pointLength=g,S.spotLength=m,S.rectAreaLength=D,S.hemiLength=T,S.numDirectionalShadows=C,S.numPointShadows=A,S.numSpotShadows=L,S.numSpotMaps=w,r.version=H0++)}function u(h,d){let f=0,_=0,v=0,M=0,g=0;const m=d.matrixWorldInverse;for(let D=0,T=h.length;D<T;D++){const C=h[D];if(C.isDirectionalLight){const A=r.directional[f];A.direction.setFromMatrixPosition(C.matrixWorld),s.setFromMatrixPosition(C.target.matrixWorld),A.direction.sub(s),A.direction.transformDirection(m),f++}else if(C.isSpotLight){const A=r.spot[v];A.position.setFromMatrixPosition(C.matrixWorld),A.position.applyMatrix4(m),A.direction.setFromMatrixPosition(C.matrixWorld),s.setFromMatrixPosition(C.target.matrixWorld),A.direction.sub(s),A.direction.transformDirection(m),v++}else if(C.isRectAreaLight){const A=r.rectArea[M];A.position.setFromMatrixPosition(C.matrixWorld),A.position.applyMatrix4(m),o.identity(),c.copy(C.matrixWorld),c.premultiply(m),o.extractRotation(c),A.halfWidth.set(C.width*.5,0,0),A.halfHeight.set(0,C.height*.5,0),A.halfWidth.applyMatrix4(o),A.halfHeight.applyMatrix4(o),M++}else if(C.isPointLight){const A=r.point[_];A.position.setFromMatrixPosition(C.matrixWorld),A.position.applyMatrix4(m),_++}else if(C.isHemisphereLight){const A=r.hemi[g];A.direction.setFromMatrixPosition(C.matrixWorld),A.direction.transformDirection(m),g++}}}return{setup:l,setupView:u,state:r}}function Cu(i,e){const t=new G0(i,e),n=[],r=[];function s(){n.length=0,r.length=0}function c(d){n.push(d)}function o(d){r.push(d)}function l(d){t.setup(n,d)}function u(d){t.setupView(n,d)}return{init:s,state:{lightsArray:n,shadowsArray:r,lights:t},setupLights:l,setupLightsView:u,pushLight:c,pushShadow:o}}function V0(i,e){let t=new WeakMap;function n(s,c=0){const o=t.get(s);let l;return o===void 0?(l=new Cu(i,e),t.set(s,[l])):c>=o.length?(l=new Cu(i,e),o.push(l)):l=o[c],l}function r(){t=new WeakMap}return{get:n,dispose:r}}class W0 extends po{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=Sp,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class X0 extends po{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const q0=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function j0(i,e,t){let n=new Ba;const r=new Re,s=new Re,c=new zt,o=new W0({depthPacking:bp}),l=new X0,u={},h=t.maxTextureSize,d={[xi]:sn,[sn]:xi,[Jn]:Jn},f=new ki({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Re},radius:{value:4}},vertexShader:q0,fragmentShader:Y0}),_=f.clone();_.defines.HORIZONTAL_PASS=1;const v=new zn;v.setAttribute("position",new Fn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new Vt(v,f),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=qu;let m=this.type;this.render=function(A,L,w){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||A.length===0)return;const N=i.getRenderTarget(),y=i.getActiveCubeFace(),S=i.getActiveMipmapLevel(),V=i.state;V.setBlending(gi),V.buffers.color.setClear(1,1,1,1),V.buffers.depth.setTest(!0),V.setScissorTest(!1);const Z=m!==Kn&&this.type===Kn,G=m===Kn&&this.type!==Kn;for(let j=0,$=A.length;j<$;j++){const re=A[j],H=re.shadow;if(H===void 0){console.warn("THREE.WebGLShadowMap:",re,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;r.copy(H.mapSize);const U=H.getFrameExtents();if(r.multiply(U),s.copy(H.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/U.x),r.x=s.x*U.x,H.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/U.y),r.y=s.y*U.y,H.mapSize.y=s.y)),H.map===null||Z===!0||G===!0){const ie=this.type!==Kn?{minFilter:nn,magFilter:nn}:{};H.map!==null&&H.map.dispose(),H.map=new zi(r.x,r.y,ie),H.map.texture.name=re.name+".shadowMap",H.camera.updateProjectionMatrix()}i.setRenderTarget(H.map),i.clear();const se=H.getViewportCount();for(let ie=0;ie<se;ie++){const Y=H.getViewport(ie);c.set(s.x*Y.x,s.y*Y.y,s.x*Y.z,s.y*Y.w),V.viewport(c),H.updateMatrices(re,ie),n=H.getFrustum(),C(L,w,H.camera,re,this.type)}H.isPointLightShadow!==!0&&this.type===Kn&&D(H,w),H.needsUpdate=!1}m=this.type,g.needsUpdate=!1,i.setRenderTarget(N,y,S)};function D(A,L){const w=e.update(M);f.defines.VSM_SAMPLES!==A.blurSamples&&(f.defines.VSM_SAMPLES=A.blurSamples,_.defines.VSM_SAMPLES=A.blurSamples,f.needsUpdate=!0,_.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new zi(r.x,r.y)),f.uniforms.shadow_pass.value=A.map.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,i.setRenderTarget(A.mapPass),i.clear(),i.renderBufferDirect(L,null,w,f,M,null),_.uniforms.shadow_pass.value=A.mapPass.texture,_.uniforms.resolution.value=A.mapSize,_.uniforms.radius.value=A.radius,i.setRenderTarget(A.map),i.clear(),i.renderBufferDirect(L,null,w,_,M,null)}function T(A,L,w,N){let y=null;const S=w.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(S!==void 0)y=S;else if(y=w.isPointLight===!0?l:o,i.localClippingEnabled&&L.clipShadows===!0&&Array.isArray(L.clippingPlanes)&&L.clippingPlanes.length!==0||L.displacementMap&&L.displacementScale!==0||L.alphaMap&&L.alphaTest>0||L.map&&L.alphaTest>0){const V=y.uuid,Z=L.uuid;let G=u[V];G===void 0&&(G={},u[V]=G);let j=G[Z];j===void 0&&(j=y.clone(),G[Z]=j),y=j}if(y.visible=L.visible,y.wireframe=L.wireframe,N===Kn?y.side=L.shadowSide!==null?L.shadowSide:L.side:y.side=L.shadowSide!==null?L.shadowSide:d[L.side],y.alphaMap=L.alphaMap,y.alphaTest=L.alphaTest,y.map=L.map,y.clipShadows=L.clipShadows,y.clippingPlanes=L.clippingPlanes,y.clipIntersection=L.clipIntersection,y.displacementMap=L.displacementMap,y.displacementScale=L.displacementScale,y.displacementBias=L.displacementBias,y.wireframeLinewidth=L.wireframeLinewidth,y.linewidth=L.linewidth,w.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const V=i.properties.get(y);V.light=w}return y}function C(A,L,w,N,y){if(A.visible===!1)return;if(A.layers.test(L.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&y===Kn)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(w.matrixWorldInverse,A.matrixWorld);const Z=e.update(A),G=A.material;if(Array.isArray(G)){const j=Z.groups;for(let $=0,re=j.length;$<re;$++){const H=j[$],U=G[H.materialIndex];if(U&&U.visible){const se=T(A,U,N,y);i.renderBufferDirect(w,null,Z,se,A,H)}}}else if(G.visible){const j=T(A,G,N,y);i.renderBufferDirect(w,null,Z,j,A,null)}}const V=A.children;for(let Z=0,G=V.length;Z<G;Z++)C(V[Z],L,w,N,y)}}function $0(i,e,t){const n=t.isWebGL2;function r(){let O=!1;const xe=new zt;let Q=null;const he=new zt(0,0,0,0);return{setMask:function(pe){Q!==pe&&!O&&(i.colorMask(pe,pe,pe,pe),Q=pe)},setLocked:function(pe){O=pe},setClear:function(pe,Qe,it,at,$t){$t===!0&&(pe*=at,Qe*=at,it*=at),xe.set(pe,Qe,it,at),he.equals(xe)===!1&&(i.clearColor(pe,Qe,it,at),he.copy(xe))},reset:function(){O=!1,Q=null,he.set(-1,0,0,0)}}}function s(){let O=!1,xe=null,Q=null,he=null;return{setTest:function(pe){pe?Ue(i.DEPTH_TEST):De(i.DEPTH_TEST)},setMask:function(pe){xe!==pe&&!O&&(i.depthMask(pe),xe=pe)},setFunc:function(pe){if(Q!==pe){switch(pe){case Qf:i.depthFunc(i.NEVER);break;case ep:i.depthFunc(i.ALWAYS);break;case tp:i.depthFunc(i.LESS);break;case Ta:i.depthFunc(i.LEQUAL);break;case np:i.depthFunc(i.EQUAL);break;case ip:i.depthFunc(i.GEQUAL);break;case rp:i.depthFunc(i.GREATER);break;case sp:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Q=pe}},setLocked:function(pe){O=pe},setClear:function(pe){he!==pe&&(i.clearDepth(pe),he=pe)},reset:function(){O=!1,xe=null,Q=null,he=null}}}function c(){let O=!1,xe=null,Q=null,he=null,pe=null,Qe=null,it=null,at=null,$t=null;return{setTest:function(mt){O||(mt?Ue(i.STENCIL_TEST):De(i.STENCIL_TEST))},setMask:function(mt){xe!==mt&&!O&&(i.stencilMask(mt),xe=mt)},setFunc:function(mt,hn,Ht){(Q!==mt||he!==hn||pe!==Ht)&&(i.stencilFunc(mt,hn,Ht),Q=mt,he=hn,pe=Ht)},setOp:function(mt,hn,Ht){(Qe!==mt||it!==hn||at!==Ht)&&(i.stencilOp(mt,hn,Ht),Qe=mt,it=hn,at=Ht)},setLocked:function(mt){O=mt},setClear:function(mt){$t!==mt&&(i.clearStencil(mt),$t=mt)},reset:function(){O=!1,xe=null,Q=null,he=null,pe=null,Qe=null,it=null,at=null,$t=null}}}const o=new r,l=new s,u=new c,h=new WeakMap,d=new WeakMap;let f={},_={},v=new WeakMap,M=[],g=null,m=!1,D=null,T=null,C=null,A=null,L=null,w=null,N=null,y=!1,S=null,V=null,Z=null,G=null,j=null;const $=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let re=!1,H=0;const U=i.getParameter(i.VERSION);U.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec(U)[1]),re=H>=1):U.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec(U)[1]),re=H>=2);let se=null,ie={};const Y=i.getParameter(i.SCISSOR_BOX),ee=i.getParameter(i.VIEWPORT),ve=new zt().fromArray(Y),_e=new zt().fromArray(ee);function Te(O,xe,Q,he){const pe=new Uint8Array(4),Qe=i.createTexture();i.bindTexture(O,Qe),i.texParameteri(O,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(O,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let it=0;it<Q;it++)n&&(O===i.TEXTURE_3D||O===i.TEXTURE_2D_ARRAY)?i.texImage3D(xe,0,i.RGBA,1,1,he,0,i.RGBA,i.UNSIGNED_BYTE,pe):i.texImage2D(xe+it,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,pe);return Qe}const ce={};ce[i.TEXTURE_2D]=Te(i.TEXTURE_2D,i.TEXTURE_2D,1),ce[i.TEXTURE_CUBE_MAP]=Te(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),n&&(ce[i.TEXTURE_2D_ARRAY]=Te(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ce[i.TEXTURE_3D]=Te(i.TEXTURE_3D,i.TEXTURE_3D,1,1)),o.setClear(0,0,0,1),l.setClear(1),u.setClear(0),Ue(i.DEPTH_TEST),l.setFunc(Ta),Be(!1),pt(fl),Ue(i.CULL_FACE),Le(gi);function Ue(O){f[O]!==!0&&(i.enable(O),f[O]=!0)}function De(O){f[O]!==!1&&(i.disable(O),f[O]=!1)}function rt(O,xe){return _[O]!==xe?(i.bindFramebuffer(O,xe),_[O]=xe,n&&(O===i.DRAW_FRAMEBUFFER&&(_[i.FRAMEBUFFER]=xe),O===i.FRAMEBUFFER&&(_[i.DRAW_FRAMEBUFFER]=xe)),!0):!1}function Dt(O,xe){let Q=M,he=!1;if(O)if(Q=v.get(xe),Q===void 0&&(Q=[],v.set(xe,Q)),O.isWebGLMultipleRenderTargets){const pe=O.texture;if(Q.length!==pe.length||Q[0]!==i.COLOR_ATTACHMENT0){for(let Qe=0,it=pe.length;Qe<it;Qe++)Q[Qe]=i.COLOR_ATTACHMENT0+Qe;Q.length=pe.length,he=!0}}else Q[0]!==i.COLOR_ATTACHMENT0&&(Q[0]=i.COLOR_ATTACHMENT0,he=!0);else Q[0]!==i.BACK&&(Q[0]=i.BACK,he=!0);he&&(t.isWebGL2?i.drawBuffers(Q):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(Q))}function He(O){return g!==O?(i.useProgram(O),g=O,!0):!1}const W={[_r]:i.FUNC_ADD,[Gf]:i.FUNC_SUBTRACT,[Vf]:i.FUNC_REVERSE_SUBTRACT};if(n)W[_l]=i.MIN,W[vl]=i.MAX;else{const O=e.get("EXT_blend_minmax");O!==null&&(W[_l]=O.MIN_EXT,W[vl]=O.MAX_EXT)}const Mt={[Wf]:i.ZERO,[Xf]:i.ONE,[qf]:i.SRC_COLOR,[Yu]:i.SRC_ALPHA,[Jf]:i.SRC_ALPHA_SATURATE,[Kf]:i.DST_COLOR,[jf]:i.DST_ALPHA,[Yf]:i.ONE_MINUS_SRC_COLOR,[ju]:i.ONE_MINUS_SRC_ALPHA,[Zf]:i.ONE_MINUS_DST_COLOR,[$f]:i.ONE_MINUS_DST_ALPHA};function Le(O,xe,Q,he,pe,Qe,it,at){if(O===gi){m===!0&&(De(i.BLEND),m=!1);return}if(m===!1&&(Ue(i.BLEND),m=!0),O!==kf){if(O!==D||at!==y){if((T!==_r||L!==_r)&&(i.blendEquation(i.FUNC_ADD),T=_r,L=_r),at)switch(O){case Er:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case pl:i.blendFunc(i.ONE,i.ONE);break;case ml:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case gl:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",O);break}else switch(O){case Er:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case pl:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case ml:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case gl:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",O);break}C=null,A=null,w=null,N=null,D=O,y=at}return}pe=pe||xe,Qe=Qe||Q,it=it||he,(xe!==T||pe!==L)&&(i.blendEquationSeparate(W[xe],W[pe]),T=xe,L=pe),(Q!==C||he!==A||Qe!==w||it!==N)&&(i.blendFuncSeparate(Mt[Q],Mt[he],Mt[Qe],Mt[it]),C=Q,A=he,w=Qe,N=it),D=O,y=!1}function Ge(O,xe){O.side===Jn?De(i.CULL_FACE):Ue(i.CULL_FACE);let Q=O.side===sn;xe&&(Q=!Q),Be(Q),O.blending===Er&&O.transparent===!1?Le(gi):Le(O.blending,O.blendEquation,O.blendSrc,O.blendDst,O.blendEquationAlpha,O.blendSrcAlpha,O.blendDstAlpha,O.premultipliedAlpha),l.setFunc(O.depthFunc),l.setTest(O.depthTest),l.setMask(O.depthWrite),o.setMask(O.colorWrite);const he=O.stencilWrite;u.setTest(he),he&&(u.setMask(O.stencilWriteMask),u.setFunc(O.stencilFunc,O.stencilRef,O.stencilFuncMask),u.setOp(O.stencilFail,O.stencilZFail,O.stencilZPass)),Ve(O.polygonOffset,O.polygonOffsetFactor,O.polygonOffsetUnits),O.alphaToCoverage===!0?Ue(i.SAMPLE_ALPHA_TO_COVERAGE):De(i.SAMPLE_ALPHA_TO_COVERAGE)}function Be(O){S!==O&&(O?i.frontFace(i.CW):i.frontFace(i.CCW),S=O)}function pt(O){O!==Bf?(Ue(i.CULL_FACE),O!==V&&(O===fl?i.cullFace(i.BACK):O===zf?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):De(i.CULL_FACE),V=O}function $e(O){O!==Z&&(re&&i.lineWidth(O),Z=O)}function Ve(O,xe,Q){O?(Ue(i.POLYGON_OFFSET_FILL),(G!==xe||j!==Q)&&(i.polygonOffset(xe,Q),G=xe,j=Q)):De(i.POLYGON_OFFSET_FILL)}function st(O){O?Ue(i.SCISSOR_TEST):De(i.SCISSOR_TEST)}function Rt(O){O===void 0&&(O=i.TEXTURE0+$-1),se!==O&&(i.activeTexture(O),se=O)}function St(O,xe,Q){Q===void 0&&(se===null?Q=i.TEXTURE0+$-1:Q=se);let he=ie[Q];he===void 0&&(he={type:void 0,texture:void 0},ie[Q]=he),(he.type!==O||he.texture!==xe)&&(se!==Q&&(i.activeTexture(Q),se=Q),i.bindTexture(O,xe||ce[O]),he.type=O,he.texture=xe)}function P(){const O=ie[se];O!==void 0&&O.type!==void 0&&(i.bindTexture(O.type,null),O.type=void 0,O.texture=void 0)}function b(){try{i.compressedTexImage2D.apply(i,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function q(){try{i.compressedTexImage3D.apply(i,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function ue(){try{i.texSubImage2D.apply(i,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function le(){try{i.texSubImage3D.apply(i,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function de(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function Ce(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function fe(){try{i.texStorage2D.apply(i,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function J(){try{i.texStorage3D.apply(i,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function I(){try{i.texImage2D.apply(i,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function oe(){try{i.texImage3D.apply(i,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function Ee(O){ve.equals(O)===!1&&(i.scissor(O.x,O.y,O.z,O.w),ve.copy(O))}function me(O){_e.equals(O)===!1&&(i.viewport(O.x,O.y,O.z,O.w),_e.copy(O))}function ye(O,xe){let Q=d.get(xe);Q===void 0&&(Q=new WeakMap,d.set(xe,Q));let he=Q.get(O);he===void 0&&(he=i.getUniformBlockIndex(xe,O.name),Q.set(O,he))}function ze(O,xe){const he=d.get(xe).get(O);h.get(xe)!==he&&(i.uniformBlockBinding(xe,he,O.__bindingPointIndex),h.set(xe,he))}function Ke(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),n===!0&&(i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null)),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),f={},se=null,ie={},_={},v=new WeakMap,M=[],g=null,m=!1,D=null,T=null,C=null,A=null,L=null,w=null,N=null,y=!1,S=null,V=null,Z=null,G=null,j=null,ve.set(0,0,i.canvas.width,i.canvas.height),_e.set(0,0,i.canvas.width,i.canvas.height),o.reset(),l.reset(),u.reset()}return{buffers:{color:o,depth:l,stencil:u},enable:Ue,disable:De,bindFramebuffer:rt,drawBuffers:Dt,useProgram:He,setBlending:Le,setMaterial:Ge,setFlipSided:Be,setCullFace:pt,setLineWidth:$e,setPolygonOffset:Ve,setScissorTest:st,activeTexture:Rt,bindTexture:St,unbindTexture:P,compressedTexImage2D:b,compressedTexImage3D:q,texImage2D:I,texImage3D:oe,updateUBOMapping:ye,uniformBlockBinding:ze,texStorage2D:fe,texStorage3D:J,texSubImage2D:ue,texSubImage3D:le,compressedTexSubImage2D:de,compressedTexSubImage3D:Ce,scissor:Ee,viewport:me,reset:Ke}}function K0(i,e,t,n,r,s,c){const o=r.isWebGL2,l=r.maxTextures,u=r.maxCubemapSize,h=r.maxTextureSize,d=r.maxSamples,f=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,_=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),v=new WeakMap;let M;const g=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function D(P,b){return m?new OffscreenCanvas(P,b):lo("canvas")}function T(P,b,q,ue){let le=1;if((P.width>ue||P.height>ue)&&(le=ue/Math.max(P.width,P.height)),le<1||b===!0)if(typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&P instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&P instanceof ImageBitmap){const de=b?co:Math.floor,Ce=de(le*P.width),fe=de(le*P.height);M===void 0&&(M=D(Ce,fe));const J=q?D(Ce,fe):M;return J.width=Ce,J.height=fe,J.getContext("2d").drawImage(P,0,0,Ce,fe),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+P.width+"x"+P.height+") to ("+Ce+"x"+fe+")."),J}else return"data"in P&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+P.width+"x"+P.height+")."),P;return P}function C(P){return Pa(P.width)&&Pa(P.height)}function A(P){return o?!1:P.wrapS!==Ln||P.wrapT!==Ln||P.minFilter!==nn&&P.minFilter!==Mn}function L(P,b){return P.generateMipmaps&&b&&P.minFilter!==nn&&P.minFilter!==Mn}function w(P){i.generateMipmap(P)}function N(P,b,q,ue,le=!1){if(o===!1)return b;if(P!==null){if(i[P]!==void 0)return i[P];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+P+"'")}let de=b;return b===i.RED&&(q===i.FLOAT&&(de=i.R32F),q===i.HALF_FLOAT&&(de=i.R16F),q===i.UNSIGNED_BYTE&&(de=i.R8)),b===i.RED_INTEGER&&(q===i.UNSIGNED_BYTE&&(de=i.R8UI),q===i.UNSIGNED_SHORT&&(de=i.R16UI),q===i.UNSIGNED_INT&&(de=i.R32UI),q===i.BYTE&&(de=i.R8I),q===i.SHORT&&(de=i.R16I),q===i.INT&&(de=i.R32I)),b===i.RG&&(q===i.FLOAT&&(de=i.RG32F),q===i.HALF_FLOAT&&(de=i.RG16F),q===i.UNSIGNED_BYTE&&(de=i.RG8)),b===i.RGBA&&(q===i.FLOAT&&(de=i.RGBA32F),q===i.HALF_FLOAT&&(de=i.RGBA16F),q===i.UNSIGNED_BYTE&&(de=ue===Et&&le===!1?i.SRGB8_ALPHA8:i.RGBA8),q===i.UNSIGNED_SHORT_4_4_4_4&&(de=i.RGBA4),q===i.UNSIGNED_SHORT_5_5_5_1&&(de=i.RGB5_A1)),(de===i.R16F||de===i.R32F||de===i.RG16F||de===i.RG32F||de===i.RGBA16F||de===i.RGBA32F)&&e.get("EXT_color_buffer_float"),de}function y(P,b,q){return L(P,q)===!0||P.isFramebufferTexture&&P.minFilter!==nn&&P.minFilter!==Mn?Math.log2(Math.max(b.width,b.height))+1:P.mipmaps!==void 0&&P.mipmaps.length>0?P.mipmaps.length:P.isCompressedTexture&&Array.isArray(P.image)?b.mipmaps.length:1}function S(P){return P===nn||P===xl||P===Wo?i.NEAREST:i.LINEAR}function V(P){const b=P.target;b.removeEventListener("dispose",V),G(b),b.isVideoTexture&&v.delete(b)}function Z(P){const b=P.target;b.removeEventListener("dispose",Z),$(b)}function G(P){const b=n.get(P);if(b.__webglInit===void 0)return;const q=P.source,ue=g.get(q);if(ue){const le=ue[b.__cacheKey];le.usedTimes--,le.usedTimes===0&&j(P),Object.keys(ue).length===0&&g.delete(q)}n.remove(P)}function j(P){const b=n.get(P);i.deleteTexture(b.__webglTexture);const q=P.source,ue=g.get(q);delete ue[b.__cacheKey],c.memory.textures--}function $(P){const b=P.texture,q=n.get(P),ue=n.get(b);if(ue.__webglTexture!==void 0&&(i.deleteTexture(ue.__webglTexture),c.memory.textures--),P.depthTexture&&P.depthTexture.dispose(),P.isWebGLCubeRenderTarget)for(let le=0;le<6;le++){if(Array.isArray(q.__webglFramebuffer[le]))for(let de=0;de<q.__webglFramebuffer[le].length;de++)i.deleteFramebuffer(q.__webglFramebuffer[le][de]);else i.deleteFramebuffer(q.__webglFramebuffer[le]);q.__webglDepthbuffer&&i.deleteRenderbuffer(q.__webglDepthbuffer[le])}else{if(Array.isArray(q.__webglFramebuffer))for(let le=0;le<q.__webglFramebuffer.length;le++)i.deleteFramebuffer(q.__webglFramebuffer[le]);else i.deleteFramebuffer(q.__webglFramebuffer);if(q.__webglDepthbuffer&&i.deleteRenderbuffer(q.__webglDepthbuffer),q.__webglMultisampledFramebuffer&&i.deleteFramebuffer(q.__webglMultisampledFramebuffer),q.__webglColorRenderbuffer)for(let le=0;le<q.__webglColorRenderbuffer.length;le++)q.__webglColorRenderbuffer[le]&&i.deleteRenderbuffer(q.__webglColorRenderbuffer[le]);q.__webglDepthRenderbuffer&&i.deleteRenderbuffer(q.__webglDepthRenderbuffer)}if(P.isWebGLMultipleRenderTargets)for(let le=0,de=b.length;le<de;le++){const Ce=n.get(b[le]);Ce.__webglTexture&&(i.deleteTexture(Ce.__webglTexture),c.memory.textures--),n.remove(b[le])}n.remove(b),n.remove(P)}let re=0;function H(){re=0}function U(){const P=re;return P>=l&&console.warn("THREE.WebGLTextures: Trying to use "+P+" texture units while this GPU supports only "+l),re+=1,P}function se(P){const b=[];return b.push(P.wrapS),b.push(P.wrapT),b.push(P.wrapR||0),b.push(P.magFilter),b.push(P.minFilter),b.push(P.anisotropy),b.push(P.internalFormat),b.push(P.format),b.push(P.type),b.push(P.generateMipmaps),b.push(P.premultiplyAlpha),b.push(P.flipY),b.push(P.unpackAlignment),b.push(P.colorSpace),b.join()}function ie(P,b){const q=n.get(P);if(P.isVideoTexture&&Rt(P),P.isRenderTargetTexture===!1&&P.version>0&&q.__version!==P.version){const ue=P.image;if(ue===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ue.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{rt(q,P,b);return}}t.bindTexture(i.TEXTURE_2D,q.__webglTexture,i.TEXTURE0+b)}function Y(P,b){const q=n.get(P);if(P.version>0&&q.__version!==P.version){rt(q,P,b);return}t.bindTexture(i.TEXTURE_2D_ARRAY,q.__webglTexture,i.TEXTURE0+b)}function ee(P,b){const q=n.get(P);if(P.version>0&&q.__version!==P.version){rt(q,P,b);return}t.bindTexture(i.TEXTURE_3D,q.__webglTexture,i.TEXTURE0+b)}function ve(P,b){const q=n.get(P);if(P.version>0&&q.__version!==P.version){Dt(q,P,b);return}t.bindTexture(i.TEXTURE_CUBE_MAP,q.__webglTexture,i.TEXTURE0+b)}const _e={[Ra]:i.REPEAT,[Ln]:i.CLAMP_TO_EDGE,[Ca]:i.MIRRORED_REPEAT},Te={[nn]:i.NEAREST,[xl]:i.NEAREST_MIPMAP_NEAREST,[Wo]:i.NEAREST_MIPMAP_LINEAR,[Mn]:i.LINEAR,[fp]:i.LINEAR_MIPMAP_NEAREST,[rs]:i.LINEAR_MIPMAP_LINEAR},ce={[Rp]:i.NEVER,[Np]:i.ALWAYS,[Cp]:i.LESS,[Pp]:i.LEQUAL,[Lp]:i.EQUAL,[Ip]:i.GEQUAL,[Dp]:i.GREATER,[Up]:i.NOTEQUAL};function Ue(P,b,q){if(q?(i.texParameteri(P,i.TEXTURE_WRAP_S,_e[b.wrapS]),i.texParameteri(P,i.TEXTURE_WRAP_T,_e[b.wrapT]),(P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY)&&i.texParameteri(P,i.TEXTURE_WRAP_R,_e[b.wrapR]),i.texParameteri(P,i.TEXTURE_MAG_FILTER,Te[b.magFilter]),i.texParameteri(P,i.TEXTURE_MIN_FILTER,Te[b.minFilter])):(i.texParameteri(P,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(P,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE),(P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY)&&i.texParameteri(P,i.TEXTURE_WRAP_R,i.CLAMP_TO_EDGE),(b.wrapS!==Ln||b.wrapT!==Ln)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),i.texParameteri(P,i.TEXTURE_MAG_FILTER,S(b.magFilter)),i.texParameteri(P,i.TEXTURE_MIN_FILTER,S(b.minFilter)),b.minFilter!==nn&&b.minFilter!==Mn&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),b.compareFunction&&(i.texParameteri(P,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(P,i.TEXTURE_COMPARE_FUNC,ce[b.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const ue=e.get("EXT_texture_filter_anisotropic");if(b.magFilter===nn||b.minFilter!==Wo&&b.minFilter!==rs||b.type===mi&&e.has("OES_texture_float_linear")===!1||o===!1&&b.type===ss&&e.has("OES_texture_half_float_linear")===!1)return;(b.anisotropy>1||n.get(b).__currentAnisotropy)&&(i.texParameterf(P,ue.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,r.getMaxAnisotropy())),n.get(b).__currentAnisotropy=b.anisotropy)}}function De(P,b){let q=!1;P.__webglInit===void 0&&(P.__webglInit=!0,b.addEventListener("dispose",V));const ue=b.source;let le=g.get(ue);le===void 0&&(le={},g.set(ue,le));const de=se(b);if(de!==P.__cacheKey){le[de]===void 0&&(le[de]={texture:i.createTexture(),usedTimes:0},c.memory.textures++,q=!0),le[de].usedTimes++;const Ce=le[P.__cacheKey];Ce!==void 0&&(le[P.__cacheKey].usedTimes--,Ce.usedTimes===0&&j(b)),P.__cacheKey=de,P.__webglTexture=le[de].texture}return q}function rt(P,b,q){let ue=i.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(ue=i.TEXTURE_2D_ARRAY),b.isData3DTexture&&(ue=i.TEXTURE_3D);const le=De(P,b),de=b.source;t.bindTexture(ue,P.__webglTexture,i.TEXTURE0+q);const Ce=n.get(de);if(de.version!==Ce.__version||le===!0){t.activeTexture(i.TEXTURE0+q),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,b.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,b.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.NONE);const fe=A(b)&&C(b.image)===!1;let J=T(b.image,fe,!1,h);J=St(b,J);const I=C(J)||o,oe=s.convert(b.format,b.colorSpace);let Ee=s.convert(b.type),me=N(b.internalFormat,oe,Ee,b.colorSpace,b.isVideoTexture);Ue(ue,b,I);let ye;const ze=b.mipmaps,Ke=o&&b.isVideoTexture!==!0,O=Ce.__version===void 0||le===!0,xe=y(b,J,I);if(b.isDepthTexture)me=i.DEPTH_COMPONENT,o?b.type===mi?me=i.DEPTH_COMPONENT32F:b.type===pi?me=i.DEPTH_COMPONENT24:b.type===Ni?me=i.DEPTH24_STENCIL8:me=i.DEPTH_COMPONENT16:b.type===mi&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),b.format===Oi&&me===i.DEPTH_COMPONENT&&b.type!==Na&&b.type!==pi&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),b.type=pi,Ee=s.convert(b.type)),b.format===Cr&&me===i.DEPTH_COMPONENT&&(me=i.DEPTH_STENCIL,b.type!==Ni&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),b.type=Ni,Ee=s.convert(b.type))),O&&(Ke?t.texStorage2D(i.TEXTURE_2D,1,me,J.width,J.height):t.texImage2D(i.TEXTURE_2D,0,me,J.width,J.height,0,oe,Ee,null));else if(b.isDataTexture)if(ze.length>0&&I){Ke&&O&&t.texStorage2D(i.TEXTURE_2D,xe,me,ze[0].width,ze[0].height);for(let Q=0,he=ze.length;Q<he;Q++)ye=ze[Q],Ke?t.texSubImage2D(i.TEXTURE_2D,Q,0,0,ye.width,ye.height,oe,Ee,ye.data):t.texImage2D(i.TEXTURE_2D,Q,me,ye.width,ye.height,0,oe,Ee,ye.data);b.generateMipmaps=!1}else Ke?(O&&t.texStorage2D(i.TEXTURE_2D,xe,me,J.width,J.height),t.texSubImage2D(i.TEXTURE_2D,0,0,0,J.width,J.height,oe,Ee,J.data)):t.texImage2D(i.TEXTURE_2D,0,me,J.width,J.height,0,oe,Ee,J.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){Ke&&O&&t.texStorage3D(i.TEXTURE_2D_ARRAY,xe,me,ze[0].width,ze[0].height,J.depth);for(let Q=0,he=ze.length;Q<he;Q++)ye=ze[Q],b.format!==Pn?oe!==null?Ke?t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,ye.width,ye.height,J.depth,oe,ye.data,0,0):t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Q,me,ye.width,ye.height,J.depth,0,ye.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ke?t.texSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,ye.width,ye.height,J.depth,oe,Ee,ye.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Q,me,ye.width,ye.height,J.depth,0,oe,Ee,ye.data)}else{Ke&&O&&t.texStorage2D(i.TEXTURE_2D,xe,me,ze[0].width,ze[0].height);for(let Q=0,he=ze.length;Q<he;Q++)ye=ze[Q],b.format!==Pn?oe!==null?Ke?t.compressedTexSubImage2D(i.TEXTURE_2D,Q,0,0,ye.width,ye.height,oe,ye.data):t.compressedTexImage2D(i.TEXTURE_2D,Q,me,ye.width,ye.height,0,ye.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ke?t.texSubImage2D(i.TEXTURE_2D,Q,0,0,ye.width,ye.height,oe,Ee,ye.data):t.texImage2D(i.TEXTURE_2D,Q,me,ye.width,ye.height,0,oe,Ee,ye.data)}else if(b.isDataArrayTexture)Ke?(O&&t.texStorage3D(i.TEXTURE_2D_ARRAY,xe,me,J.width,J.height,J.depth),t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,oe,Ee,J.data)):t.texImage3D(i.TEXTURE_2D_ARRAY,0,me,J.width,J.height,J.depth,0,oe,Ee,J.data);else if(b.isData3DTexture)Ke?(O&&t.texStorage3D(i.TEXTURE_3D,xe,me,J.width,J.height,J.depth),t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,oe,Ee,J.data)):t.texImage3D(i.TEXTURE_3D,0,me,J.width,J.height,J.depth,0,oe,Ee,J.data);else if(b.isFramebufferTexture){if(O)if(Ke)t.texStorage2D(i.TEXTURE_2D,xe,me,J.width,J.height);else{let Q=J.width,he=J.height;for(let pe=0;pe<xe;pe++)t.texImage2D(i.TEXTURE_2D,pe,me,Q,he,0,oe,Ee,null),Q>>=1,he>>=1}}else if(ze.length>0&&I){Ke&&O&&t.texStorage2D(i.TEXTURE_2D,xe,me,ze[0].width,ze[0].height);for(let Q=0,he=ze.length;Q<he;Q++)ye=ze[Q],Ke?t.texSubImage2D(i.TEXTURE_2D,Q,0,0,oe,Ee,ye):t.texImage2D(i.TEXTURE_2D,Q,me,oe,Ee,ye);b.generateMipmaps=!1}else Ke?(O&&t.texStorage2D(i.TEXTURE_2D,xe,me,J.width,J.height),t.texSubImage2D(i.TEXTURE_2D,0,0,0,oe,Ee,J)):t.texImage2D(i.TEXTURE_2D,0,me,oe,Ee,J);L(b,I)&&w(ue),Ce.__version=de.version,b.onUpdate&&b.onUpdate(b)}P.__version=b.version}function Dt(P,b,q){if(b.image.length!==6)return;const ue=De(P,b),le=b.source;t.bindTexture(i.TEXTURE_CUBE_MAP,P.__webglTexture,i.TEXTURE0+q);const de=n.get(le);if(le.version!==de.__version||ue===!0){t.activeTexture(i.TEXTURE0+q),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,b.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,b.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.NONE);const Ce=b.isCompressedTexture||b.image[0].isCompressedTexture,fe=b.image[0]&&b.image[0].isDataTexture,J=[];for(let Q=0;Q<6;Q++)!Ce&&!fe?J[Q]=T(b.image[Q],!1,!0,u):J[Q]=fe?b.image[Q].image:b.image[Q],J[Q]=St(b,J[Q]);const I=J[0],oe=C(I)||o,Ee=s.convert(b.format,b.colorSpace),me=s.convert(b.type),ye=N(b.internalFormat,Ee,me,b.colorSpace),ze=o&&b.isVideoTexture!==!0,Ke=de.__version===void 0||ue===!0;let O=y(b,I,oe);Ue(i.TEXTURE_CUBE_MAP,b,oe);let xe;if(Ce){ze&&Ke&&t.texStorage2D(i.TEXTURE_CUBE_MAP,O,ye,I.width,I.height);for(let Q=0;Q<6;Q++){xe=J[Q].mipmaps;for(let he=0;he<xe.length;he++){const pe=xe[he];b.format!==Pn?Ee!==null?ze?t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,he,0,0,pe.width,pe.height,Ee,pe.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,he,ye,pe.width,pe.height,0,pe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):ze?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,he,0,0,pe.width,pe.height,Ee,me,pe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,he,ye,pe.width,pe.height,0,Ee,me,pe.data)}}}else{xe=b.mipmaps,ze&&Ke&&(xe.length>0&&O++,t.texStorage2D(i.TEXTURE_CUBE_MAP,O,ye,J[0].width,J[0].height));for(let Q=0;Q<6;Q++)if(fe){ze?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,J[Q].width,J[Q].height,Ee,me,J[Q].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,ye,J[Q].width,J[Q].height,0,Ee,me,J[Q].data);for(let he=0;he<xe.length;he++){const Qe=xe[he].image[Q].image;ze?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,he+1,0,0,Qe.width,Qe.height,Ee,me,Qe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,he+1,ye,Qe.width,Qe.height,0,Ee,me,Qe.data)}}else{ze?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Ee,me,J[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,ye,Ee,me,J[Q]);for(let he=0;he<xe.length;he++){const pe=xe[he];ze?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,he+1,0,0,Ee,me,pe.image[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,he+1,ye,Ee,me,pe.image[Q])}}}L(b,oe)&&w(i.TEXTURE_CUBE_MAP),de.__version=le.version,b.onUpdate&&b.onUpdate(b)}P.__version=b.version}function He(P,b,q,ue,le,de){const Ce=s.convert(q.format,q.colorSpace),fe=s.convert(q.type),J=N(q.internalFormat,Ce,fe,q.colorSpace);if(!n.get(b).__hasExternalTextures){const oe=Math.max(1,b.width>>de),Ee=Math.max(1,b.height>>de);le===i.TEXTURE_3D||le===i.TEXTURE_2D_ARRAY?t.texImage3D(le,de,J,oe,Ee,b.depth,0,Ce,fe,null):t.texImage2D(le,de,J,oe,Ee,0,Ce,fe,null)}t.bindFramebuffer(i.FRAMEBUFFER,P),st(b)?f.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ue,le,n.get(q).__webglTexture,0,Ve(b)):(le===i.TEXTURE_2D||le>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&le<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,ue,le,n.get(q).__webglTexture,de),t.bindFramebuffer(i.FRAMEBUFFER,null)}function W(P,b,q){if(i.bindRenderbuffer(i.RENDERBUFFER,P),b.depthBuffer&&!b.stencilBuffer){let ue=i.DEPTH_COMPONENT16;if(q||st(b)){const le=b.depthTexture;le&&le.isDepthTexture&&(le.type===mi?ue=i.DEPTH_COMPONENT32F:le.type===pi&&(ue=i.DEPTH_COMPONENT24));const de=Ve(b);st(b)?f.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,de,ue,b.width,b.height):i.renderbufferStorageMultisample(i.RENDERBUFFER,de,ue,b.width,b.height)}else i.renderbufferStorage(i.RENDERBUFFER,ue,b.width,b.height);i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.RENDERBUFFER,P)}else if(b.depthBuffer&&b.stencilBuffer){const ue=Ve(b);q&&st(b)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,ue,i.DEPTH24_STENCIL8,b.width,b.height):st(b)?f.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ue,i.DEPTH24_STENCIL8,b.width,b.height):i.renderbufferStorage(i.RENDERBUFFER,i.DEPTH_STENCIL,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.RENDERBUFFER,P)}else{const ue=b.isWebGLMultipleRenderTargets===!0?b.texture:[b.texture];for(let le=0;le<ue.length;le++){const de=ue[le],Ce=s.convert(de.format,de.colorSpace),fe=s.convert(de.type),J=N(de.internalFormat,Ce,fe,de.colorSpace),I=Ve(b);q&&st(b)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,I,J,b.width,b.height):st(b)?f.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,I,J,b.width,b.height):i.renderbufferStorage(i.RENDERBUFFER,J,b.width,b.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Mt(P,b){if(b&&b.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,P),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(b.depthTexture).__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),ie(b.depthTexture,0);const ue=n.get(b.depthTexture).__webglTexture,le=Ve(b);if(b.depthTexture.format===Oi)st(b)?f.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ue,0,le):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ue,0);else if(b.depthTexture.format===Cr)st(b)?f.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ue,0,le):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ue,0);else throw new Error("Unknown depthTexture format")}function Le(P){const b=n.get(P),q=P.isWebGLCubeRenderTarget===!0;if(P.depthTexture&&!b.__autoAllocateDepthBuffer){if(q)throw new Error("target.depthTexture not supported in Cube render targets");Mt(b.__webglFramebuffer,P)}else if(q){b.__webglDepthbuffer=[];for(let ue=0;ue<6;ue++)t.bindFramebuffer(i.FRAMEBUFFER,b.__webglFramebuffer[ue]),b.__webglDepthbuffer[ue]=i.createRenderbuffer(),W(b.__webglDepthbuffer[ue],P,!1)}else t.bindFramebuffer(i.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer=i.createRenderbuffer(),W(b.__webglDepthbuffer,P,!1);t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ge(P,b,q){const ue=n.get(P);b!==void 0&&He(ue.__webglFramebuffer,P,P.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),q!==void 0&&Le(P)}function Be(P){const b=P.texture,q=n.get(P),ue=n.get(b);P.addEventListener("dispose",Z),P.isWebGLMultipleRenderTargets!==!0&&(ue.__webglTexture===void 0&&(ue.__webglTexture=i.createTexture()),ue.__version=b.version,c.memory.textures++);const le=P.isWebGLCubeRenderTarget===!0,de=P.isWebGLMultipleRenderTargets===!0,Ce=C(P)||o;if(le){q.__webglFramebuffer=[];for(let fe=0;fe<6;fe++)if(o&&b.mipmaps&&b.mipmaps.length>0){q.__webglFramebuffer[fe]=[];for(let J=0;J<b.mipmaps.length;J++)q.__webglFramebuffer[fe][J]=i.createFramebuffer()}else q.__webglFramebuffer[fe]=i.createFramebuffer()}else{if(o&&b.mipmaps&&b.mipmaps.length>0){q.__webglFramebuffer=[];for(let fe=0;fe<b.mipmaps.length;fe++)q.__webglFramebuffer[fe]=i.createFramebuffer()}else q.__webglFramebuffer=i.createFramebuffer();if(de)if(r.drawBuffers){const fe=P.texture;for(let J=0,I=fe.length;J<I;J++){const oe=n.get(fe[J]);oe.__webglTexture===void 0&&(oe.__webglTexture=i.createTexture(),c.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(o&&P.samples>0&&st(P)===!1){const fe=de?b:[b];q.__webglMultisampledFramebuffer=i.createFramebuffer(),q.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,q.__webglMultisampledFramebuffer);for(let J=0;J<fe.length;J++){const I=fe[J];q.__webglColorRenderbuffer[J]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,q.__webglColorRenderbuffer[J]);const oe=s.convert(I.format,I.colorSpace),Ee=s.convert(I.type),me=N(I.internalFormat,oe,Ee,I.colorSpace,P.isXRRenderTarget===!0),ye=Ve(P);i.renderbufferStorageMultisample(i.RENDERBUFFER,ye,me,P.width,P.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+J,i.RENDERBUFFER,q.__webglColorRenderbuffer[J])}i.bindRenderbuffer(i.RENDERBUFFER,null),P.depthBuffer&&(q.__webglDepthRenderbuffer=i.createRenderbuffer(),W(q.__webglDepthRenderbuffer,P,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(le){t.bindTexture(i.TEXTURE_CUBE_MAP,ue.__webglTexture),Ue(i.TEXTURE_CUBE_MAP,b,Ce);for(let fe=0;fe<6;fe++)if(o&&b.mipmaps&&b.mipmaps.length>0)for(let J=0;J<b.mipmaps.length;J++)He(q.__webglFramebuffer[fe][J],P,b,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+fe,J);else He(q.__webglFramebuffer[fe],P,b,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0);L(b,Ce)&&w(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(de){const fe=P.texture;for(let J=0,I=fe.length;J<I;J++){const oe=fe[J],Ee=n.get(oe);t.bindTexture(i.TEXTURE_2D,Ee.__webglTexture),Ue(i.TEXTURE_2D,oe,Ce),He(q.__webglFramebuffer,P,oe,i.COLOR_ATTACHMENT0+J,i.TEXTURE_2D,0),L(oe,Ce)&&w(i.TEXTURE_2D)}t.unbindTexture()}else{let fe=i.TEXTURE_2D;if((P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(o?fe=P.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(fe,ue.__webglTexture),Ue(fe,b,Ce),o&&b.mipmaps&&b.mipmaps.length>0)for(let J=0;J<b.mipmaps.length;J++)He(q.__webglFramebuffer[J],P,b,i.COLOR_ATTACHMENT0,fe,J);else He(q.__webglFramebuffer,P,b,i.COLOR_ATTACHMENT0,fe,0);L(b,Ce)&&w(fe),t.unbindTexture()}P.depthBuffer&&Le(P)}function pt(P){const b=C(P)||o,q=P.isWebGLMultipleRenderTargets===!0?P.texture:[P.texture];for(let ue=0,le=q.length;ue<le;ue++){const de=q[ue];if(L(de,b)){const Ce=P.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,fe=n.get(de).__webglTexture;t.bindTexture(Ce,fe),w(Ce),t.unbindTexture()}}}function $e(P){if(o&&P.samples>0&&st(P)===!1){const b=P.isWebGLMultipleRenderTargets?P.texture:[P.texture],q=P.width,ue=P.height;let le=i.COLOR_BUFFER_BIT;const de=[],Ce=P.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,fe=n.get(P),J=P.isWebGLMultipleRenderTargets===!0;if(J)for(let I=0;I<b.length;I++)t.bindFramebuffer(i.FRAMEBUFFER,fe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+I,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,fe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+I,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,fe.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,fe.__webglFramebuffer);for(let I=0;I<b.length;I++){de.push(i.COLOR_ATTACHMENT0+I),P.depthBuffer&&de.push(Ce);const oe=fe.__ignoreDepthValues!==void 0?fe.__ignoreDepthValues:!1;if(oe===!1&&(P.depthBuffer&&(le|=i.DEPTH_BUFFER_BIT),P.stencilBuffer&&(le|=i.STENCIL_BUFFER_BIT)),J&&i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,fe.__webglColorRenderbuffer[I]),oe===!0&&(i.invalidateFramebuffer(i.READ_FRAMEBUFFER,[Ce]),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[Ce])),J){const Ee=n.get(b[I]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ee,0)}i.blitFramebuffer(0,0,q,ue,0,0,q,ue,le,i.NEAREST),_&&i.invalidateFramebuffer(i.READ_FRAMEBUFFER,de)}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),J)for(let I=0;I<b.length;I++){t.bindFramebuffer(i.FRAMEBUFFER,fe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+I,i.RENDERBUFFER,fe.__webglColorRenderbuffer[I]);const oe=n.get(b[I]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,fe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+I,i.TEXTURE_2D,oe,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,fe.__webglMultisampledFramebuffer)}}function Ve(P){return Math.min(d,P.samples)}function st(P){const b=n.get(P);return o&&P.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function Rt(P){const b=c.render.frame;v.get(P)!==b&&(v.set(P,b),P.update())}function St(P,b){const q=P.colorSpace,ue=P.format,le=P.type;return P.isCompressedTexture===!0||P.isVideoTexture===!0||P.format===La||q!==Bn&&q!==Bi&&(q===Et||q===ho?o===!1?e.has("EXT_sRGB")===!0&&ue===Pn?(P.format=La,P.minFilter=Mn,P.generateMipmaps=!1):b=sh.sRGBToLinear(b):(ue!==Pn||le!==vi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",q)),b}this.allocateTextureUnit=U,this.resetTextureUnits=H,this.setTexture2D=ie,this.setTexture2DArray=Y,this.setTexture3D=ee,this.setTextureCube=ve,this.rebindTextures=Ge,this.setupRenderTarget=Be,this.updateRenderTargetMipmap=pt,this.updateMultisampleRenderTarget=$e,this.setupDepthRenderbuffer=Le,this.setupFrameBufferTexture=He,this.useMultisampledRTT=st}const Z0=0,Ut=1;function J0(i,e,t){const n=t.isWebGL2;function r(s,c=Bi){let o;const l=c===Et||c===ho?Ut:Z0;if(s===vi)return i.UNSIGNED_BYTE;if(s===Ju)return i.UNSIGNED_SHORT_4_4_4_4;if(s===Qu)return i.UNSIGNED_SHORT_5_5_5_1;if(s===pp)return i.BYTE;if(s===mp)return i.SHORT;if(s===Na)return i.UNSIGNED_SHORT;if(s===Zu)return i.INT;if(s===pi)return i.UNSIGNED_INT;if(s===mi)return i.FLOAT;if(s===ss)return n?i.HALF_FLOAT:(o=e.get("OES_texture_half_float"),o!==null?o.HALF_FLOAT_OES:null);if(s===gp)return i.ALPHA;if(s===Pn)return i.RGBA;if(s===_p)return i.LUMINANCE;if(s===vp)return i.LUMINANCE_ALPHA;if(s===Oi)return i.DEPTH_COMPONENT;if(s===Cr)return i.DEPTH_STENCIL;if(s===La)return o=e.get("EXT_sRGB"),o!==null?o.SRGB_ALPHA_EXT:null;if(s===xp)return i.RED;if(s===eh)return i.RED_INTEGER;if(s===Mp)return i.RG;if(s===th)return i.RG_INTEGER;if(s===nh)return i.RGBA_INTEGER;if(s===Xo||s===qo||s===Yo||s===jo)if(l===Ut)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(s===Xo)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===qo)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Yo)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===jo)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(s===Xo)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===qo)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Yo)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===jo)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===Ml||s===yl||s===El||s===Sl)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(s===Ml)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===yl)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===El)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===Sl)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===yp)return o=e.get("WEBGL_compressed_texture_etc1"),o!==null?o.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===bl||s===Tl)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(s===bl)return l===Ut?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(s===Tl)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===Al||s===wl||s===Rl||s===Cl||s===Ll||s===Pl||s===Dl||s===Ul||s===Il||s===Nl||s===Ol||s===Fl||s===Bl||s===zl)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(s===Al)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===wl)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===Rl)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===Cl)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===Ll)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===Pl)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===Dl)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Ul)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===Il)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===Nl)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===Ol)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Fl)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===Bl)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===zl)return l===Ut?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===$o||s===Hl||s===kl)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(s===$o)return l===Ut?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===Hl)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===kl)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Ep||s===Gl||s===Vl||s===Wl)if(o=e.get("EXT_texture_compression_rgtc"),o!==null){if(s===$o)return o.COMPRESSED_RED_RGTC1_EXT;if(s===Gl)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===Vl)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Wl)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Ni?n?i.UNSIGNED_INT_24_8:(o=e.get("WEBGL_depth_texture"),o!==null?o.UNSIGNED_INT_24_8_WEBGL:null):i[s]!==void 0?i[s]:null}return{convert:r}}class Q0 extends yn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class qr extends Yt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const ex={type:"move"};class _a{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new qr,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new qr,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new F,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new F),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new qr,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new F,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new F),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let r=null,s=null,c=null;const o=this._targetRay,l=this._grip,u=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(u&&e.hand){c=!0;for(const M of e.hand.values()){const g=t.getJointPose(M,n),m=this._getHandJoint(u,M);g!==null&&(m.matrix.fromArray(g.transform.matrix),m.matrix.decompose(m.position,m.rotation,m.scale),m.matrixWorldNeedsUpdate=!0,m.jointRadius=g.radius),m.visible=g!==null}const h=u.joints["index-finger-tip"],d=u.joints["thumb-tip"],f=h.position.distanceTo(d.position),_=.02,v=.005;u.inputState.pinching&&f>_+v?(u.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!u.inputState.pinching&&f<=_-v&&(u.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=t.getPose(e.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(ex)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),u!==null&&(u.visible=c!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new qr;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}class tx extends on{constructor(e,t,n,r,s,c,o,l,u,h){if(h=h!==void 0?h:Oi,h!==Oi&&h!==Cr)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===Oi&&(n=pi),n===void 0&&h===Cr&&(n=Ni),super(null,r,s,c,o,l,h,n,u),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:nn,this.minFilter=l!==void 0?l:nn,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}class nx extends Gi{constructor(e,t){super();const n=this;let r=null,s=1,c=null,o="local-floor",l=1,u=null,h=null,d=null,f=null,_=null,v=null;const M=t.getContextAttributes();let g=null,m=null;const D=[],T=[],C=new yn;C.layers.enable(1),C.viewport=new zt;const A=new yn;A.layers.enable(2),A.viewport=new zt;const L=[C,A],w=new Q0;w.layers.enable(1),w.layers.enable(2);let N=null,y=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Y){let ee=D[Y];return ee===void 0&&(ee=new _a,D[Y]=ee),ee.getTargetRaySpace()},this.getControllerGrip=function(Y){let ee=D[Y];return ee===void 0&&(ee=new _a,D[Y]=ee),ee.getGripSpace()},this.getHand=function(Y){let ee=D[Y];return ee===void 0&&(ee=new _a,D[Y]=ee),ee.getHandSpace()};function S(Y){const ee=T.indexOf(Y.inputSource);if(ee===-1)return;const ve=D[ee];ve!==void 0&&(ve.update(Y.inputSource,Y.frame,u||c),ve.dispatchEvent({type:Y.type,data:Y.inputSource}))}function V(){r.removeEventListener("select",S),r.removeEventListener("selectstart",S),r.removeEventListener("selectend",S),r.removeEventListener("squeeze",S),r.removeEventListener("squeezestart",S),r.removeEventListener("squeezeend",S),r.removeEventListener("end",V),r.removeEventListener("inputsourceschange",Z);for(let Y=0;Y<D.length;Y++){const ee=T[Y];ee!==null&&(T[Y]=null,D[Y].disconnect(ee))}N=null,y=null,e.setRenderTarget(g),_=null,f=null,d=null,r=null,m=null,ie.stop(),n.isPresenting=!1,n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Y){s=Y,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Y){o=Y,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||c},this.setReferenceSpace=function(Y){u=Y},this.getBaseLayer=function(){return f!==null?f:_},this.getBinding=function(){return d},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(Y){if(r=Y,r!==null){if(g=e.getRenderTarget(),r.addEventListener("select",S),r.addEventListener("selectstart",S),r.addEventListener("selectend",S),r.addEventListener("squeeze",S),r.addEventListener("squeezestart",S),r.addEventListener("squeezeend",S),r.addEventListener("end",V),r.addEventListener("inputsourceschange",Z),M.xrCompatible!==!0&&await t.makeXRCompatible(),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const ee={antialias:r.renderState.layers===void 0?M.antialias:!0,alpha:!0,depth:M.depth,stencil:M.stencil,framebufferScaleFactor:s};_=new XRWebGLLayer(r,t,ee),r.updateRenderState({baseLayer:_}),m=new zi(_.framebufferWidth,_.framebufferHeight,{format:Pn,type:vi,colorSpace:e.outputColorSpace,stencilBuffer:M.stencil})}else{let ee=null,ve=null,_e=null;M.depth&&(_e=M.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ee=M.stencil?Cr:Oi,ve=M.stencil?Ni:pi);const Te={colorFormat:t.RGBA8,depthFormat:_e,scaleFactor:s};d=new XRWebGLBinding(r,t),f=d.createProjectionLayer(Te),r.updateRenderState({layers:[f]}),m=new zi(f.textureWidth,f.textureHeight,{format:Pn,type:vi,depthTexture:new tx(f.textureWidth,f.textureHeight,ve,void 0,void 0,void 0,void 0,void 0,void 0,ee),stencilBuffer:M.stencil,colorSpace:e.outputColorSpace,samples:M.antialias?4:0});const ce=e.properties.get(m);ce.__ignoreDepthValues=f.ignoreDepthValues}m.isXRRenderTarget=!0,this.setFoveation(l),u=null,c=await r.requestReferenceSpace(o),ie.setContext(r),ie.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function Z(Y){for(let ee=0;ee<Y.removed.length;ee++){const ve=Y.removed[ee],_e=T.indexOf(ve);_e>=0&&(T[_e]=null,D[_e].disconnect(ve))}for(let ee=0;ee<Y.added.length;ee++){const ve=Y.added[ee];let _e=T.indexOf(ve);if(_e===-1){for(let ce=0;ce<D.length;ce++)if(ce>=T.length){T.push(ve),_e=ce;break}else if(T[ce]===null){T[ce]=ve,_e=ce;break}if(_e===-1)break}const Te=D[_e];Te&&Te.connect(ve)}}const G=new F,j=new F;function $(Y,ee,ve){G.setFromMatrixPosition(ee.matrixWorld),j.setFromMatrixPosition(ve.matrixWorld);const _e=G.distanceTo(j),Te=ee.projectionMatrix.elements,ce=ve.projectionMatrix.elements,Ue=Te[14]/(Te[10]-1),De=Te[14]/(Te[10]+1),rt=(Te[9]+1)/Te[5],Dt=(Te[9]-1)/Te[5],He=(Te[8]-1)/Te[0],W=(ce[8]+1)/ce[0],Mt=Ue*He,Le=Ue*W,Ge=_e/(-He+W),Be=Ge*-He;ee.matrixWorld.decompose(Y.position,Y.quaternion,Y.scale),Y.translateX(Be),Y.translateZ(Ge),Y.matrixWorld.compose(Y.position,Y.quaternion,Y.scale),Y.matrixWorldInverse.copy(Y.matrixWorld).invert();const pt=Ue+Ge,$e=De+Ge,Ve=Mt-Be,st=Le+(_e-Be),Rt=rt*De/$e*pt,St=Dt*De/$e*pt;Y.projectionMatrix.makePerspective(Ve,st,Rt,St,pt,$e),Y.projectionMatrixInverse.copy(Y.projectionMatrix).invert()}function re(Y,ee){ee===null?Y.matrixWorld.copy(Y.matrix):Y.matrixWorld.multiplyMatrices(ee.matrixWorld,Y.matrix),Y.matrixWorldInverse.copy(Y.matrixWorld).invert()}this.updateCamera=function(Y){if(r===null)return;w.near=A.near=C.near=Y.near,w.far=A.far=C.far=Y.far,(N!==w.near||y!==w.far)&&(r.updateRenderState({depthNear:w.near,depthFar:w.far}),N=w.near,y=w.far);const ee=Y.parent,ve=w.cameras;re(w,ee);for(let _e=0;_e<ve.length;_e++)re(ve[_e],ee);ve.length===2?$(w,C,A):w.projectionMatrix.copy(C.projectionMatrix),H(Y,w,ee)};function H(Y,ee,ve){ve===null?Y.matrix.copy(ee.matrixWorld):(Y.matrix.copy(ve.matrixWorld),Y.matrix.invert(),Y.matrix.multiply(ee.matrixWorld)),Y.matrix.decompose(Y.position,Y.quaternion,Y.scale),Y.updateMatrixWorld(!0),Y.projectionMatrix.copy(ee.projectionMatrix),Y.projectionMatrixInverse.copy(ee.projectionMatrixInverse),Y.isPerspectiveCamera&&(Y.fov=os*2*Math.atan(1/Y.projectionMatrix.elements[5]),Y.zoom=1)}this.getCamera=function(){return w},this.getFoveation=function(){if(!(f===null&&_===null))return l},this.setFoveation=function(Y){l=Y,f!==null&&(f.fixedFoveation=Y),_!==null&&_.fixedFoveation!==void 0&&(_.fixedFoveation=Y)};let U=null;function se(Y,ee){if(h=ee.getViewerPose(u||c),v=ee,h!==null){const ve=h.views;_!==null&&(e.setRenderTargetFramebuffer(m,_.framebuffer),e.setRenderTarget(m));let _e=!1;ve.length!==w.cameras.length&&(w.cameras.length=0,_e=!0);for(let Te=0;Te<ve.length;Te++){const ce=ve[Te];let Ue=null;if(_!==null)Ue=_.getViewport(ce);else{const rt=d.getViewSubImage(f,ce);Ue=rt.viewport,Te===0&&(e.setRenderTargetTextures(m,rt.colorTexture,f.ignoreDepthValues?void 0:rt.depthStencilTexture),e.setRenderTarget(m))}let De=L[Te];De===void 0&&(De=new yn,De.layers.enable(Te),De.viewport=new zt,L[Te]=De),De.matrix.fromArray(ce.transform.matrix),De.matrix.decompose(De.position,De.quaternion,De.scale),De.projectionMatrix.fromArray(ce.projectionMatrix),De.projectionMatrixInverse.copy(De.projectionMatrix).invert(),De.viewport.set(Ue.x,Ue.y,Ue.width,Ue.height),Te===0&&(w.matrix.copy(De.matrix),w.matrix.decompose(w.position,w.quaternion,w.scale)),_e===!0&&w.cameras.push(De)}}for(let ve=0;ve<D.length;ve++){const _e=T[ve],Te=D[ve];_e!==null&&Te!==void 0&&Te.update(_e,ee,u||c)}U&&U(Y,ee),ee.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ee}),v=null}const ie=new gh;ie.setAnimationLoop(se),this.setAnimationLoop=function(Y){U=Y},this.dispose=function(){}}}function ix(i,e){function t(g,m){g.matrixAutoUpdate===!0&&g.updateMatrix(),m.value.copy(g.matrix)}function n(g,m){m.color.getRGB(g.fogColor.value,fh(i)),m.isFog?(g.fogNear.value=m.near,g.fogFar.value=m.far):m.isFogExp2&&(g.fogDensity.value=m.density)}function r(g,m,D,T,C){m.isMeshBasicMaterial||m.isMeshLambertMaterial?s(g,m):m.isMeshToonMaterial?(s(g,m),d(g,m)):m.isMeshPhongMaterial?(s(g,m),h(g,m)):m.isMeshStandardMaterial?(s(g,m),f(g,m),m.isMeshPhysicalMaterial&&_(g,m,C)):m.isMeshMatcapMaterial?(s(g,m),v(g,m)):m.isMeshDepthMaterial?s(g,m):m.isMeshDistanceMaterial?(s(g,m),M(g,m)):m.isMeshNormalMaterial?s(g,m):m.isLineBasicMaterial?(c(g,m),m.isLineDashedMaterial&&o(g,m)):m.isPointsMaterial?l(g,m,D,T):m.isSpriteMaterial?u(g,m):m.isShadowMaterial?(g.color.value.copy(m.color),g.opacity.value=m.opacity):m.isShaderMaterial&&(m.uniformsNeedUpdate=!1)}function s(g,m){g.opacity.value=m.opacity,m.color&&g.diffuse.value.copy(m.color),m.emissive&&g.emissive.value.copy(m.emissive).multiplyScalar(m.emissiveIntensity),m.map&&(g.map.value=m.map,t(m.map,g.mapTransform)),m.alphaMap&&(g.alphaMap.value=m.alphaMap,t(m.alphaMap,g.alphaMapTransform)),m.bumpMap&&(g.bumpMap.value=m.bumpMap,t(m.bumpMap,g.bumpMapTransform),g.bumpScale.value=m.bumpScale,m.side===sn&&(g.bumpScale.value*=-1)),m.normalMap&&(g.normalMap.value=m.normalMap,t(m.normalMap,g.normalMapTransform),g.normalScale.value.copy(m.normalScale),m.side===sn&&g.normalScale.value.negate()),m.displacementMap&&(g.displacementMap.value=m.displacementMap,t(m.displacementMap,g.displacementMapTransform),g.displacementScale.value=m.displacementScale,g.displacementBias.value=m.displacementBias),m.emissiveMap&&(g.emissiveMap.value=m.emissiveMap,t(m.emissiveMap,g.emissiveMapTransform)),m.specularMap&&(g.specularMap.value=m.specularMap,t(m.specularMap,g.specularMapTransform)),m.alphaTest>0&&(g.alphaTest.value=m.alphaTest);const D=e.get(m).envMap;if(D&&(g.envMap.value=D,g.flipEnvMap.value=D.isCubeTexture&&D.isRenderTargetTexture===!1?-1:1,g.reflectivity.value=m.reflectivity,g.ior.value=m.ior,g.refractionRatio.value=m.refractionRatio),m.lightMap){g.lightMap.value=m.lightMap;const T=i._useLegacyLights===!0?Math.PI:1;g.lightMapIntensity.value=m.lightMapIntensity*T,t(m.lightMap,g.lightMapTransform)}m.aoMap&&(g.aoMap.value=m.aoMap,g.aoMapIntensity.value=m.aoMapIntensity,t(m.aoMap,g.aoMapTransform))}function c(g,m){g.diffuse.value.copy(m.color),g.opacity.value=m.opacity,m.map&&(g.map.value=m.map,t(m.map,g.mapTransform))}function o(g,m){g.dashSize.value=m.dashSize,g.totalSize.value=m.dashSize+m.gapSize,g.scale.value=m.scale}function l(g,m,D,T){g.diffuse.value.copy(m.color),g.opacity.value=m.opacity,g.size.value=m.size*D,g.scale.value=T*.5,m.map&&(g.map.value=m.map,t(m.map,g.uvTransform)),m.alphaMap&&(g.alphaMap.value=m.alphaMap,t(m.alphaMap,g.alphaMapTransform)),m.alphaTest>0&&(g.alphaTest.value=m.alphaTest)}function u(g,m){g.diffuse.value.copy(m.color),g.opacity.value=m.opacity,g.rotation.value=m.rotation,m.map&&(g.map.value=m.map,t(m.map,g.mapTransform)),m.alphaMap&&(g.alphaMap.value=m.alphaMap,t(m.alphaMap,g.alphaMapTransform)),m.alphaTest>0&&(g.alphaTest.value=m.alphaTest)}function h(g,m){g.specular.value.copy(m.specular),g.shininess.value=Math.max(m.shininess,1e-4)}function d(g,m){m.gradientMap&&(g.gradientMap.value=m.gradientMap)}function f(g,m){g.metalness.value=m.metalness,m.metalnessMap&&(g.metalnessMap.value=m.metalnessMap,t(m.metalnessMap,g.metalnessMapTransform)),g.roughness.value=m.roughness,m.roughnessMap&&(g.roughnessMap.value=m.roughnessMap,t(m.roughnessMap,g.roughnessMapTransform)),e.get(m).envMap&&(g.envMapIntensity.value=m.envMapIntensity)}function _(g,m,D){g.ior.value=m.ior,m.sheen>0&&(g.sheenColor.value.copy(m.sheenColor).multiplyScalar(m.sheen),g.sheenRoughness.value=m.sheenRoughness,m.sheenColorMap&&(g.sheenColorMap.value=m.sheenColorMap,t(m.sheenColorMap,g.sheenColorMapTransform)),m.sheenRoughnessMap&&(g.sheenRoughnessMap.value=m.sheenRoughnessMap,t(m.sheenRoughnessMap,g.sheenRoughnessMapTransform))),m.clearcoat>0&&(g.clearcoat.value=m.clearcoat,g.clearcoatRoughness.value=m.clearcoatRoughness,m.clearcoatMap&&(g.clearcoatMap.value=m.clearcoatMap,t(m.clearcoatMap,g.clearcoatMapTransform)),m.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=m.clearcoatRoughnessMap,t(m.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),m.clearcoatNormalMap&&(g.clearcoatNormalMap.value=m.clearcoatNormalMap,t(m.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(m.clearcoatNormalScale),m.side===sn&&g.clearcoatNormalScale.value.negate())),m.iridescence>0&&(g.iridescence.value=m.iridescence,g.iridescenceIOR.value=m.iridescenceIOR,g.iridescenceThicknessMinimum.value=m.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=m.iridescenceThicknessRange[1],m.iridescenceMap&&(g.iridescenceMap.value=m.iridescenceMap,t(m.iridescenceMap,g.iridescenceMapTransform)),m.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=m.iridescenceThicknessMap,t(m.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),m.transmission>0&&(g.transmission.value=m.transmission,g.transmissionSamplerMap.value=D.texture,g.transmissionSamplerSize.value.set(D.width,D.height),m.transmissionMap&&(g.transmissionMap.value=m.transmissionMap,t(m.transmissionMap,g.transmissionMapTransform)),g.thickness.value=m.thickness,m.thicknessMap&&(g.thicknessMap.value=m.thicknessMap,t(m.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=m.attenuationDistance,g.attenuationColor.value.copy(m.attenuationColor)),m.anisotropy>0&&(g.anisotropyVector.value.set(m.anisotropy*Math.cos(m.anisotropyRotation),m.anisotropy*Math.sin(m.anisotropyRotation)),m.anisotropyMap&&(g.anisotropyMap.value=m.anisotropyMap,t(m.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=m.specularIntensity,g.specularColor.value.copy(m.specularColor),m.specularColorMap&&(g.specularColorMap.value=m.specularColorMap,t(m.specularColorMap,g.specularColorMapTransform)),m.specularIntensityMap&&(g.specularIntensityMap.value=m.specularIntensityMap,t(m.specularIntensityMap,g.specularIntensityMapTransform))}function v(g,m){m.matcap&&(g.matcap.value=m.matcap)}function M(g,m){const D=e.get(m).light;g.referencePosition.value.setFromMatrixPosition(D.matrixWorld),g.nearDistance.value=D.shadow.camera.near,g.farDistance.value=D.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function rx(i,e,t,n){let r={},s={},c=[];const o=t.isWebGL2?i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(D,T){const C=T.program;n.uniformBlockBinding(D,C)}function u(D,T){let C=r[D.id];C===void 0&&(v(D),C=h(D),r[D.id]=C,D.addEventListener("dispose",g));const A=T.program;n.updateUBOMapping(D,A);const L=e.render.frame;s[D.id]!==L&&(f(D),s[D.id]=L)}function h(D){const T=d();D.__bindingPointIndex=T;const C=i.createBuffer(),A=D.__size,L=D.usage;return i.bindBuffer(i.UNIFORM_BUFFER,C),i.bufferData(i.UNIFORM_BUFFER,A,L),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,T,C),C}function d(){for(let D=0;D<o;D++)if(c.indexOf(D)===-1)return c.push(D),D;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(D){const T=r[D.id],C=D.uniforms,A=D.__cache;i.bindBuffer(i.UNIFORM_BUFFER,T);for(let L=0,w=C.length;L<w;L++){const N=C[L];if(_(N,L,A)===!0){const y=N.__offset,S=Array.isArray(N.value)?N.value:[N.value];let V=0;for(let Z=0;Z<S.length;Z++){const G=S[Z],j=M(G);typeof G=="number"?(N.__data[0]=G,i.bufferSubData(i.UNIFORM_BUFFER,y+V,N.__data)):G.isMatrix3?(N.__data[0]=G.elements[0],N.__data[1]=G.elements[1],N.__data[2]=G.elements[2],N.__data[3]=G.elements[0],N.__data[4]=G.elements[3],N.__data[5]=G.elements[4],N.__data[6]=G.elements[5],N.__data[7]=G.elements[0],N.__data[8]=G.elements[6],N.__data[9]=G.elements[7],N.__data[10]=G.elements[8],N.__data[11]=G.elements[0]):(G.toArray(N.__data,V),V+=j.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,y,N.__data)}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function _(D,T,C){const A=D.value;if(C[T]===void 0){if(typeof A=="number")C[T]=A;else{const L=Array.isArray(A)?A:[A],w=[];for(let N=0;N<L.length;N++)w.push(L[N].clone());C[T]=w}return!0}else if(typeof A=="number"){if(C[T]!==A)return C[T]=A,!0}else{const L=Array.isArray(C[T])?C[T]:[C[T]],w=Array.isArray(A)?A:[A];for(let N=0;N<L.length;N++){const y=L[N];if(y.equals(w[N])===!1)return y.copy(w[N]),!0}}return!1}function v(D){const T=D.uniforms;let C=0;const A=16;let L=0;for(let w=0,N=T.length;w<N;w++){const y=T[w],S={boundary:0,storage:0},V=Array.isArray(y.value)?y.value:[y.value];for(let Z=0,G=V.length;Z<G;Z++){const j=V[Z],$=M(j);S.boundary+=$.boundary,S.storage+=$.storage}if(y.__data=new Float32Array(S.storage/Float32Array.BYTES_PER_ELEMENT),y.__offset=C,w>0){L=C%A;const Z=A-L;L!==0&&Z-S.boundary<0&&(C+=A-L,y.__offset=C)}C+=S.storage}return L=C%A,L>0&&(C+=A-L),D.__size=C,D.__cache={},this}function M(D){const T={boundary:0,storage:0};return typeof D=="number"?(T.boundary=4,T.storage=4):D.isVector2?(T.boundary=8,T.storage=8):D.isVector3||D.isColor?(T.boundary=16,T.storage=12):D.isVector4?(T.boundary=16,T.storage=16):D.isMatrix3?(T.boundary=48,T.storage=48):D.isMatrix4?(T.boundary=64,T.storage=64):D.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",D),T}function g(D){const T=D.target;T.removeEventListener("dispose",g);const C=c.indexOf(T.__bindingPointIndex);c.splice(C,1),i.deleteBuffer(r[T.id]),delete r[T.id],delete s[T.id]}function m(){for(const D in r)i.deleteBuffer(r[D]);c=[],r={},s={}}return{bind:l,update:u,dispose:m}}class Eh{constructor(e={}){const{canvas:t=Zp(),context:n=null,depth:r=!0,stencil:s=!0,alpha:c=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:d=!1}=e;this.isWebGLRenderer=!0;let f;n!==null?f=n.getContextAttributes().alpha:f=c;const _=new Uint32Array(4),v=new Int32Array(4);let M=null,g=null;const m=[],D=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.outputColorSpace=Et,this._useLegacyLights=!1,this.toneMapping=_i,this.toneMappingExposure=1;const T=this;let C=!1,A=0,L=0,w=null,N=-1,y=null;const S=new zt,V=new zt;let Z=null;const G=new _t(0);let j=0,$=t.width,re=t.height,H=1,U=null,se=null;const ie=new zt(0,0,$,re),Y=new zt(0,0,$,re);let ee=!1;const ve=new Ba;let _e=!1,Te=!1,ce=null;const Ue=new Pt,De=new Re,rt=new F,Dt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function He(){return w===null?H:1}let W=n;function Mt(R,k){for(let K=0;K<R.length;K++){const X=R[K],ne=t.getContext(X,k);if(ne!==null)return ne}return null}try{const R={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:h,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Ia}`),t.addEventListener("webglcontextlost",xe,!1),t.addEventListener("webglcontextrestored",Q,!1),t.addEventListener("webglcontextcreationerror",he,!1),W===null){const k=["webgl2","webgl","experimental-webgl"];if(T.isWebGL1Renderer===!0&&k.shift(),W=Mt(k,R),W===null)throw Mt(k)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&W instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),W.getShaderPrecisionFormat===void 0&&(W.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(R){throw console.error("THREE.WebGLRenderer: "+R.message),R}let Le,Ge,Be,pt,$e,Ve,st,Rt,St,P,b,q,ue,le,de,Ce,fe,J,I,oe,Ee,me,ye,ze;function Ke(){Le=new pv(W),Ge=new cv(W,Le,e),Le.init(Ge),me=new J0(W,Le,Ge),Be=new $0(W,Le,Ge),pt=new _v(W),$e=new N0,Ve=new K0(W,Le,Be,$e,Ge,me,pt),st=new uv(T),Rt=new fv(T),St=new wm(W,Ge),ye=new ov(W,Le,St,Ge),P=new mv(W,St,pt,ye),b=new yv(W,P,St,pt),I=new Mv(W,Ge,Ve),Ce=new lv($e),q=new I0(T,st,Rt,Le,Ge,ye,Ce),ue=new ix(T,$e),le=new F0,de=new V0(Le,Ge),J=new sv(T,st,Rt,Be,b,f,l),fe=new j0(T,b,Ge),ze=new rx(W,pt,Ge,Be),oe=new av(W,Le,pt,Ge),Ee=new gv(W,Le,pt,Ge),pt.programs=q.programs,T.capabilities=Ge,T.extensions=Le,T.properties=$e,T.renderLists=le,T.shadowMap=fe,T.state=Be,T.info=pt}Ke();const O=new nx(T,W);this.xr=O,this.getContext=function(){return W},this.getContextAttributes=function(){return W.getContextAttributes()},this.forceContextLoss=function(){const R=Le.get("WEBGL_lose_context");R&&R.loseContext()},this.forceContextRestore=function(){const R=Le.get("WEBGL_lose_context");R&&R.restoreContext()},this.getPixelRatio=function(){return H},this.setPixelRatio=function(R){R!==void 0&&(H=R,this.setSize($,re,!1))},this.getSize=function(R){return R.set($,re)},this.setSize=function(R,k,K=!0){if(O.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}$=R,re=k,t.width=Math.floor(R*H),t.height=Math.floor(k*H),K===!0&&(t.style.width=R+"px",t.style.height=k+"px"),this.setViewport(0,0,R,k)},this.getDrawingBufferSize=function(R){return R.set($*H,re*H).floor()},this.setDrawingBufferSize=function(R,k,K){$=R,re=k,H=K,t.width=Math.floor(R*K),t.height=Math.floor(k*K),this.setViewport(0,0,R,k)},this.getCurrentViewport=function(R){return R.copy(S)},this.getViewport=function(R){return R.copy(ie)},this.setViewport=function(R,k,K,X){R.isVector4?ie.set(R.x,R.y,R.z,R.w):ie.set(R,k,K,X),Be.viewport(S.copy(ie).multiplyScalar(H).floor())},this.getScissor=function(R){return R.copy(Y)},this.setScissor=function(R,k,K,X){R.isVector4?Y.set(R.x,R.y,R.z,R.w):Y.set(R,k,K,X),Be.scissor(V.copy(Y).multiplyScalar(H).floor())},this.getScissorTest=function(){return ee},this.setScissorTest=function(R){Be.setScissorTest(ee=R)},this.setOpaqueSort=function(R){U=R},this.setTransparentSort=function(R){se=R},this.getClearColor=function(R){return R.copy(J.getClearColor())},this.setClearColor=function(){J.setClearColor.apply(J,arguments)},this.getClearAlpha=function(){return J.getClearAlpha()},this.setClearAlpha=function(){J.setClearAlpha.apply(J,arguments)},this.clear=function(R=!0,k=!0,K=!0){let X=0;if(R){let ne=!1;if(w!==null){const be=w.texture.format;ne=be===nh||be===th||be===eh}if(ne){const be=w.texture.type,Pe=be===vi||be===pi||be===Na||be===Ni||be===Ju||be===Qu,Fe=J.getClearColor(),Ie=J.getClearAlpha(),We=Fe.r,Ne=Fe.g,Xe=Fe.b;Pe?(_[0]=We,_[1]=Ne,_[2]=Xe,_[3]=Ie,W.clearBufferuiv(W.COLOR,0,_)):(v[0]=We,v[1]=Ne,v[2]=Xe,v[3]=Ie,W.clearBufferiv(W.COLOR,0,v))}else X|=W.COLOR_BUFFER_BIT}k&&(X|=W.DEPTH_BUFFER_BIT),K&&(X|=W.STENCIL_BUFFER_BIT),W.clear(X)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",xe,!1),t.removeEventListener("webglcontextrestored",Q,!1),t.removeEventListener("webglcontextcreationerror",he,!1),le.dispose(),de.dispose(),$e.dispose(),st.dispose(),Rt.dispose(),b.dispose(),ye.dispose(),ze.dispose(),q.dispose(),O.dispose(),O.removeEventListener("sessionstart",mt),O.removeEventListener("sessionend",hn),ce&&(ce.dispose(),ce=null),Ht.stop()};function xe(R){R.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),C=!0}function Q(){console.log("THREE.WebGLRenderer: Context Restored."),C=!1;const R=pt.autoReset,k=fe.enabled,K=fe.autoUpdate,X=fe.needsUpdate,ne=fe.type;Ke(),pt.autoReset=R,fe.enabled=k,fe.autoUpdate=K,fe.needsUpdate=X,fe.type=ne}function he(R){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",R.statusMessage)}function pe(R){const k=R.target;k.removeEventListener("dispose",pe),Qe(k)}function Qe(R){it(R),$e.remove(R)}function it(R){const k=$e.get(R).programs;k!==void 0&&(k.forEach(function(K){q.releaseProgram(K)}),R.isShaderMaterial&&q.releaseShaderCache(R))}this.renderBufferDirect=function(R,k,K,X,ne,be){k===null&&(k=Dt);const Pe=ne.isMesh&&ne.matrixWorld.determinant()<0,Fe=go(R,k,K,X,ne);Be.setMaterial(X,Pe);let Ie=K.index,We=1;if(X.wireframe===!0){if(Ie=P.getWireframeAttribute(K),Ie===void 0)return;We=2}const Ne=K.drawRange,Xe=K.attributes.position;let vt=Ne.start*We,yt=(Ne.start+Ne.count)*We;be!==null&&(vt=Math.max(vt,be.start*We),yt=Math.min(yt,(be.start+be.count)*We)),Ie!==null?(vt=Math.max(vt,0),yt=Math.min(yt,Ie.count)):Xe!=null&&(vt=Math.max(vt,0),yt=Math.min(yt,Xe.count));const Kt=yt-vt;if(Kt<0||Kt===1/0)return;ye.setup(ne,X,Fe,K,Ie);let dn,bt=oe;if(Ie!==null&&(dn=St.get(Ie),bt=Ee,bt.setIndex(dn)),ne.isMesh)X.wireframe===!0?(Be.setLineWidth(X.wireframeLinewidth*He()),bt.setMode(W.LINES)):bt.setMode(W.TRIANGLES);else if(ne.isLine){let et=X.linewidth;et===void 0&&(et=1),Be.setLineWidth(et*He()),ne.isLineSegments?bt.setMode(W.LINES):ne.isLineLoop?bt.setMode(W.LINE_LOOP):bt.setMode(W.LINE_STRIP)}else ne.isPoints?bt.setMode(W.POINTS):ne.isSprite&&bt.setMode(W.TRIANGLES);if(ne.isInstancedMesh)bt.renderInstances(vt,Kt,ne.count);else if(K.isInstancedBufferGeometry){const et=K._maxInstanceCount!==void 0?K._maxInstanceCount:1/0,Wi=Math.min(K.instanceCount,et);bt.renderInstances(vt,Kt,Wi)}else bt.render(vt,Kt)},this.compile=function(R,k){function K(X,ne,be){X.transparent===!0&&X.side===Jn&&X.forceSinglePass===!1?(X.side=sn,X.needsUpdate=!0,ni(X,ne,be),X.side=xi,X.needsUpdate=!0,ni(X,ne,be),X.side=Jn):ni(X,ne,be)}g=de.get(R),g.init(),D.push(g),R.traverseVisible(function(X){X.isLight&&X.layers.test(k.layers)&&(g.pushLight(X),X.castShadow&&g.pushShadow(X))}),g.setupLights(T._useLegacyLights),R.traverse(function(X){const ne=X.material;if(ne)if(Array.isArray(ne))for(let be=0;be<ne.length;be++){const Pe=ne[be];K(Pe,R,X)}else K(ne,R,X)}),D.pop(),g=null};let at=null;function $t(R){at&&at(R)}function mt(){Ht.stop()}function hn(){Ht.start()}const Ht=new gh;Ht.setAnimationLoop($t),typeof self<"u"&&Ht.setContext(self),this.setAnimationLoop=function(R){at=R,O.setAnimationLoop(R),R===null?Ht.stop():Ht.start()},O.addEventListener("sessionstart",mt),O.addEventListener("sessionend",hn),this.render=function(R,k){if(k!==void 0&&k.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(C===!0)return;R.matrixWorldAutoUpdate===!0&&R.updateMatrixWorld(),k.parent===null&&k.matrixWorldAutoUpdate===!0&&k.updateMatrixWorld(),O.enabled===!0&&O.isPresenting===!0&&(O.cameraAutoUpdate===!0&&O.updateCamera(k),k=O.getCamera()),R.isScene===!0&&R.onBeforeRender(T,R,k,w),g=de.get(R,D.length),g.init(),D.push(g),Ue.multiplyMatrices(k.projectionMatrix,k.matrixWorldInverse),ve.setFromProjectionMatrix(Ue),Te=this.localClippingEnabled,_e=Ce.init(this.clippingPlanes,Te),M=le.get(R,m.length),M.init(),m.push(M),ls(R,k,0,T.sortObjects),M.finish(),T.sortObjects===!0&&M.sort(U,se),this.info.render.frame++,_e===!0&&Ce.beginShadows();const K=g.state.shadowsArray;if(fe.render(K,R,k),_e===!0&&Ce.endShadows(),this.info.autoReset===!0&&this.info.reset(),J.render(M,R),g.setupLights(T._useLegacyLights),k.isArrayCamera){const X=k.cameras;for(let ne=0,be=X.length;ne<be;ne++){const Pe=X[ne];Vi(M,R,Pe,Pe.viewport)}}else Vi(M,R,k);w!==null&&(Ve.updateMultisampleRenderTarget(w),Ve.updateRenderTargetMipmap(w)),R.isScene===!0&&R.onAfterRender(T,R,k),ye.resetDefaultState(),N=-1,y=null,D.pop(),D.length>0?g=D[D.length-1]:g=null,m.pop(),m.length>0?M=m[m.length-1]:M=null};function ls(R,k,K,X){if(R.visible===!1)return;if(R.layers.test(k.layers)){if(R.isGroup)K=R.renderOrder;else if(R.isLOD)R.autoUpdate===!0&&R.update(k);else if(R.isLight)g.pushLight(R),R.castShadow&&g.pushShadow(R);else if(R.isSprite){if(!R.frustumCulled||ve.intersectsSprite(R)){X&&rt.setFromMatrixPosition(R.matrixWorld).applyMatrix4(Ue);const Pe=b.update(R),Fe=R.material;Fe.visible&&M.push(R,Pe,Fe,K,rt.z,null)}}else if((R.isMesh||R.isLine||R.isPoints)&&(!R.frustumCulled||ve.intersectsObject(R))){const Pe=b.update(R),Fe=R.material;if(X&&(R.boundingSphere!==void 0?(R.boundingSphere===null&&R.computeBoundingSphere(),rt.copy(R.boundingSphere.center)):(Pe.boundingSphere===null&&Pe.computeBoundingSphere(),rt.copy(Pe.boundingSphere.center)),rt.applyMatrix4(R.matrixWorld).applyMatrix4(Ue)),Array.isArray(Fe)){const Ie=Pe.groups;for(let We=0,Ne=Ie.length;We<Ne;We++){const Xe=Ie[We],vt=Fe[Xe.materialIndex];vt&&vt.visible&&M.push(R,Pe,vt,K,rt.z,Xe)}}else Fe.visible&&M.push(R,Pe,Fe,K,rt.z,null)}}const be=R.children;for(let Pe=0,Fe=be.length;Pe<Fe;Pe++)ls(be[Pe],k,K,X)}function Vi(R,k,K,X){const ne=R.opaque,be=R.transmissive,Pe=R.transparent;g.setupLightsView(K),_e===!0&&Ce.setGlobalState(T.clippingPlanes,K),be.length>0&&ti(ne,be,k,K),X&&Be.viewport(S.copy(X)),ne.length>0&&Hn(ne,k,K),be.length>0&&Hn(be,k,K),Pe.length>0&&Hn(Pe,k,K),Be.buffers.depth.setTest(!0),Be.buffers.depth.setMask(!0),Be.buffers.color.setMask(!0),Be.setPolygonOffset(!1)}function ti(R,k,K,X){const ne=Ge.isWebGL2;ce===null&&(ce=new zi(1,1,{generateMipmaps:!0,type:Le.has("EXT_color_buffer_half_float")?ss:vi,minFilter:rs,samples:ne?4:0})),T.getDrawingBufferSize(De),ne?ce.setSize(De.x,De.y):ce.setSize(co(De.x),co(De.y));const be=T.getRenderTarget();T.setRenderTarget(ce),T.getClearColor(G),j=T.getClearAlpha(),j<1&&T.setClearColor(16777215,.5),T.clear();const Pe=T.toneMapping;T.toneMapping=_i,Hn(R,K,X),Ve.updateMultisampleRenderTarget(ce),Ve.updateRenderTargetMipmap(ce);let Fe=!1;for(let Ie=0,We=k.length;Ie<We;Ie++){const Ne=k[Ie],Xe=Ne.object,vt=Ne.geometry,yt=Ne.material,Kt=Ne.group;if(yt.side===Jn&&Xe.layers.test(X.layers)){const dn=yt.side;yt.side=sn,yt.needsUpdate=!0,us(Xe,K,X,vt,yt,Kt),yt.side=dn,yt.needsUpdate=!0,Fe=!0}}Fe===!0&&(Ve.updateMultisampleRenderTarget(ce),Ve.updateRenderTargetMipmap(ce)),T.setRenderTarget(be),T.setClearColor(G,j),T.toneMapping=Pe}function Hn(R,k,K){const X=k.isScene===!0?k.overrideMaterial:null;for(let ne=0,be=R.length;ne<be;ne++){const Pe=R[ne],Fe=Pe.object,Ie=Pe.geometry,We=X===null?Pe.material:X,Ne=Pe.group;Fe.layers.test(K.layers)&&us(Fe,k,K,Ie,We,Ne)}}function us(R,k,K,X,ne,be){R.onBeforeRender(T,k,K,X,ne,be),R.modelViewMatrix.multiplyMatrices(K.matrixWorldInverse,R.matrixWorld),R.normalMatrix.getNormalMatrix(R.modelViewMatrix),ne.onBeforeRender(T,k,K,X,R,be),ne.transparent===!0&&ne.side===Jn&&ne.forceSinglePass===!1?(ne.side=sn,ne.needsUpdate=!0,T.renderBufferDirect(K,k,X,ne,R,be),ne.side=xi,ne.needsUpdate=!0,T.renderBufferDirect(K,k,X,ne,R,be),ne.side=Jn):T.renderBufferDirect(K,k,X,ne,R,be),R.onAfterRender(T,k,K,X,ne,be)}function ni(R,k,K){k.isScene!==!0&&(k=Dt);const X=$e.get(R),ne=g.state.lights,be=g.state.shadowsArray,Pe=ne.state.version,Fe=q.getParameters(R,ne.state,be,k,K),Ie=q.getProgramCacheKey(Fe);let We=X.programs;X.environment=R.isMeshStandardMaterial?k.environment:null,X.fog=k.fog,X.envMap=(R.isMeshStandardMaterial?Rt:st).get(R.envMap||X.environment),We===void 0&&(R.addEventListener("dispose",pe),We=new Map,X.programs=We);let Ne=We.get(Ie);if(Ne!==void 0){if(X.currentProgram===Ne&&X.lightsStateVersion===Pe)return hs(R,Fe),Ne}else Fe.uniforms=q.getUniforms(R),R.onBuild(K,Fe,T),R.onBeforeCompile(Fe,T),Ne=q.acquireProgram(Fe,Ie),We.set(Ie,Ne),X.uniforms=Fe.uniforms;const Xe=X.uniforms;(!R.isShaderMaterial&&!R.isRawShaderMaterial||R.clipping===!0)&&(Xe.clippingPlanes=Ce.uniform),hs(R,Fe),X.needsLights=kt(R),X.lightsStateVersion=Pe,X.needsLights&&(Xe.ambientLightColor.value=ne.state.ambient,Xe.lightProbe.value=ne.state.probe,Xe.directionalLights.value=ne.state.directional,Xe.directionalLightShadows.value=ne.state.directionalShadow,Xe.spotLights.value=ne.state.spot,Xe.spotLightShadows.value=ne.state.spotShadow,Xe.rectAreaLights.value=ne.state.rectArea,Xe.ltc_1.value=ne.state.rectAreaLTC1,Xe.ltc_2.value=ne.state.rectAreaLTC2,Xe.pointLights.value=ne.state.point,Xe.pointLightShadows.value=ne.state.pointShadow,Xe.hemisphereLights.value=ne.state.hemi,Xe.directionalShadowMap.value=ne.state.directionalShadowMap,Xe.directionalShadowMatrix.value=ne.state.directionalShadowMatrix,Xe.spotShadowMap.value=ne.state.spotShadowMap,Xe.spotLightMatrix.value=ne.state.spotLightMatrix,Xe.spotLightMap.value=ne.state.spotLightMap,Xe.pointShadowMap.value=ne.state.pointShadowMap,Xe.pointShadowMatrix.value=ne.state.pointShadowMatrix);const vt=Ne.getUniforms(),yt=to.seqWithValue(vt.seq,Xe);return X.currentProgram=Ne,X.uniformsList=yt,Ne}function hs(R,k){const K=$e.get(R);K.outputColorSpace=k.outputColorSpace,K.instancing=k.instancing,K.instancingColor=k.instancingColor,K.skinning=k.skinning,K.morphTargets=k.morphTargets,K.morphNormals=k.morphNormals,K.morphColors=k.morphColors,K.morphTargetsCount=k.morphTargetsCount,K.numClippingPlanes=k.numClippingPlanes,K.numIntersection=k.numClipIntersection,K.vertexAlphas=k.vertexAlphas,K.vertexTangents=k.vertexTangents,K.toneMapping=k.toneMapping}function go(R,k,K,X,ne){k.isScene!==!0&&(k=Dt),Ve.resetTextureUnits();const be=k.fog,Pe=X.isMeshStandardMaterial?k.environment:null,Fe=w===null?T.outputColorSpace:w.isXRRenderTarget===!0?w.texture.colorSpace:Bn,Ie=(X.isMeshStandardMaterial?Rt:st).get(X.envMap||Pe),We=X.vertexColors===!0&&!!K.attributes.color&&K.attributes.color.itemSize===4,Ne=!!K.attributes.tangent&&(!!X.normalMap||X.anisotropy>0),Xe=!!K.morphAttributes.position,vt=!!K.morphAttributes.normal,yt=!!K.morphAttributes.color;let Kt=_i;X.toneMapped&&(w===null||w.isXRRenderTarget===!0)&&(Kt=T.toneMapping);const dn=K.morphAttributes.position||K.morphAttributes.normal||K.morphAttributes.color,bt=dn!==void 0?dn.length:0,et=$e.get(X),Wi=g.state.lights;if(_e===!0&&(Te===!0||R!==y)){const Gt=R===y&&X.id===N;Ce.setState(X,R,Gt)}let Tt=!1;X.version===et.__version?(et.needsLights&&et.lightsStateVersion!==Wi.state.version||et.outputColorSpace!==Fe||ne.isInstancedMesh&&et.instancing===!1||!ne.isInstancedMesh&&et.instancing===!0||ne.isSkinnedMesh&&et.skinning===!1||!ne.isSkinnedMesh&&et.skinning===!0||ne.isInstancedMesh&&et.instancingColor===!0&&ne.instanceColor===null||ne.isInstancedMesh&&et.instancingColor===!1&&ne.instanceColor!==null||et.envMap!==Ie||X.fog===!0&&et.fog!==be||et.numClippingPlanes!==void 0&&(et.numClippingPlanes!==Ce.numPlanes||et.numIntersection!==Ce.numIntersection)||et.vertexAlphas!==We||et.vertexTangents!==Ne||et.morphTargets!==Xe||et.morphNormals!==vt||et.morphColors!==yt||et.toneMapping!==Kt||Ge.isWebGL2===!0&&et.morphTargetsCount!==bt)&&(Tt=!0):(Tt=!0,et.__version=X.version);let Dn=et.currentProgram;Tt===!0&&(Dn=ni(X,k,ne));let Ir=!1,ri=!1,rn=!1;const lt=Dn.getUniforms(),Zt=et.uniforms;if(Be.useProgram(Dn.program)&&(Ir=!0,ri=!0,rn=!0),X.id!==N&&(N=X.id,ri=!0),Ir||y!==R){lt.setValue(W,"projectionMatrix",R.projectionMatrix),lt.setValue(W,"viewMatrix",R.matrixWorldInverse);const Gt=lt.map.cameraPosition;Gt!==void 0&&Gt.setValue(W,rt.setFromMatrixPosition(R.matrixWorld)),Ge.logarithmicDepthBuffer&&lt.setValue(W,"logDepthBufFC",2/(Math.log(R.far+1)/Math.LN2)),(X.isMeshPhongMaterial||X.isMeshToonMaterial||X.isMeshLambertMaterial||X.isMeshBasicMaterial||X.isMeshStandardMaterial||X.isShaderMaterial)&&lt.setValue(W,"isOrthographic",R.isOrthographicCamera===!0),y!==R&&(y=R,ri=!0,rn=!0)}if(ne.isSkinnedMesh){lt.setOptional(W,ne,"bindMatrix"),lt.setOptional(W,ne,"bindMatrixInverse");const Gt=ne.skeleton;Gt&&(Ge.floatVertexTextures?(Gt.boneTexture===null&&Gt.computeBoneTexture(),lt.setValue(W,"boneTexture",Gt.boneTexture,Ve),lt.setValue(W,"boneTextureSize",Gt.boneTextureSize)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}const Wt=K.morphAttributes;if((Wt.position!==void 0||Wt.normal!==void 0||Wt.color!==void 0&&Ge.isWebGL2===!0)&&I.update(ne,K,Dn),(ri||et.receiveShadow!==ne.receiveShadow)&&(et.receiveShadow=ne.receiveShadow,lt.setValue(W,"receiveShadow",ne.receiveShadow)),X.isMeshGouraudMaterial&&X.envMap!==null&&(Zt.envMap.value=Ie,Zt.flipEnvMap.value=Ie.isCubeTexture&&Ie.isRenderTargetTexture===!1?-1:1),ri&&(lt.setValue(W,"toneMappingExposure",T.toneMappingExposure),et.needsLights&&ii(Zt,rn),be&&X.fog===!0&&ue.refreshFogUniforms(Zt,be),ue.refreshMaterialUniforms(Zt,X,H,re,ce),to.upload(W,et.uniformsList,Zt,Ve)),X.isShaderMaterial&&X.uniformsNeedUpdate===!0&&(to.upload(W,et.uniformsList,Zt,Ve),X.uniformsNeedUpdate=!1),X.isSpriteMaterial&&lt.setValue(W,"center",ne.center),lt.setValue(W,"modelViewMatrix",ne.modelViewMatrix),lt.setValue(W,"normalMatrix",ne.normalMatrix),lt.setValue(W,"modelMatrix",ne.matrixWorld),X.isShaderMaterial||X.isRawShaderMaterial){const Gt=X.uniformsGroups;for(let Mi=0,fn=Gt.length;Mi<fn;Mi++)if(Ge.isWebGL2){const Un=Gt[Mi];ze.update(Un,Dn),ze.bind(Un,Dn)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return Dn}function ii(R,k){R.ambientLightColor.needsUpdate=k,R.lightProbe.needsUpdate=k,R.directionalLights.needsUpdate=k,R.directionalLightShadows.needsUpdate=k,R.pointLights.needsUpdate=k,R.pointLightShadows.needsUpdate=k,R.spotLights.needsUpdate=k,R.spotLightShadows.needsUpdate=k,R.rectAreaLights.needsUpdate=k,R.hemisphereLights.needsUpdate=k}function kt(R){return R.isMeshLambertMaterial||R.isMeshToonMaterial||R.isMeshPhongMaterial||R.isMeshStandardMaterial||R.isShadowMaterial||R.isShaderMaterial&&R.lights===!0}this.getActiveCubeFace=function(){return A},this.getActiveMipmapLevel=function(){return L},this.getRenderTarget=function(){return w},this.setRenderTargetTextures=function(R,k,K){$e.get(R.texture).__webglTexture=k,$e.get(R.depthTexture).__webglTexture=K;const X=$e.get(R);X.__hasExternalTextures=!0,X.__hasExternalTextures&&(X.__autoAllocateDepthBuffer=K===void 0,X.__autoAllocateDepthBuffer||Le.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),X.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(R,k){const K=$e.get(R);K.__webglFramebuffer=k,K.__useDefaultFramebuffer=k===void 0},this.setRenderTarget=function(R,k=0,K=0){w=R,A=k,L=K;let X=!0,ne=null,be=!1,Pe=!1;if(R){const Ie=$e.get(R);Ie.__useDefaultFramebuffer!==void 0?(Be.bindFramebuffer(W.FRAMEBUFFER,null),X=!1):Ie.__webglFramebuffer===void 0?Ve.setupRenderTarget(R):Ie.__hasExternalTextures&&Ve.rebindTextures(R,$e.get(R.texture).__webglTexture,$e.get(R.depthTexture).__webglTexture);const We=R.texture;(We.isData3DTexture||We.isDataArrayTexture||We.isCompressedArrayTexture)&&(Pe=!0);const Ne=$e.get(R).__webglFramebuffer;R.isWebGLCubeRenderTarget?(Array.isArray(Ne[k])?ne=Ne[k][K]:ne=Ne[k],be=!0):Ge.isWebGL2&&R.samples>0&&Ve.useMultisampledRTT(R)===!1?ne=$e.get(R).__webglMultisampledFramebuffer:Array.isArray(Ne)?ne=Ne[K]:ne=Ne,S.copy(R.viewport),V.copy(R.scissor),Z=R.scissorTest}else S.copy(ie).multiplyScalar(H).floor(),V.copy(Y).multiplyScalar(H).floor(),Z=ee;if(Be.bindFramebuffer(W.FRAMEBUFFER,ne)&&Ge.drawBuffers&&X&&Be.drawBuffers(R,ne),Be.viewport(S),Be.scissor(V),Be.setScissorTest(Z),be){const Ie=$e.get(R.texture);W.framebufferTexture2D(W.FRAMEBUFFER,W.COLOR_ATTACHMENT0,W.TEXTURE_CUBE_MAP_POSITIVE_X+k,Ie.__webglTexture,K)}else if(Pe){const Ie=$e.get(R.texture),We=k||0;W.framebufferTextureLayer(W.FRAMEBUFFER,W.COLOR_ATTACHMENT0,Ie.__webglTexture,K||0,We)}N=-1},this.readRenderTargetPixels=function(R,k,K,X,ne,be,Pe){if(!(R&&R.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Fe=$e.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Pe!==void 0&&(Fe=Fe[Pe]),Fe){Be.bindFramebuffer(W.FRAMEBUFFER,Fe);try{const Ie=R.texture,We=Ie.format,Ne=Ie.type;if(We!==Pn&&me.convert(We)!==W.getParameter(W.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const Xe=Ne===ss&&(Le.has("EXT_color_buffer_half_float")||Ge.isWebGL2&&Le.has("EXT_color_buffer_float"));if(Ne!==vi&&me.convert(Ne)!==W.getParameter(W.IMPLEMENTATION_COLOR_READ_TYPE)&&!(Ne===mi&&(Ge.isWebGL2||Le.has("OES_texture_float")||Le.has("WEBGL_color_buffer_float")))&&!Xe){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}k>=0&&k<=R.width-X&&K>=0&&K<=R.height-ne&&W.readPixels(k,K,X,ne,me.convert(We),me.convert(Ne),be)}finally{const Ie=w!==null?$e.get(w).__webglFramebuffer:null;Be.bindFramebuffer(W.FRAMEBUFFER,Ie)}}},this.copyFramebufferToTexture=function(R,k,K=0){const X=Math.pow(2,-K),ne=Math.floor(k.image.width*X),be=Math.floor(k.image.height*X);Ve.setTexture2D(k,0),W.copyTexSubImage2D(W.TEXTURE_2D,K,0,0,R.x,R.y,ne,be),Be.unbindTexture()},this.copyTextureToTexture=function(R,k,K,X=0){const ne=k.image.width,be=k.image.height,Pe=me.convert(K.format),Fe=me.convert(K.type);Ve.setTexture2D(K,0),W.pixelStorei(W.UNPACK_FLIP_Y_WEBGL,K.flipY),W.pixelStorei(W.UNPACK_PREMULTIPLY_ALPHA_WEBGL,K.premultiplyAlpha),W.pixelStorei(W.UNPACK_ALIGNMENT,K.unpackAlignment),k.isDataTexture?W.texSubImage2D(W.TEXTURE_2D,X,R.x,R.y,ne,be,Pe,Fe,k.image.data):k.isCompressedTexture?W.compressedTexSubImage2D(W.TEXTURE_2D,X,R.x,R.y,k.mipmaps[0].width,k.mipmaps[0].height,Pe,k.mipmaps[0].data):W.texSubImage2D(W.TEXTURE_2D,X,R.x,R.y,Pe,Fe,k.image),X===0&&K.generateMipmaps&&W.generateMipmap(W.TEXTURE_2D),Be.unbindTexture()},this.copyTextureToTexture3D=function(R,k,K,X,ne=0){if(T.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const be=R.max.x-R.min.x+1,Pe=R.max.y-R.min.y+1,Fe=R.max.z-R.min.z+1,Ie=me.convert(X.format),We=me.convert(X.type);let Ne;if(X.isData3DTexture)Ve.setTexture3D(X,0),Ne=W.TEXTURE_3D;else if(X.isDataArrayTexture)Ve.setTexture2DArray(X,0),Ne=W.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}W.pixelStorei(W.UNPACK_FLIP_Y_WEBGL,X.flipY),W.pixelStorei(W.UNPACK_PREMULTIPLY_ALPHA_WEBGL,X.premultiplyAlpha),W.pixelStorei(W.UNPACK_ALIGNMENT,X.unpackAlignment);const Xe=W.getParameter(W.UNPACK_ROW_LENGTH),vt=W.getParameter(W.UNPACK_IMAGE_HEIGHT),yt=W.getParameter(W.UNPACK_SKIP_PIXELS),Kt=W.getParameter(W.UNPACK_SKIP_ROWS),dn=W.getParameter(W.UNPACK_SKIP_IMAGES),bt=K.isCompressedTexture?K.mipmaps[0]:K.image;W.pixelStorei(W.UNPACK_ROW_LENGTH,bt.width),W.pixelStorei(W.UNPACK_IMAGE_HEIGHT,bt.height),W.pixelStorei(W.UNPACK_SKIP_PIXELS,R.min.x),W.pixelStorei(W.UNPACK_SKIP_ROWS,R.min.y),W.pixelStorei(W.UNPACK_SKIP_IMAGES,R.min.z),K.isDataTexture||K.isData3DTexture?W.texSubImage3D(Ne,ne,k.x,k.y,k.z,be,Pe,Fe,Ie,We,bt.data):K.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),W.compressedTexSubImage3D(Ne,ne,k.x,k.y,k.z,be,Pe,Fe,Ie,bt.data)):W.texSubImage3D(Ne,ne,k.x,k.y,k.z,be,Pe,Fe,Ie,We,bt),W.pixelStorei(W.UNPACK_ROW_LENGTH,Xe),W.pixelStorei(W.UNPACK_IMAGE_HEIGHT,vt),W.pixelStorei(W.UNPACK_SKIP_PIXELS,yt),W.pixelStorei(W.UNPACK_SKIP_ROWS,Kt),W.pixelStorei(W.UNPACK_SKIP_IMAGES,dn),ne===0&&X.generateMipmaps&&W.generateMipmap(Ne),Be.unbindTexture()},this.initTexture=function(R){R.isCubeTexture?Ve.setTextureCube(R,0):R.isData3DTexture?Ve.setTexture3D(R,0):R.isDataArrayTexture||R.isCompressedArrayTexture?Ve.setTexture2DArray(R,0):Ve.setTexture2D(R,0),Be.unbindTexture()},this.resetState=function(){A=0,L=0,w=null,Be.reset(),ye.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Qn}get physicallyCorrectLights(){return console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),!this.useLegacyLights}set physicallyCorrectLights(e){console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),this.useLegacyLights=!e}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===Et?Fi:ih}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===Fi?Et:Bn}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class sx extends Eh{}sx.prototype.isWebGL1Renderer=!0;class ox extends Yt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t}}class ax extends on{constructor(e,t,n,r,s,c,o,l,u){super(e,t,n,r,s,c,o,l,u),this.isCanvasTexture=!0,this.needsUpdate=!0}}class ei{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(e,t){const n=this.getUtoTmapping(e);return this.getPoint(n,t)}getPoints(e=5){const t=[];for(let n=0;n<=e;n++)t.push(this.getPoint(n/e));return t}getSpacedPoints(e=5){const t=[];for(let n=0;n<=e;n++)t.push(this.getPointAt(n/e));return t}getLength(){const e=this.getLengths();return e[e.length-1]}getLengths(e=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===e+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const t=[];let n,r=this.getPoint(0),s=0;t.push(0);for(let c=1;c<=e;c++)n=this.getPoint(c/e),s+=n.distanceTo(r),t.push(s),r=n;return this.cacheArcLengths=t,t}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(e,t){const n=this.getLengths();let r=0;const s=n.length;let c;t?c=t:c=e*n[s-1];let o=0,l=s-1,u;for(;o<=l;)if(r=Math.floor(o+(l-o)/2),u=n[r]-c,u<0)o=r+1;else if(u>0)l=r-1;else{l=r;break}if(r=l,n[r]===c)return r/(s-1);const h=n[r],f=n[r+1]-h,_=(c-h)/f;return(r+_)/(s-1)}getTangent(e,t){let r=e-1e-4,s=e+1e-4;r<0&&(r=0),s>1&&(s=1);const c=this.getPoint(r),o=this.getPoint(s),l=t||(c.isVector2?new Re:new F);return l.copy(o).sub(c).normalize(),l}getTangentAt(e,t){const n=this.getUtoTmapping(e);return this.getTangent(n,t)}computeFrenetFrames(e,t){const n=new F,r=[],s=[],c=[],o=new F,l=new Pt;for(let _=0;_<=e;_++){const v=_/e;r[_]=this.getTangentAt(v,new F)}s[0]=new F,c[0]=new F;let u=Number.MAX_VALUE;const h=Math.abs(r[0].x),d=Math.abs(r[0].y),f=Math.abs(r[0].z);h<=u&&(u=h,n.set(1,0,0)),d<=u&&(u=d,n.set(0,1,0)),f<=u&&n.set(0,0,1),o.crossVectors(r[0],n).normalize(),s[0].crossVectors(r[0],o),c[0].crossVectors(r[0],s[0]);for(let _=1;_<=e;_++){if(s[_]=s[_-1].clone(),c[_]=c[_-1].clone(),o.crossVectors(r[_-1],r[_]),o.length()>Number.EPSILON){o.normalize();const v=Math.acos(Bt(r[_-1].dot(r[_]),-1,1));s[_].applyMatrix4(l.makeRotationAxis(o,v))}c[_].crossVectors(r[_],s[_])}if(t===!0){let _=Math.acos(Bt(s[0].dot(s[e]),-1,1));_/=e,r[0].dot(o.crossVectors(s[0],s[e]))>0&&(_=-_);for(let v=1;v<=e;v++)s[v].applyMatrix4(l.makeRotationAxis(r[v],_*v)),c[v].crossVectors(r[v],s[v])}return{tangents:r,normals:s,binormals:c}}clone(){return new this.constructor().copy(this)}copy(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}toJSON(){const e={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return e.arcLengthDivisions=this.arcLengthDivisions,e.type=this.type,e}fromJSON(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}}class Sh extends ei{constructor(e=0,t=0,n=1,r=1,s=0,c=Math.PI*2,o=!1,l=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=e,this.aY=t,this.xRadius=n,this.yRadius=r,this.aStartAngle=s,this.aEndAngle=c,this.aClockwise=o,this.aRotation=l}getPoint(e,t){const n=t||new Re,r=Math.PI*2;let s=this.aEndAngle-this.aStartAngle;const c=Math.abs(s)<Number.EPSILON;for(;s<0;)s+=r;for(;s>r;)s-=r;s<Number.EPSILON&&(c?s=0:s=r),this.aClockwise===!0&&!c&&(s===r?s=-r:s=s-r);const o=this.aStartAngle+e*s;let l=this.aX+this.xRadius*Math.cos(o),u=this.aY+this.yRadius*Math.sin(o);if(this.aRotation!==0){const h=Math.cos(this.aRotation),d=Math.sin(this.aRotation),f=l-this.aX,_=u-this.aY;l=f*h-_*d+this.aX,u=f*d+_*h+this.aY}return n.set(l,u)}copy(e){return super.copy(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}toJSON(){const e=super.toJSON();return e.aX=this.aX,e.aY=this.aY,e.xRadius=this.xRadius,e.yRadius=this.yRadius,e.aStartAngle=this.aStartAngle,e.aEndAngle=this.aEndAngle,e.aClockwise=this.aClockwise,e.aRotation=this.aRotation,e}fromJSON(e){return super.fromJSON(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}}class cx extends Sh{constructor(e,t,n,r,s,c){super(e,t,n,n,r,s,c),this.isArcCurve=!0,this.type="ArcCurve"}}function ka(){let i=0,e=0,t=0,n=0;function r(s,c,o,l){i=s,e=o,t=-3*s+3*c-2*o-l,n=2*s-2*c+o+l}return{initCatmullRom:function(s,c,o,l,u){r(c,o,u*(o-s),u*(l-c))},initNonuniformCatmullRom:function(s,c,o,l,u,h,d){let f=(c-s)/u-(o-s)/(u+h)+(o-c)/h,_=(o-c)/h-(l-c)/(h+d)+(l-o)/d;f*=h,_*=h,r(c,o,f,_)},calc:function(s){const c=s*s,o=c*s;return i+e*s+t*c+n*o}}}const Js=new F,va=new ka,xa=new ka,Ma=new ka;class bh extends ei{constructor(e=[],t=!1,n="centripetal",r=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=e,this.closed=t,this.curveType=n,this.tension=r}getPoint(e,t=new F){const n=t,r=this.points,s=r.length,c=(s-(this.closed?0:1))*e;let o=Math.floor(c),l=c-o;this.closed?o+=o>0?0:(Math.floor(Math.abs(o)/s)+1)*s:l===0&&o===s-1&&(o=s-2,l=1);let u,h;this.closed||o>0?u=r[(o-1)%s]:(Js.subVectors(r[0],r[1]).add(r[0]),u=Js);const d=r[o%s],f=r[(o+1)%s];if(this.closed||o+2<s?h=r[(o+2)%s]:(Js.subVectors(r[s-1],r[s-2]).add(r[s-1]),h=Js),this.curveType==="centripetal"||this.curveType==="chordal"){const _=this.curveType==="chordal"?.5:.25;let v=Math.pow(u.distanceToSquared(d),_),M=Math.pow(d.distanceToSquared(f),_),g=Math.pow(f.distanceToSquared(h),_);M<1e-4&&(M=1),v<1e-4&&(v=M),g<1e-4&&(g=M),va.initNonuniformCatmullRom(u.x,d.x,f.x,h.x,v,M,g),xa.initNonuniformCatmullRom(u.y,d.y,f.y,h.y,v,M,g),Ma.initNonuniformCatmullRom(u.z,d.z,f.z,h.z,v,M,g)}else this.curveType==="catmullrom"&&(va.initCatmullRom(u.x,d.x,f.x,h.x,this.tension),xa.initCatmullRom(u.y,d.y,f.y,h.y,this.tension),Ma.initCatmullRom(u.z,d.z,f.z,h.z,this.tension));return n.set(va.calc(l),xa.calc(l),Ma.calc(l)),n}copy(e){super.copy(e),this.points=[];for(let t=0,n=e.points.length;t<n;t++){const r=e.points[t];this.points.push(r.clone())}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,n=this.points.length;t<n;t++){const r=this.points[t];e.points.push(r.toArray())}return e.closed=this.closed,e.curveType=this.curveType,e.tension=this.tension,e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,n=e.points.length;t<n;t++){const r=e.points[t];this.points.push(new F().fromArray(r))}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}}function Lu(i,e,t,n,r){const s=(n-e)*.5,c=(r-t)*.5,o=i*i,l=i*o;return(2*t-2*n+s+c)*l+(-3*t+3*n-2*s-c)*o+s*i+t}function lx(i,e){const t=1-i;return t*t*e}function ux(i,e){return 2*(1-i)*i*e}function hx(i,e){return i*i*e}function es(i,e,t,n){return lx(i,e)+ux(i,t)+hx(i,n)}function dx(i,e){const t=1-i;return t*t*t*e}function fx(i,e){const t=1-i;return 3*t*t*i*e}function px(i,e){return 3*(1-i)*i*i*e}function mx(i,e){return i*i*i*e}function ts(i,e,t,n,r){return dx(i,e)+fx(i,t)+px(i,n)+mx(i,r)}class gx extends ei{constructor(e=new Re,t=new Re,n=new Re,r=new Re){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=e,this.v1=t,this.v2=n,this.v3=r}getPoint(e,t=new Re){const n=t,r=this.v0,s=this.v1,c=this.v2,o=this.v3;return n.set(ts(e,r.x,s.x,c.x,o.x),ts(e,r.y,s.y,c.y,o.y)),n}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class _x extends ei{constructor(e=new F,t=new F,n=new F,r=new F){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=e,this.v1=t,this.v2=n,this.v3=r}getPoint(e,t=new F){const n=t,r=this.v0,s=this.v1,c=this.v2,o=this.v3;return n.set(ts(e,r.x,s.x,c.x,o.x),ts(e,r.y,s.y,c.y,o.y),ts(e,r.z,s.z,c.z,o.z)),n}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class vx extends ei{constructor(e=new Re,t=new Re){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=e,this.v2=t}getPoint(e,t=new Re){const n=t;return e===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(e).add(this.v1)),n}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new Re){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class xx extends ei{constructor(e=new F,t=new F){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=e,this.v2=t}getPoint(e,t=new F){const n=t;return e===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(e).add(this.v1)),n}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new F){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class Mx extends ei{constructor(e=new Re,t=new Re,n=new Re){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=e,this.v1=t,this.v2=n}getPoint(e,t=new Re){const n=t,r=this.v0,s=this.v1,c=this.v2;return n.set(es(e,r.x,s.x,c.x),es(e,r.y,s.y,c.y)),n}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class Th extends ei{constructor(e=new F,t=new F,n=new F){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=e,this.v1=t,this.v2=n}getPoint(e,t=new F){const n=t,r=this.v0,s=this.v1,c=this.v2;return n.set(es(e,r.x,s.x,c.x),es(e,r.y,s.y,c.y),es(e,r.z,s.z,c.z)),n}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class yx extends ei{constructor(e=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=e}getPoint(e,t=new Re){const n=t,r=this.points,s=(r.length-1)*e,c=Math.floor(s),o=s-c,l=r[c===0?c:c-1],u=r[c],h=r[c>r.length-2?r.length-1:c+1],d=r[c>r.length-3?r.length-1:c+2];return n.set(Lu(o,l.x,u.x,h.x,d.x),Lu(o,l.y,u.y,h.y,d.y)),n}copy(e){super.copy(e),this.points=[];for(let t=0,n=e.points.length;t<n;t++){const r=e.points[t];this.points.push(r.clone())}return this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,n=this.points.length;t<n;t++){const r=this.points[t];e.points.push(r.toArray())}return e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,n=e.points.length;t<n;t++){const r=e.points[t];this.points.push(new Re().fromArray(r))}return this}}var Ex=Object.freeze({__proto__:null,ArcCurve:cx,CatmullRomCurve3:bh,CubicBezierCurve:gx,CubicBezierCurve3:_x,EllipseCurve:Sh,LineCurve:vx,LineCurve3:xx,QuadraticBezierCurve:Mx,QuadraticBezierCurve3:Th,SplineCurve:yx});class Ga extends zn{constructor(e=1,t=1,n=1,r=32,s=1,c=!1,o=0,l=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:e,radiusBottom:t,height:n,radialSegments:r,heightSegments:s,openEnded:c,thetaStart:o,thetaLength:l};const u=this;r=Math.floor(r),s=Math.floor(s);const h=[],d=[],f=[],_=[];let v=0;const M=[],g=n/2;let m=0;D(),c===!1&&(e>0&&T(!0),t>0&&T(!1)),this.setIndex(h),this.setAttribute("position",new jt(d,3)),this.setAttribute("normal",new jt(f,3)),this.setAttribute("uv",new jt(_,2));function D(){const C=new F,A=new F;let L=0;const w=(t-e)/n;for(let N=0;N<=s;N++){const y=[],S=N/s,V=S*(t-e)+e;for(let Z=0;Z<=r;Z++){const G=Z/r,j=G*l+o,$=Math.sin(j),re=Math.cos(j);A.x=V*$,A.y=-S*n+g,A.z=V*re,d.push(A.x,A.y,A.z),C.set($,w,re).normalize(),f.push(C.x,C.y,C.z),_.push(G,1-S),y.push(v++)}M.push(y)}for(let N=0;N<r;N++)for(let y=0;y<s;y++){const S=M[y][N],V=M[y+1][N],Z=M[y+1][N+1],G=M[y][N+1];h.push(S,V,G),h.push(V,Z,G),L+=6}u.addGroup(m,L,0),m+=L}function T(C){const A=v,L=new Re,w=new F;let N=0;const y=C===!0?e:t,S=C===!0?1:-1;for(let Z=1;Z<=r;Z++)d.push(0,g*S,0),f.push(0,S,0),_.push(.5,.5),v++;const V=v;for(let Z=0;Z<=r;Z++){const j=Z/r*l+o,$=Math.cos(j),re=Math.sin(j);w.x=y*re,w.y=g*S,w.z=y*$,d.push(w.x,w.y,w.z),f.push(0,S,0),L.x=$*.5+.5,L.y=re*.5*S+.5,_.push(L.x,L.y),v++}for(let Z=0;Z<r;Z++){const G=A+Z,j=V+Z;C===!0?h.push(j,j+1,G):h.push(j+1,j,G),N+=3}u.addGroup(m,N,C===!0?1:2),m+=N}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Ga(e.radiusTop,e.radiusBottom,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}class yr extends Ga{constructor(e=1,t=1,n=32,r=1,s=!1,c=0,o=Math.PI*2){super(0,e,t,n,r,s,c,o),this.type="ConeGeometry",this.parameters={radius:e,height:t,radialSegments:n,heightSegments:r,openEnded:s,thetaStart:c,thetaLength:o}}static fromJSON(e){return new yr(e.radius,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}class ns extends zn{constructor(e=1,t=.4,n=12,r=48,s=Math.PI*2){super(),this.type="TorusGeometry",this.parameters={radius:e,tube:t,radialSegments:n,tubularSegments:r,arc:s},n=Math.floor(n),r=Math.floor(r);const c=[],o=[],l=[],u=[],h=new F,d=new F,f=new F;for(let _=0;_<=n;_++)for(let v=0;v<=r;v++){const M=v/r*s,g=_/n*Math.PI*2;d.x=(e+t*Math.cos(g))*Math.cos(M),d.y=(e+t*Math.cos(g))*Math.sin(M),d.z=t*Math.sin(g),o.push(d.x,d.y,d.z),h.x=e*Math.cos(M),h.y=e*Math.sin(M),f.subVectors(d,h).normalize(),l.push(f.x,f.y,f.z),u.push(v/r),u.push(_/n)}for(let _=1;_<=n;_++)for(let v=1;v<=r;v++){const M=(r+1)*_+v-1,g=(r+1)*(_-1)+v-1,m=(r+1)*(_-1)+v,D=(r+1)*_+v;c.push(M,g,D),c.push(g,m,D)}this.setIndex(c),this.setAttribute("position",new jt(o,3)),this.setAttribute("normal",new jt(l,3)),this.setAttribute("uv",new jt(u,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new ns(e.radius,e.tube,e.radialSegments,e.tubularSegments,e.arc)}}class Va extends zn{constructor(e=new Th(new F(-1,-1,0),new F(-1,1,0),new F(1,1,0)),t=64,n=1,r=8,s=!1){super(),this.type="TubeGeometry",this.parameters={path:e,tubularSegments:t,radius:n,radialSegments:r,closed:s};const c=e.computeFrenetFrames(t,s);this.tangents=c.tangents,this.normals=c.normals,this.binormals=c.binormals;const o=new F,l=new F,u=new Re;let h=new F;const d=[],f=[],_=[],v=[];M(),this.setIndex(v),this.setAttribute("position",new jt(d,3)),this.setAttribute("normal",new jt(f,3)),this.setAttribute("uv",new jt(_,2));function M(){for(let T=0;T<t;T++)g(T);g(s===!1?t:0),D(),m()}function g(T){h=e.getPointAt(T/t,h);const C=c.normals[T],A=c.binormals[T];for(let L=0;L<=r;L++){const w=L/r*Math.PI*2,N=Math.sin(w),y=-Math.cos(w);l.x=y*C.x+N*A.x,l.y=y*C.y+N*A.y,l.z=y*C.z+N*A.z,l.normalize(),f.push(l.x,l.y,l.z),o.x=h.x+n*l.x,o.y=h.y+n*l.y,o.z=h.z+n*l.z,d.push(o.x,o.y,o.z)}}function m(){for(let T=1;T<=t;T++)for(let C=1;C<=r;C++){const A=(r+1)*(T-1)+(C-1),L=(r+1)*T+(C-1),w=(r+1)*T+C,N=(r+1)*(T-1)+C;v.push(A,L,N),v.push(L,w,N)}}function D(){for(let T=0;T<=t;T++)for(let C=0;C<=r;C++)u.x=T/t,u.y=C/r,_.push(u.x,u.y)}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}toJSON(){const e=super.toJSON();return e.path=this.parameters.path.toJSON(),e}static fromJSON(e){return new Va(new Ex[e.path.type]().fromJSON(e.path),e.tubularSegments,e.radius,e.radialSegments,e.closed)}}class Sx extends Yt{constructor(e,t=1){super(),this.isLight=!0,this.type="Light",this.color=new _t(e),this.intensity=t}dispose(){}copy(e,t){return super.copy(e,t),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const t=super.toJSON(e);return t.object.color=this.color.getHex(),t.object.intensity=this.intensity,this.groundColor!==void 0&&(t.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(t.object.distance=this.distance),this.angle!==void 0&&(t.object.angle=this.angle),this.decay!==void 0&&(t.object.decay=this.decay),this.penumbra!==void 0&&(t.object.penumbra=this.penumbra),this.shadow!==void 0&&(t.object.shadow=this.shadow.toJSON()),t}}const ya=new Pt,Pu=new F,Du=new F;class bx{constructor(e){this.camera=e,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Re(512,512),this.map=null,this.mapPass=null,this.matrix=new Pt,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Ba,this._frameExtents=new Re(1,1),this._viewportCount=1,this._viewports=[new zt(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const t=this.camera,n=this.matrix;Pu.setFromMatrixPosition(e.matrixWorld),t.position.copy(Pu),Du.setFromMatrixPosition(e.target.matrixWorld),t.lookAt(Du),t.updateMatrixWorld(),ya.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),this._frustum.setFromProjectionMatrix(ya),n.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),n.multiply(ya)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class Tx extends bx{constructor(){super(new _h(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class Uu extends Sx{constructor(e,t){super(e,t),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(Yt.DEFAULT_UP),this.updateMatrix(),this.target=new Yt,this.shadow=new Tx}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class Iu{constructor(e=1,t=0,n=0){return this.radius=e,this.phi=t,this.theta=n,this}set(e,t,n){return this.radius=e,this.phi=t,this.theta=n,this}copy(e){return this.radius=e.radius,this.phi=e.phi,this.theta=e.theta,this}makeSafe(){return this.phi=Math.max(1e-6,Math.min(Math.PI-1e-6,this.phi)),this}setFromVector3(e){return this.setFromCartesianCoords(e.x,e.y,e.z)}setFromCartesianCoords(e,t,n){return this.radius=Math.sqrt(e*e+t*t+n*n),this.radius===0?(this.theta=0,this.phi=0):(this.theta=Math.atan2(e,n),this.phi=Math.acos(Bt(t/this.radius,-1,1))),this}clone(){return new this.constructor().copy(this)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Ia}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Ia);const Nu={type:"change"},Ea={type:"start"},Ou={type:"end"},Qs=new ch,Fu=new fi,Ax=Math.cos(70*Kp.DEG2RAD);class wx extends Gi{constructor(e,t){super(),this.object=e,this.domElement=t,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new F,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Ji.ROTATE,MIDDLE:Ji.DOLLY,RIGHT:Ji.PAN},this.touches={ONE:Qi.ROTATE,TWO:Qi.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return o.phi},this.getAzimuthalAngle=function(){return o.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(I){I.addEventListener("keydown",b),this._domElementKeyEvents=I},this.stopListenToKeyEvents=function(){this._domElementKeyEvents.removeEventListener("keydown",b),this._domElementKeyEvents=null},this.saveState=function(){n.target0.copy(n.target),n.position0.copy(n.object.position),n.zoom0=n.object.zoom},this.reset=function(){n.target.copy(n.target0),n.object.position.copy(n.position0),n.object.zoom=n.zoom0,n.object.updateProjectionMatrix(),n.dispatchEvent(Nu),n.update(),s=r.NONE},this.update=function(){const I=new F,oe=new Hi().setFromUnitVectors(e.up,new F(0,1,0)),Ee=oe.clone().invert(),me=new F,ye=new Hi,ze=new F,Ke=2*Math.PI;return function(xe=null){const Q=n.object.position;I.copy(Q).sub(n.target),I.applyQuaternion(oe),o.setFromVector3(I),n.autoRotate&&s===r.NONE&&V(y(xe)),n.enableDamping?(o.theta+=l.theta*n.dampingFactor,o.phi+=l.phi*n.dampingFactor):(o.theta+=l.theta,o.phi+=l.phi);let he=n.minAzimuthAngle,pe=n.maxAzimuthAngle;isFinite(he)&&isFinite(pe)&&(he<-Math.PI?he+=Ke:he>Math.PI&&(he-=Ke),pe<-Math.PI?pe+=Ke:pe>Math.PI&&(pe-=Ke),he<=pe?o.theta=Math.max(he,Math.min(pe,o.theta)):o.theta=o.theta>(he+pe)/2?Math.max(he,o.theta):Math.min(pe,o.theta)),o.phi=Math.max(n.minPolarAngle,Math.min(n.maxPolarAngle,o.phi)),o.makeSafe(),n.enableDamping===!0?n.target.addScaledVector(h,n.dampingFactor):n.target.add(h),n.zoomToCursor&&L||n.object.isOrthographicCamera?o.radius=se(o.radius):o.radius=se(o.radius*u),I.setFromSpherical(o),I.applyQuaternion(Ee),Q.copy(n.target).add(I),n.object.lookAt(n.target),n.enableDamping===!0?(l.theta*=1-n.dampingFactor,l.phi*=1-n.dampingFactor,h.multiplyScalar(1-n.dampingFactor)):(l.set(0,0,0),h.set(0,0,0));let Qe=!1;if(n.zoomToCursor&&L){let it=null;if(n.object.isPerspectiveCamera){const at=I.length();it=se(at*u);const $t=at-it;n.object.position.addScaledVector(C,$t),n.object.updateMatrixWorld()}else if(n.object.isOrthographicCamera){const at=new F(A.x,A.y,0);at.unproject(n.object),n.object.zoom=Math.max(n.minZoom,Math.min(n.maxZoom,n.object.zoom/u)),n.object.updateProjectionMatrix(),Qe=!0;const $t=new F(A.x,A.y,0);$t.unproject(n.object),n.object.position.sub($t).add(at),n.object.updateMatrixWorld(),it=I.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),n.zoomToCursor=!1;it!==null&&(this.screenSpacePanning?n.target.set(0,0,-1).transformDirection(n.object.matrix).multiplyScalar(it).add(n.object.position):(Qs.origin.copy(n.object.position),Qs.direction.set(0,0,-1).transformDirection(n.object.matrix),Math.abs(n.object.up.dot(Qs.direction))<Ax?e.lookAt(n.target):(Fu.setFromNormalAndCoplanarPoint(n.object.up,n.target),Qs.intersectPlane(Fu,n.target))))}else n.object.isOrthographicCamera&&(n.object.zoom=Math.max(n.minZoom,Math.min(n.maxZoom,n.object.zoom/u)),n.object.updateProjectionMatrix(),Qe=!0);return u=1,L=!1,Qe||me.distanceToSquared(n.object.position)>c||8*(1-ye.dot(n.object.quaternion))>c||ze.distanceToSquared(n.target)>0?(n.dispatchEvent(Nu),me.copy(n.object.position),ye.copy(n.object.quaternion),ze.copy(n.target),Qe=!1,!0):!1}}(),this.dispose=function(){n.domElement.removeEventListener("contextmenu",le),n.domElement.removeEventListener("pointerdown",$e),n.domElement.removeEventListener("pointercancel",st),n.domElement.removeEventListener("wheel",P),n.domElement.removeEventListener("pointermove",Ve),n.domElement.removeEventListener("pointerup",st),n._domElementKeyEvents!==null&&(n._domElementKeyEvents.removeEventListener("keydown",b),n._domElementKeyEvents=null)};const n=this,r={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let s=r.NONE;const c=1e-6,o=new Iu,l=new Iu;let u=1;const h=new F,d=new Re,f=new Re,_=new Re,v=new Re,M=new Re,g=new Re,m=new Re,D=new Re,T=new Re,C=new F,A=new Re;let L=!1;const w=[],N={};function y(I){return I!==null?2*Math.PI/60*n.autoRotateSpeed*I:2*Math.PI/60/60*n.autoRotateSpeed}function S(){return Math.pow(.95,n.zoomSpeed)}function V(I){l.theta-=I}function Z(I){l.phi-=I}const G=function(){const I=new F;return function(Ee,me){I.setFromMatrixColumn(me,0),I.multiplyScalar(-Ee),h.add(I)}}(),j=function(){const I=new F;return function(Ee,me){n.screenSpacePanning===!0?I.setFromMatrixColumn(me,1):(I.setFromMatrixColumn(me,0),I.crossVectors(n.object.up,I)),I.multiplyScalar(Ee),h.add(I)}}(),$=function(){const I=new F;return function(Ee,me){const ye=n.domElement;if(n.object.isPerspectiveCamera){const ze=n.object.position;I.copy(ze).sub(n.target);let Ke=I.length();Ke*=Math.tan(n.object.fov/2*Math.PI/180),G(2*Ee*Ke/ye.clientHeight,n.object.matrix),j(2*me*Ke/ye.clientHeight,n.object.matrix)}else n.object.isOrthographicCamera?(G(Ee*(n.object.right-n.object.left)/n.object.zoom/ye.clientWidth,n.object.matrix),j(me*(n.object.top-n.object.bottom)/n.object.zoom/ye.clientHeight,n.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),n.enablePan=!1)}}();function re(I){n.object.isPerspectiveCamera||n.object.isOrthographicCamera?u/=I:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),n.enableZoom=!1)}function H(I){n.object.isPerspectiveCamera||n.object.isOrthographicCamera?u*=I:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),n.enableZoom=!1)}function U(I){if(!n.zoomToCursor)return;L=!0;const oe=n.domElement.getBoundingClientRect(),Ee=I.clientX-oe.left,me=I.clientY-oe.top,ye=oe.width,ze=oe.height;A.x=Ee/ye*2-1,A.y=-(me/ze)*2+1,C.set(A.x,A.y,1).unproject(n.object).sub(n.object.position).normalize()}function se(I){return Math.max(n.minDistance,Math.min(n.maxDistance,I))}function ie(I){d.set(I.clientX,I.clientY)}function Y(I){U(I),m.set(I.clientX,I.clientY)}function ee(I){v.set(I.clientX,I.clientY)}function ve(I){f.set(I.clientX,I.clientY),_.subVectors(f,d).multiplyScalar(n.rotateSpeed);const oe=n.domElement;V(2*Math.PI*_.x/oe.clientHeight),Z(2*Math.PI*_.y/oe.clientHeight),d.copy(f),n.update()}function _e(I){D.set(I.clientX,I.clientY),T.subVectors(D,m),T.y>0?re(S()):T.y<0&&H(S()),m.copy(D),n.update()}function Te(I){M.set(I.clientX,I.clientY),g.subVectors(M,v).multiplyScalar(n.panSpeed),$(g.x,g.y),v.copy(M),n.update()}function ce(I){U(I),I.deltaY<0?H(S()):I.deltaY>0&&re(S()),n.update()}function Ue(I){let oe=!1;switch(I.code){case n.keys.UP:I.ctrlKey||I.metaKey||I.shiftKey?Z(2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):$(0,n.keyPanSpeed),oe=!0;break;case n.keys.BOTTOM:I.ctrlKey||I.metaKey||I.shiftKey?Z(-2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):$(0,-n.keyPanSpeed),oe=!0;break;case n.keys.LEFT:I.ctrlKey||I.metaKey||I.shiftKey?V(2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):$(n.keyPanSpeed,0),oe=!0;break;case n.keys.RIGHT:I.ctrlKey||I.metaKey||I.shiftKey?V(-2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):$(-n.keyPanSpeed,0),oe=!0;break}oe&&(I.preventDefault(),n.update())}function De(){if(w.length===1)d.set(w[0].pageX,w[0].pageY);else{const I=.5*(w[0].pageX+w[1].pageX),oe=.5*(w[0].pageY+w[1].pageY);d.set(I,oe)}}function rt(){if(w.length===1)v.set(w[0].pageX,w[0].pageY);else{const I=.5*(w[0].pageX+w[1].pageX),oe=.5*(w[0].pageY+w[1].pageY);v.set(I,oe)}}function Dt(){const I=w[0].pageX-w[1].pageX,oe=w[0].pageY-w[1].pageY,Ee=Math.sqrt(I*I+oe*oe);m.set(0,Ee)}function He(){n.enableZoom&&Dt(),n.enablePan&&rt()}function W(){n.enableZoom&&Dt(),n.enableRotate&&De()}function Mt(I){if(w.length==1)f.set(I.pageX,I.pageY);else{const Ee=J(I),me=.5*(I.pageX+Ee.x),ye=.5*(I.pageY+Ee.y);f.set(me,ye)}_.subVectors(f,d).multiplyScalar(n.rotateSpeed);const oe=n.domElement;V(2*Math.PI*_.x/oe.clientHeight),Z(2*Math.PI*_.y/oe.clientHeight),d.copy(f)}function Le(I){if(w.length===1)M.set(I.pageX,I.pageY);else{const oe=J(I),Ee=.5*(I.pageX+oe.x),me=.5*(I.pageY+oe.y);M.set(Ee,me)}g.subVectors(M,v).multiplyScalar(n.panSpeed),$(g.x,g.y),v.copy(M)}function Ge(I){const oe=J(I),Ee=I.pageX-oe.x,me=I.pageY-oe.y,ye=Math.sqrt(Ee*Ee+me*me);D.set(0,ye),T.set(0,Math.pow(D.y/m.y,n.zoomSpeed)),re(T.y),m.copy(D)}function Be(I){n.enableZoom&&Ge(I),n.enablePan&&Le(I)}function pt(I){n.enableZoom&&Ge(I),n.enableRotate&&Mt(I)}function $e(I){n.enabled!==!1&&(w.length===0&&(n.domElement.setPointerCapture(I.pointerId),n.domElement.addEventListener("pointermove",Ve),n.domElement.addEventListener("pointerup",st)),de(I),I.pointerType==="touch"?q(I):Rt(I))}function Ve(I){n.enabled!==!1&&(I.pointerType==="touch"?ue(I):St(I))}function st(I){Ce(I),w.length===0&&(n.domElement.releasePointerCapture(I.pointerId),n.domElement.removeEventListener("pointermove",Ve),n.domElement.removeEventListener("pointerup",st)),n.dispatchEvent(Ou),s=r.NONE}function Rt(I){let oe;switch(I.button){case 0:oe=n.mouseButtons.LEFT;break;case 1:oe=n.mouseButtons.MIDDLE;break;case 2:oe=n.mouseButtons.RIGHT;break;default:oe=-1}switch(oe){case Ji.DOLLY:if(n.enableZoom===!1)return;Y(I),s=r.DOLLY;break;case Ji.ROTATE:if(I.ctrlKey||I.metaKey||I.shiftKey){if(n.enablePan===!1)return;ee(I),s=r.PAN}else{if(n.enableRotate===!1)return;ie(I),s=r.ROTATE}break;case Ji.PAN:if(I.ctrlKey||I.metaKey||I.shiftKey){if(n.enableRotate===!1)return;ie(I),s=r.ROTATE}else{if(n.enablePan===!1)return;ee(I),s=r.PAN}break;default:s=r.NONE}s!==r.NONE&&n.dispatchEvent(Ea)}function St(I){switch(s){case r.ROTATE:if(n.enableRotate===!1)return;ve(I);break;case r.DOLLY:if(n.enableZoom===!1)return;_e(I);break;case r.PAN:if(n.enablePan===!1)return;Te(I);break}}function P(I){n.enabled===!1||n.enableZoom===!1||s!==r.NONE||(I.preventDefault(),n.dispatchEvent(Ea),ce(I),n.dispatchEvent(Ou))}function b(I){n.enabled===!1||n.enablePan===!1||Ue(I)}function q(I){switch(fe(I),w.length){case 1:switch(n.touches.ONE){case Qi.ROTATE:if(n.enableRotate===!1)return;De(),s=r.TOUCH_ROTATE;break;case Qi.PAN:if(n.enablePan===!1)return;rt(),s=r.TOUCH_PAN;break;default:s=r.NONE}break;case 2:switch(n.touches.TWO){case Qi.DOLLY_PAN:if(n.enableZoom===!1&&n.enablePan===!1)return;He(),s=r.TOUCH_DOLLY_PAN;break;case Qi.DOLLY_ROTATE:if(n.enableZoom===!1&&n.enableRotate===!1)return;W(),s=r.TOUCH_DOLLY_ROTATE;break;default:s=r.NONE}break;default:s=r.NONE}s!==r.NONE&&n.dispatchEvent(Ea)}function ue(I){switch(fe(I),s){case r.TOUCH_ROTATE:if(n.enableRotate===!1)return;Mt(I),n.update();break;case r.TOUCH_PAN:if(n.enablePan===!1)return;Le(I),n.update();break;case r.TOUCH_DOLLY_PAN:if(n.enableZoom===!1&&n.enablePan===!1)return;Be(I),n.update();break;case r.TOUCH_DOLLY_ROTATE:if(n.enableZoom===!1&&n.enableRotate===!1)return;pt(I),n.update();break;default:s=r.NONE}}function le(I){n.enabled!==!1&&I.preventDefault()}function de(I){w.push(I)}function Ce(I){delete N[I.pointerId];for(let oe=0;oe<w.length;oe++)if(w[oe].pointerId==I.pointerId){w.splice(oe,1);return}}function fe(I){let oe=N[I.pointerId];oe===void 0&&(oe=new Re,N[I.pointerId]=oe),oe.set(I.pageX,I.pageY)}function J(I){const oe=I.pointerId===w[0].pointerId?w[1]:w[0];return N[oe.pointerId]}n.domElement.addEventListener("contextmenu",le),n.domElement.addEventListener("pointerdown",$e),n.domElement.addEventListener("pointercancel",st),n.domElement.addEventListener("wheel",P,{passive:!1}),this.update()}}const eo={R:"hsl(120, 100%, 60%)",L:"hsl(240, 100%, 60%)",U:"hsl(60, 100%, 60%)",D:"hsl(120, 100%, 100%)",F:"hsl(0, 100%, 60%)",B:"hsl(20, 100%, 60%)"};let Ah=0,Yr=null;function Rx(i){const e=i.N,t=l=>{const[u,h,d]=l;if(u===-1)return"L";if(u===1)return"R";if(h===-1)return"D";if(h===1)return"U";if(d===-1)return"B";if(d===1)return"F";throw new Error("unreachable")},n=(l,u,h)=>{const[d,f,_]=u,v=t(h);switch(v){case"U":return[v,d,_];case"F":return[v,d,l-1-f];case"R":return[v,l-1-_,l-1-f];case"L":return[v,_,l-1-f];case"B":return[v,l-1-d,l-1-f];case"D":return[v,d,l-1-_]}},r=(l,u,h)=>{switch(t(h)){case"U":return l;case"F":return u;case"L":return oo(u,l);case"R":return oo(l,u);case"B":return u.map(d=>-d);case"D":return l.map(d=>-d)}},s=(l,u)=>{const h=[];for(let d=0;d<3;d++){const f=[0,0,0];if(u[d]===0)f[d]=-1;else if(u[d]===l-1)f[d]=1;else continue;h.push(f)}return h},c={};for(const l of i.permutations)for(const{p1:u,p2:h,nT:d,nF:f}of l){const _=s(e,u);for(const v of _){let M=r(d,f,v);const g=t(v),[m,D,T]=n(e,h,M);c[`${m}-${D}-${T}`]=g}}const o=[];for(const l in eo){const u=eo[l],h=document.createElement("canvas"),d=h.getContext("2d");h.width=1e3,h.height=1e3,d.lineWidth=5,d.strokeStyle="black",d.fillStyle=u;const[f,_]=[h.width,h.height],v=f/e,M=_/e;for(let g=0;g<e;g++)for(let m=0;m<e;m++){const D=`${l}-${g}-${m}`,T=D in c?eo[c[D]]:eo[l];d.fillStyle=T,d.beginPath(),d.moveTo(g*v,m*M),d.lineTo(g*v+v,m*M),d.lineTo(g*v+v,m*M+M),d.lineTo(g*v,m*M+M),d.closePath(),d.fill(),d.stroke()}o.push(h)}return o}function Sa(i,e,t){const n=t*(i-1)/2;let r=e.map(s=>s===0?-n:s===i-1?i+n:s+.5);return r=r.map(s=>s*2/i-1),r}function Cx(){cancelAnimationFrame(Ah),Yr==null||Yr.remove(),Yr=null}function Lx(i,e,t){const n=new ox;n.background=new _t("white");const r=30;t.clientWidth/t.clientHeight;const s=.01,c=100,o=new yn(r,1,s,c);o.position.set(4,4,4);const h=Rx(e).map(T=>new ax(T)).map(T=>new Qr({map:T,color:"white",opacity:.8,transparent:!0})),d=new Dr(2,2,2),f=new Vt(d,h),_=new Uu("white",3),v=new Uu("white",3);_.position.set(10,10,10),v.position.set(-10,-10,-10),n.add(f,_,v);const M=new Vu;for(const T of e.permutations){const C=new Qr({color:M.nextColor()});if(T.length!==1)for(const A of T){const L=Sa(i,A.p1,.01),w=Sa(i,A.p2,.01),N=Df(w,L),y=Pf(N),S=Uf(N),V=dl(L,hl(y,S-.04)),j=[dl(L,hl(y,.05)),V].map(ie=>new F(...ie)),$=new bh(j),re=new Va($,64,.01,20),H=new Vt(re,C);n.add(H);const U=new yr(.03,.05,32,1),se=new Vt(U,C);se.geometry.rotateX(Math.PI/2),se.lookAt(new F(...N)),se.position.set(...V),n.add(se)}}for(const T of e.rotates){const C=new Qr({color:M.nextColor()}),A=T.unit.position,L=Sa(i,A,.05),w=new qr;if(T.degree===180){const N=Math.PI*.7;{const y=new ns(.1,.01,void 0,void 0,N),S=new Vt(y,C);S.geometry.rotateZ(Math.PI/2),w.add(S);const V=new yr(.03,.05),Z=new Vt(V,C);Z.geometry.rotateZ(-Math.PI/2),Z.position.set(.02,.1,0),w.add(Z)}{const y=new ns(.1,.01,void 0,void 0,N),S=new Vt(y,C);S.geometry.rotateZ(-Math.PI/2),w.add(S);const V=new yr(.03,.05),Z=new Vt(V,C);Z.geometry.rotateZ(Math.PI/2),Z.position.set(-.02,-.1,0),w.add(Z)}}else{const N=Math.PI*3/2,y=new ns(.1,.01,void 0,void 0,N),S=new Vt(y,C);S.geometry.rotateZ(T.degree<0?Math.PI/2:Math.PI),w.add(S);const V=new yr(.03,.05),Z=new Vt(V,C);Z.position.set(T.degree<0?.1:-.1,.02,0),w.add(Z)}w.lookAt(...L),w.position.set(...L),n.add(w)}const g=new Eh;new wx(o,g.domElement);const m=Math.min(t.clientWidth,t.clientHeight);g.setSize(m,m),g.setPixelRatio(window.devicePixelRatio),t.append(g.domElement),Yr=g.domElement;function D(){Ah=requestAnimationFrame(D),g.render(n,o)}D()}let xn={n:"3",alg:"(R U R' U)5",renderType:"3D",algParam:""};const At=Px();let di,no="";window.onload=function(){let i={};try{i=JSON.parse(window.localStorage.getItem("setting")||"{}")}catch{}xn={...xn,...i},new URLSearchParams(window.location.search).forEach((e,t)=>{t in xn&&(xn[t]=e)}),document.body.appendChild(At.app),At.inputAlg.value=xn.alg,At.inputN.value=(xn.n||3).toString(),At.inputParam.value=xn.algParam,Xu(At.canvas2D),wh(xn.renderType)};window.onresize=function(){br()};function Px(){const i=document.createElement("div");i.id="app",i.classList.add("container-fluid","my-2");const[e,t]=ba("alg","",br);document.createElement("div").classList.add("input-group-prepend"),Ix(e);const[r,s]=ba("N","N",br),[c,o]=ba("Params","Params",br),l=un("row justify-content-between mb-2"),u=un("col-md-7"),h=un("col-md-3"),d=un("col-md-2");u.append(e),h.append(c),d.append(r),l.append(u,h,d);const f=un("row mb-2");f.classList.add("row");const _=un("col-12 mb-1"),v=un("col"),M=$r("button","btn btn-outline-secondary me-2");M.textContent="Share link",M.onclick=()=>{const N=Object.keys(xn).map(S=>`${S}=${xn[S]}`).join("&"),y=window.location.href.split("?")[0];window.open(y+"?"+N,"_blank")};const g=document.createElement("btn");g.classList.add("btn","btn-outline-secondary"),g.append("alpha.twizzle.net"),g.onclick=()=>{const N=At.inputN.value;window.open(`https://alpha.twizzle.net/explore/?puzzle=${N}x${N}x${N}&alg=${At.inputAlg.value}`,"_blank")};const m=Ux();_.append(m),_.append(M,g),f.append(_,v);const D=un("row"),T=un("col-md-8"),C=un("col-md-4"),A=un("border rounded-1");A.style.aspectRatio="1/1",A.style.maxHeight="1080px";const L=Fx();A.appendChild(L);const w=un("border rounded-1 p-2");return T.append(A),C.append(w),D.append(T,C),i.append(l,f,D),{app:i,inputN:s,inputAlg:t,inputParam:o,canvasContainer:A,canvas2D:L,renderSwitcher:m,desc:w}}function ba(i,e,t){const n=document.createElement("div");if(n.classList.add("input-group"),e!==""){const s=document.createElement("span");s.classList.add("input-group-text"),s.appendChild(document.createTextNode(e)),n.appendChild(s)}const r=document.createElement("input");return r.type="text",r.classList.add("form-control"),r.id=i,r.onchange=t,n.appendChild(r),[n,r]}function Dx(i,e,t){const n=document.createElement("button"),r=e.split(/\s+/g);return n.classList.add(...r),n.onclick=t,n.textContent=i,n.style.whiteSpace="nowrap",n}function wh(i){no=i;for(const e of At.renderSwitcher.children)e.classList.remove("btn-primary"),e.classList.add("btn-outline-secondary"),e.textContent===i&&(e.classList.add("btn-primary"),e.classList.remove("btn-outline-secondary"));br()}function Ux(){const i=un("mb-2 me-3");i.style.display="inline-block";const e="btn btn-outline-secondary rounded-0";for(const t of["1 face","3 faces","5 faces","6 faces","6 faces 2","3D"])i.append(Dx(t,e,n=>{const r=n.target;wh(r.textContent)}));return i}function Ix(i){const e=document.createElement("button");e.classList.add("btn","btn-outline-secondary","dropdown-toggle","input-group-prepend"),e.type="button",e.setAttribute("data-bs-toggle","dropdown"),e.setAttribute("aria-expanded","false"),e.textContent="Alg";const t=document.createElement("ul");t.classList.add("dropdown-menu");for(const n of Ff()){const r=document.createElement("li"),s=document.createElement("a");s.classList.add("dropdown-item"),s.append(...Nf("red","["+n.tags.join(",")+"] ","black",n.name+" ","blue",n.algorithm)),s.onclick=function(c){return function(){At.inputAlg.value=c,br()}}(n.algorithm),r.append(s),t.append(r)}i.prepend(e,t)}function Nx(i,e,t){const n=e.split(/\s+/g).filter(s=>s!==""),r=[];for(const s of i)s.match(/[a-z]/i)&&!s.match(/[xyzMESmesLRFBUDlrfbudhw]/)&&r.indexOf(s)<0&&r.push(s);for(let s=n.length;s<r.length;s++)n.push("1");n.length=r.length;for(let s=0;s<r.length;s++)i=i.replaceAll(r[s],n[s]);return i=i.replaceAll("h",`${~~(t/2)}`),[i,n.join(" ")]}function br(){console.log("onInputChange");const i=parseInt(At.inputN.value),e=At.inputAlg.value,[t,n]=Nx(e,At.inputParam.value,i);if(console.log(t,n),n!==At.inputParam.value&&(At.inputParam.value=n),di=Rf(t,i),Ox(di,i),Cx(),no==="3D")Lx(i,di,At.canvasContainer),At.canvas2D.style.display="none";else{At.canvas2D.style.display="block";const r=At.canvas2D;Xu(r);const s=r.getContext("2d");switch(s.reset(),s.clearRect(0,0,r.width,r.height),no){case"1 face":Bx(i,di,r);break;case"3 faces":zx(i,di,r);break;case"5 faces":Gx(i,di,r);break;case"6 faces":Hx(i,di,r);break;case"6 faces 2":kx(i,di,r);break}}xn={n:i.toString(),alg:e,renderType:no,algParam:At.inputParam.value},window.localStorage.setItem("setting",JSON.stringify(xn))}function Ox(i,e){const t=(o,l)=>{const u=document.createElement("span");return u.style.color=l,u.style.fontWeight="800",u.textContent=o,u};If(At.desc);const n=document.createElement("div");n.style.maxHeight="300px",n.style.overflowY="auto",n.append("Regulated Alg: "+i.regulatedAlg,document.createElement("br")),n.append("Simplified Alg: "+i.simplifiedAlg,document.createElement("br")),$r("span","");const r=$r("span","bg-light me-2 pe-2"),s=$r("span");r.style.cursor="pointer",r.textContent="Refactored Alg:",r.onclick=()=>{const o=parseInt(r.getAttribute("depth")||"1"),l=Date.now(),u=bf(e,o,i.ops),h=Date.now();s.textContent=u.alg,r.setAttribute("depth",`${o+1}`),r.textContent=`Refactored Alg(depth ${o}):`,h-l>5e3&&(r.classList.add("bg-danger"),r.classList.remove("bg-light")),u.complete&&(r.textContent="Refactored Alg:",r.onclick=()=>{})},n.append(r,s,document.createElement("br")),At.desc.append(n),At.desc.append("Order: "+i.order,document.createElement("br"));const c=document.createElement("div");if(i.cycles.length>100)c.append("cycles are too big to display: "+i.cycles.length);else for(const o of i.cycles){const l=o.map(u=>ll(e,u)||`${u}`).join(" -> ");c.append(t(`[${o.length}]`,"#0080ff"),document.createTextNode(l+" "))}c.append(document.createElement("br"));for(const o of i.rotates){const l=ll(e,o.unit.position)||`${o.unit.position}`;c.append(t(`[${o.degree}] `,"#FF0080"),l+" ")}At.desc.append(c)}function Fx(){const i=document.createElement("canvas");return i.style.width="100%",i.style.height="100%",i}function jr(i,e){const t={U:0,L:0,F:0,R:0,B:0,D:0};for(const[n,r,s]of i)n===0&&t.L++,n===e-1&&t.R++,r===0&&t.D++,r===e-1&&t.U++,s===0&&t.B++,s===e-1&&t.F++;return t}function Rn(i,e,t){return[[i,e],[i+t,e],[i+t,e+t],[i,e+t]]}function Bx(i,e,t){const n=t.getContext("2d"),r=10,s=10,c=Math.floor(Math.min((t.width-r*2)/17,(t.height-s/2)/14))-2,o=c*14,l=c*2;n.translate(r,s);const u=[{name:"U",priority:6,shape:Rn(0,0,o)},{name:"F",priority:5,shape:Rn(o+c,0,l)},{name:"R",priority:4,shape:Rn(o+c,3*c,l)},{name:"L",priority:3,shape:Rn(o+c,6*c,l)},{name:"B",priority:2,shape:Rn(o+c,9*c,l)},{name:"D",priority:1,shape:Rn(o+c,12*c,l)}],h=jr(e.cycles.flat(),i);u.sort((d,f)=>h[f.name]-h[d.name]),u[0].shape=Rn(0,0,o);for(let d=1;d<6;d++)u[d].shape=Rn(o+c,(d-1)*3*c,l),u[d].priority=7-d;cs(i,e,n,u)}function zx(i,e,t){const n=t.getContext("2d");n.lineCap="round",n.lineJoin="round",n.lineWidth=3;const r=10,s=10;n.translate(r,s);const c=Math.floor(Math.min((t.width-r*2)/2.5,(t.height-s*2)/2))-2,o=c/4,l=(v,M)=>{if(v===0)return[c,c];const g=v%2===M?c*.95:c,m=Math.PI/6+Math.PI/3*(v-1);return[c+g*Math.cos(m),c-g*Math.sin(m)]},u=e.cycles.flat();function h(){const v=(M,g,m)=>{for(const D of u)if(D[0]!==M&&D[1]!==g&&D[2]!==m)return!1;return!0};return v(i-1,i-1,i-1)?["U",[2,1,0,3],"R",[0,1,6,5],"F",[3,0,5,4],"L","D","B"]:v(0,i-1,i-1)?["U",[3,2,1,0],"F",[0,1,6,5],"L",[3,0,5,4],"B","D","R"]:v(0,i-1,0)?["U",[0,3,2,1],"L",[0,1,6,5],"B",[3,0,5,4],"R","D","F"]:v(i-1,i-1,0)?["U",[1,0,3,2],"B",[0,1,6,5],"R",[3,0,5,4],"F","D","L"]:v(i-1,0,i-1)?["D",[4,0,6,5],"R",[2,1,6,0],"F",[3,2,0,4],"U","L","B"]:v(0,0,i-1)?["D",[5,4,0,6],"F",[2,1,6,0],"L",[3,2,0,4],"U","B","R"]:v(0,0,0)?["D",[6,5,4,0],"L",[2,1,6,0],"B",[3,2,0,4],"U","R","F"]:v(i-1,0,0)?["D",[0,6,5,4],"B",[2,1,6,0],"R",[3,2,0,4],"U","F","L"]:["U",[2,1,0,3],"F",[3,0,5,4],"R",[0,1,6,5],"L","D","B"]}const d=h(),f=d[0]==="U"?0:1,_=[{name:d[0],priority:6,shape:d[1].map(v=>l(v,f))},{name:d[2],priority:5,shape:d[3].map(v=>l(v,f))},{name:d[4],priority:4,shape:d[5].map(v=>l(v,f))},{name:d[6],priority:-1,shape:Rn(0,0,o)},{name:d[7],priority:-2,shape:Rn(0,2*c-o,o)},{name:d[8],priority:-3,shape:Rn(2*c+o,c-o/2,o)}];cs(i,e,n,_)}function Hx(i,e,t){const n=t.getContext("2d"),r=10,s=10,c=Math.floor(Math.min((t.width-r*2)/4,(t.height-s/2)/3))-2;n.translate(r,s);const o=(u,h)=>[[u,h],[u+c,h],[u+c,h+c],[u,h+c]],l=[{name:"U",priority:6,shape:o(c,0)},{name:"F",priority:5,shape:o(c,c)},{name:"R",priority:4,shape:o(2*c,c)},{name:"L",priority:3,shape:o(0,c)},{name:"D",priority:2,shape:o(c,2*c)},{name:"B",priority:-1,shape:o(3*c,c)}];cs(i,e,n,l)}function kx(i,e,t){const n=t.getContext("2d"),r=10,s=10,c=.5,o=.5,l=Math.floor(Math.min((t.width-r*2)/(3+c),(t.height-s/2)/(2+o)))-2;n.translate(r,s);const u=(d,f)=>[[d,f],[d+l,f],[d+l,f+l],[d,f+l]],h=[{name:"U",priority:4,shape:[[l+c*l,0],[2*l+c*l,0],[2*l,l*o],[l,l*o]]},{name:"R",priority:5,shape:[[2*l,l*o],[2*l+c*l,0],[2*l+c*l,l],[2*l,l+l*o]]},{name:"F",priority:6,shape:u(l,l*o)},{name:"L",priority:3,shape:u(0,l*o)},{name:"D",priority:2,shape:u(l,l+l*o)},{name:"B",priority:-1,shape:u(2*l+c*l,0)}];cs(i,e,n,h)}function cs(i,e,t,n){const r={},s=(A,L,w,N,y)=>{const S=(H,U,se)=>{const ie=[H];for(let Y=1;Y<se;Y++)ie.push([H[0]+Y*(U[0]-H[0])/se,H[1]+Y*(U[1]-H[1])/se]);return ie.push(U),ie},V=H=>H.reduce((se,ie,Y,ee)=>[se[0]+ie[0],se[1]+ie[1]],[0,0]).map(se=>se/H.length);t.fillStyle=w[A],t.beginPath(),L.forEach((H,U)=>{U===0?t.moveTo(...H):t.lineTo(...H)}),t.closePath(),t.fill();const Z=S(L[0],L[3],i),G=S(L[0],L[1],i),j=S(L[1],L[2],i),$=S(L[3],L[2],i);for(let H=0;H<=i;H++)t.beginPath(),t.moveTo(Z[H][0],Z[H][1]),t.lineTo(j[H][0],j[H][1]),t.moveTo(G[H][0],G[H][1]),t.lineTo($[H][0],$[H][1]),t.stroke();const re=[];for(let H=0;H<G.length;H++)re.push(S(G[H],$[H],i));for(let H=0;H<i;H++)for(let U=0;U<i;U++){const se=y(H,U).join(",")+`-${A}`,ie=V([re[H][U],re[H][U+1],re[H+1][U+1],re[H+1][U]]);r[se]=ie,H===0&&U===0&&t.fillText(A,ie[0],ie[1])}for(let H=0;H<i;H++)for(let U=0;U<i;U++){const se=`${A}-${H}-${U}`;if(se in N){t.fillStyle=w[N[se]];const ie=[re[H][U],re[H][U+1],re[H+1][U+1],re[H+1][U]];t.beginPath(),t.moveTo(...ie[0]),t.lineTo(...ie[1]),t.lineTo(...ie[2]),t.lineTo(...ie[3]),t.closePath(),t.fill(),t.stroke()}}},c=A=>{const[L,w,N]=A;if(L===-1)return"L";if(L===1)return"R";if(w===-1)return"D";if(w===1)return"U";if(N===-1)return"B";if(N===1)return"F";throw new Error("unreachable")},o={};t.lineCap="round",t.lineJoin="round",t.lineWidth=9/i;const l={U:(A,L)=>[A,i-1,L],F:(A,L)=>[A,i-1-L,i-1],R:(A,L)=>[i-1,i-1-L,i-1-A],L:(A,L)=>[0,i-1-L,A],B:(A,L)=>[i-1-A,i-1-L,0],D:(A,L)=>[A,0,i-1-L]},u=(A,L,w)=>{const[N,y,S]=L,V=c(w);switch(V){case"U":return[V,N,S];case"F":return[V,N,A-1-y];case"R":return[V,A-1-S,A-1-y];case"L":return[V,S,A-1-y];case"B":return[V,A-1-N,A-1-y];case"D":return[V,N,A-1-S]}},h=(A,L,w)=>{switch(c(w)){case"U":return A;case"F":return L;case"L":return oo(L,A);case"R":return oo(A,L);case"B":return L.map(N=>-N);case"D":return A.map(N=>-N)}},d=(A,L)=>{const w=[];for(let N=0;N<3;N++){const y=[0,0,0];if(L[N]===0)y[N]=-1;else if(L[N]===A-1)y[N]=1;else continue;w.push(y)}return w};for(const A of e.permutations)for(const{p1:L,p2:w,nT:N,nF:y}of A){const S=d(i,L);for(const V of S){let Z=h(N,y,V);const G=c(V),[j,$,re]=u(i,w,Z);o[`${j}-${$}-${re}`]=G}}const f={U:"hsl(60, 100%, 90%)",F:"hsl(0, 100%, 90%)",R:"hsl(120, 100%, 85%)",B:"hsl(23, 100%, 90%)",L:"hsl(240, 100%, 90%)",D:"hsl(120, 100%, 100%)"};for(const A of n)s(A.name,A.shape,f,o,l[A.name]);const _=new Vu;t.shadowColor="rgba(0, 0, 0, .4)",t.shadowBlur=15,t.lineWidth=5;const v=A=>{const L=_.nextColor();for(let w=0;w<A.length;w++){const N=w===A.length-1?0:w+1,[y,S]=A[w],[V,Z]=A[N];t.beginPath(),Cf(t,y,S,V,Z,L,20),t.stroke()}},M=(A,L)=>{const w=_.nextColor(),[N,y]=A;t.beginPath(),Lf(t,N,y,L,w,20),t.stroke()},g=()=>({U:0,L:0,F:0,R:0,B:0,D:0}),m=(A,L)=>{const w=[...A].sort((N,y)=>L(y)-L(N));if(w.length===1||w.length>1&&L(w[0])>L(w[1]))return w[0]},D=g(),T=n.map(A=>A.name);let C=[...e.cycles].sort((A,L)=>A.length-L.length);e:for(;C.length>0;){for(let A=0;A<C.length;A++){const L=C[A],w=jr(L,i),N=T.filter(S=>w[S]===L.length),y=m(N,S=>D[S]);if(y){v(L.map(S=>r[S.join(",")+`-${y}`])),D[y]+=L.length,C.splice(A,1);continue e}}{const A={U:[],F:[],B:[],D:[],L:[],R:[]};for(let y=0;y<C.length;y++){const S=C[y],V=jr(S,i);T.forEach(Z=>{V[Z]===S.length&&A[Z].push(y)})}const w=[...T].sort((y,S)=>D[S]-D[y]).sort((y,S)=>A[S].length-A[y].length)[0],N=A[w];if(N.length>1){for(let y=N.length-1;y>=0;y--){const S=C[N[y]];v(S.map(V=>r[V.join(",")+`-${w}`])),D[w]+=S.length,C.splice(N[y],1)}continue e}}break}for(const A of C){const L=A.map(w=>[-1,-1]);for(;L.find(w=>w[0]===-1);){const w=A.filter((S,V)=>L[V][0]===-1),N=jr(w,i),y=n.map(S=>({name:S.name,priority:S.priority,count:S.priority>0?N[S.name]:Math.min(N[S.name],1)})).sort((S,V)=>V.priority-S.priority).sort((S,V)=>V.count-S.count);A.forEach((S,V)=>{if(L[V][0]===-1){const Z=S.join(",")+`-${y[0].name}`;Z in r&&(L[V]=r[Z])}})}v(L)}{const A=e.rotates,L=e.rotates.map(w=>[-1,-1]);for(;L.find(w=>w[0]===-1);){const w=A.filter((S,V)=>L[V][0]===-1),N=jr(w.map(S=>S.unit.position),i),y=n.map(S=>({name:S.name,priority:S.priority,count:S.priority>0?N[S.name]:Math.min(N[S.name],1)})).sort((S,V)=>V.priority-S.priority).sort((S,V)=>V.count-S.count);A.forEach((S,V)=>{if(L[V][0]===-1){const Z=S.unit.position.join(",")+`-${y[0].name}`;Z in r&&(L[V]=r[Z],M(L[V],S.degree))}})}}}function Gx(i,e,t){const n=t.getContext("2d");n.lineCap="round",n.lineJoin="round",n.lineWidth=3;const r=10,s=10,[c,o,l,u]=[.5,.5,.5,.5],h=100;n.translate(r,s);const d=Math.floor(Math.min((t.width-r*2-h-20)/(1+c+o),(t.height-s*2)/(1+l+u))),f=[0,0],_=[d*(1+c+o),0],v=[d*(1+c+o),d*(1+l+u)],M=[0,d*(1+l+u)],g=[d*c,d*l],m=[d*(1+c),d*l],D=[d*(1+c),d*(1+l)],T=[d*c,d*(1+l)],A=[{name:"U",priority:6,shape:[g,m,D,T]},{name:"F",priority:5,shape:[T,D,v,M]},{name:"R",priority:4,shape:[D,m,_,v]},{name:"L",priority:3,shape:[g,T,M,f]},{name:"B",priority:2,shape:[m,g,f,_]},{name:"D",priority:-1,shape:((L,w,N,y)=>[[L,w],[L+N,w],[L+N,w+y],[L,w+y]])(d*(1+c+o)+20,0,h,h)}];cs(i,e,n,A)}});export default Vx();

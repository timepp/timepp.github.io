var yf=Object.defineProperty;var Mf=(i,e,t)=>e in i?yf(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var Sf=(i,e)=>()=>(e||i((e={exports:{}}).exports,e),e.exports);var ko=(i,e,t)=>(Mf(i,typeof e!="symbol"?e+"":e,t),t);var Zx=Sf((Ph,Ia)=>{(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}})();/*!
  * Bootstrap v5.3.2 (https://getbootstrap.com/)
  * Copyright 2011-2023 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
  */(function(i,e){typeof Ph=="object"&&typeof Ia<"u"?Ia.exports=e():typeof define=="function"&&define.amd?define(e):(i=typeof globalThis<"u"?globalThis:i||self).bootstrap=e()})(globalThis,function(){const i=new Map,e={set(x,c,p){i.has(x)||i.set(x,new Map);const S=i.get(x);S.has(c)||S.size===0?S.set(c,p):console.error(`Bootstrap doesn't allow more than one instance per element. Bound instance: ${Array.from(S.keys())[0]}.`)},get:(x,c)=>i.has(x)&&i.get(x).get(c)||null,remove(x,c){if(!i.has(x))return;const p=i.get(x);p.delete(c),p.size===0&&i.delete(x)}},t="transitionend",n=x=>(x&&window.CSS&&window.CSS.escape&&(x=x.replace(/#([^\s"#']+)/g,(c,p)=>`#${CSS.escape(p)}`)),x),r=x=>{x.dispatchEvent(new Event(t))},s=x=>!(!x||typeof x!="object")&&(x.jquery!==void 0&&(x=x[0]),x.nodeType!==void 0),a=x=>s(x)?x.jquery?x[0]:x:typeof x=="string"&&x.length>0?document.querySelector(n(x)):null,o=x=>{if(!s(x)||x.getClientRects().length===0)return!1;const c=getComputedStyle(x).getPropertyValue("visibility")==="visible",p=x.closest("details:not([open])");if(!p)return c;if(p!==x){const S=x.closest("summary");if(S&&S.parentNode!==p||S===null)return!1}return c},l=x=>!x||x.nodeType!==Node.ELEMENT_NODE||!!x.classList.contains("disabled")||(x.disabled!==void 0?x.disabled:x.hasAttribute("disabled")&&x.getAttribute("disabled")!=="false"),u=x=>{if(!document.documentElement.attachShadow)return null;if(typeof x.getRootNode=="function"){const c=x.getRootNode();return c instanceof ShadowRoot?c:null}return x instanceof ShadowRoot?x:x.parentNode?u(x.parentNode):null},h=()=>{},d=x=>{x.offsetHeight},f=()=>window.jQuery&&!document.body.hasAttribute("data-bs-no-jquery")?window.jQuery:null,_=[],v=()=>document.documentElement.dir==="rtl",y=x=>{var c;c=()=>{const p=f();if(p){const S=x.NAME,B=p.fn[S];p.fn[S]=x.jQueryInterface,p.fn[S].Constructor=x,p.fn[S].noConflict=()=>(p.fn[S]=B,x.jQueryInterface)}},document.readyState==="loading"?(_.length||document.addEventListener("DOMContentLoaded",()=>{for(const p of _)p()}),_.push(c)):c()},g=(x,c=[],p=x)=>typeof x=="function"?x(...c):p,m=(x,c,p=!0)=>{if(!p)return void g(x);const S=(te=>{if(!te)return 0;let{transitionDuration:ae,transitionDelay:ge}=window.getComputedStyle(te);const Ae=Number.parseFloat(ae),we=Number.parseFloat(ge);return Ae||we?(ae=ae.split(",")[0],ge=ge.split(",")[0],1e3*(Number.parseFloat(ae)+Number.parseFloat(ge))):0})(c)+5;let B=!1;const z=({target:te})=>{te===c&&(B=!0,c.removeEventListener(t,z),g(x))};c.addEventListener(t,z),setTimeout(()=>{B||r(c)},S)},D=(x,c,p,S)=>{const B=x.length;let z=x.indexOf(c);return z===-1?!p&&S?x[B-1]:x[0]:(z+=p?1:-1,S&&(z=(z+B)%B),x[Math.max(0,Math.min(z,B-1))])},T=/[^.]*(?=\..*)\.|.*/,C=/\..*/,E=/::\d+$/,L={};let w=1;const N={mouseenter:"mouseover",mouseleave:"mouseout"},M=new Set(["click","dblclick","mouseup","mousedown","contextmenu","mousewheel","DOMMouseScroll","mouseover","mouseout","mousemove","selectstart","selectend","keydown","keypress","keyup","orientationchange","touchstart","touchmove","touchend","touchcancel","pointerdown","pointermove","pointerup","pointerleave","pointercancel","gesturestart","gesturechange","gestureend","focus","blur","change","reset","select","submit","focusin","focusout","load","unload","beforeunload","resize","move","DOMContentLoaded","readystatechange","error","abort","scroll"]);function A(x,c){return c&&`${c}::${w++}`||x.uidEvent||w++}function V(x){const c=A(x);return x.uidEvent=c,L[c]=L[c]||{},L[c]}function Q(x,c,p=null){return Object.values(x).find(S=>S.callable===c&&S.delegationSelector===p)}function H(x,c,p){const S=typeof c=="string",B=S?p:c||p;let z=k(x);return M.has(z)||(z=x),[S,B,z]}function Y(x,c,p,S,B){if(typeof c!="string"||!x)return;let[z,te,ae]=H(c,p,S);c in N&&(te=(qe=>function(ke){if(!ke.relatedTarget||ke.relatedTarget!==ke.delegateTarget&&!ke.delegateTarget.contains(ke.relatedTarget))return qe.call(this,ke)})(te));const ge=V(x),Ae=ge[ae]||(ge[ae]={}),we=Q(Ae,te,z?p:null);if(we)return void(we.oneOff=we.oneOff&&B);const Ee=A(te,c.replace(T,"")),Ye=z?function(Oe,qe,ke){return function je(ft){const xt=Oe.querySelectorAll(qe);for(let{target:tt}=ft;tt&&tt!==this;tt=tt.parentNode)for(const ct of xt)if(ct===tt)return se(ft,{delegateTarget:tt}),je.oneOff&&U.off(Oe,ft.type,qe,ke),ke.apply(tt,[ft])}}(x,p,te):function(Oe,qe){return function ke(je){return se(je,{delegateTarget:Oe}),ke.oneOff&&U.off(Oe,je.type,qe),qe.apply(Oe,[je])}}(x,te);Ye.delegationSelector=z?p:null,Ye.callable=te,Ye.oneOff=B,Ye.uidEvent=Ee,Ae[Ee]=Ye,x.addEventListener(ae,Ye,z)}function $(x,c,p,S,B){const z=Q(c[p],S,B);z&&(x.removeEventListener(p,z,!!B),delete c[p][z.uidEvent])}function re(x,c,p,S){const B=c[p]||{};for(const[z,te]of Object.entries(B))z.includes(S)&&$(x,c,p,te.callable,te.delegationSelector)}function k(x){return x=x.replace(C,""),N[x]||x}const U={on(x,c,p,S){Y(x,c,p,S,!1)},one(x,c,p,S){Y(x,c,p,S,!0)},off(x,c,p,S){if(typeof c!="string"||!x)return;const[B,z,te]=H(c,p,S),ae=te!==c,ge=V(x),Ae=ge[te]||{},we=c.startsWith(".");if(z===void 0){if(we)for(const Ee of Object.keys(ge))re(x,ge,Ee,c.slice(1));for(const[Ee,Ye]of Object.entries(Ae)){const Oe=Ee.replace(E,"");ae&&!c.includes(Oe)||$(x,ge,te,Ye.callable,Ye.delegationSelector)}}else{if(!Object.keys(Ae).length)return;$(x,ge,te,z,B?p:null)}},trigger(x,c,p){if(typeof c!="string"||!x)return null;const S=f();let B=null,z=!0,te=!0,ae=!1;c!==k(c)&&S&&(B=S.Event(c,p),S(x).trigger(B),z=!B.isPropagationStopped(),te=!B.isImmediatePropagationStopped(),ae=B.isDefaultPrevented());const ge=se(new Event(c,{bubbles:z,cancelable:!0}),p);return ae&&ge.preventDefault(),te&&x.dispatchEvent(ge),ge.defaultPrevented&&B&&B.preventDefault(),ge}};function se(x,c={}){for(const[p,S]of Object.entries(c))try{x[p]=S}catch{Object.defineProperty(x,p,{configurable:!0,get:()=>S})}return x}function ie(x){if(x==="true")return!0;if(x==="false")return!1;if(x===Number(x).toString())return Number(x);if(x===""||x==="null")return null;if(typeof x!="string")return x;try{return JSON.parse(decodeURIComponent(x))}catch{return x}}function q(x){return x.replace(/[A-Z]/g,c=>`-${c.toLowerCase()}`)}const ee={setDataAttribute(x,c,p){x.setAttribute(`data-bs-${q(c)}`,p)},removeDataAttribute(x,c){x.removeAttribute(`data-bs-${q(c)}`)},getDataAttributes(x){if(!x)return{};const c={},p=Object.keys(x.dataset).filter(S=>S.startsWith("bs")&&!S.startsWith("bsConfig"));for(const S of p){let B=S.replace(/^bs/,"");B=B.charAt(0).toLowerCase()+B.slice(1,B.length),c[B]=ie(x.dataset[S])}return c},getDataAttribute:(x,c)=>ie(x.getAttribute(`data-bs-${q(c)}`))};class ve{static get Default(){return{}}static get DefaultType(){return{}}static get NAME(){throw new Error('You have to implement the static method "NAME", for each component!')}_getConfig(c){return c=this._mergeConfigObj(c),c=this._configAfterMerge(c),this._typeCheckConfig(c),c}_configAfterMerge(c){return c}_mergeConfigObj(c,p){const S=s(p)?ee.getDataAttribute(p,"config"):{};return{...this.constructor.Default,...typeof S=="object"?S:{},...s(p)?ee.getDataAttributes(p):{},...typeof c=="object"?c:{}}}_typeCheckConfig(c,p=this.constructor.DefaultType){for(const[B,z]of Object.entries(p)){const te=c[B],ae=s(te)?"element":(S=te)==null?`${S}`:Object.prototype.toString.call(S).match(/\s([a-z]+)/i)[1].toLowerCase();if(!new RegExp(z).test(ae))throw new TypeError(`${this.constructor.NAME.toUpperCase()}: Option "${B}" provided type "${ae}" but expected type "${z}".`)}var S}}class _e extends ve{constructor(c,p){super(),(c=a(c))&&(this._element=c,this._config=this._getConfig(p),e.set(this._element,this.constructor.DATA_KEY,this))}dispose(){e.remove(this._element,this.constructor.DATA_KEY),U.off(this._element,this.constructor.EVENT_KEY);for(const c of Object.getOwnPropertyNames(this))this[c]=null}_queueCallback(c,p,S=!0){m(c,p,S)}_getConfig(c){return c=this._mergeConfigObj(c,this._element),c=this._configAfterMerge(c),this._typeCheckConfig(c),c}static getInstance(c){return e.get(a(c),this.DATA_KEY)}static getOrCreateInstance(c,p={}){return this.getInstance(c)||new this(c,typeof p=="object"?p:null)}static get VERSION(){return"5.3.2"}static get DATA_KEY(){return`bs.${this.NAME}`}static get EVENT_KEY(){return`.${this.DATA_KEY}`}static eventName(c){return`${c}${this.EVENT_KEY}`}}const Te=x=>{let c=x.getAttribute("data-bs-target");if(!c||c==="#"){let p=x.getAttribute("href");if(!p||!p.includes("#")&&!p.startsWith("."))return null;p.includes("#")&&!p.startsWith("#")&&(p=`#${p.split("#")[1]}`),c=p&&p!=="#"?n(p.trim()):null}return c},ce={find:(x,c=document.documentElement)=>[].concat(...Element.prototype.querySelectorAll.call(c,x)),findOne:(x,c=document.documentElement)=>Element.prototype.querySelector.call(c,x),children:(x,c)=>[].concat(...x.children).filter(p=>p.matches(c)),parents(x,c){const p=[];let S=x.parentNode.closest(c);for(;S;)p.push(S),S=S.parentNode.closest(c);return p},prev(x,c){let p=x.previousElementSibling;for(;p;){if(p.matches(c))return[p];p=p.previousElementSibling}return[]},next(x,c){let p=x.nextElementSibling;for(;p;){if(p.matches(c))return[p];p=p.nextElementSibling}return[]},focusableChildren(x){const c=["a","button","input","textarea","select","details","[tabindex]",'[contenteditable="true"]'].map(p=>`${p}:not([tabindex^="-"])`).join(",");return this.find(c,x).filter(p=>!l(p)&&o(p))},getSelectorFromElement(x){const c=Te(x);return c&&ce.findOne(c)?c:null},getElementFromSelector(x){const c=Te(x);return c?ce.findOne(c):null},getMultipleElementsFromSelector(x){const c=Te(x);return c?ce.find(c):[]}},Ue=(x,c="hide")=>{const p=`click.dismiss${x.EVENT_KEY}`,S=x.NAME;U.on(document,p,`[data-bs-dismiss="${S}"]`,function(B){if(["A","AREA"].includes(this.tagName)&&B.preventDefault(),l(this))return;const z=ce.getElementFromSelector(this)||this.closest(`.${S}`);x.getOrCreateInstance(z)[c]()})},De=".bs.alert",rt=`close${De}`,Ut=`closed${De}`;class He extends _e{static get NAME(){return"alert"}close(){if(U.trigger(this._element,rt).defaultPrevented)return;this._element.classList.remove("show");const c=this._element.classList.contains("fade");this._queueCallback(()=>this._destroyElement(),this._element,c)}_destroyElement(){this._element.remove(),U.trigger(this._element,Ut),this.dispose()}static jQueryInterface(c){return this.each(function(){const p=He.getOrCreateInstance(this);if(typeof c=="string"){if(p[c]===void 0||c.startsWith("_")||c==="constructor")throw new TypeError(`No method named "${c}"`);p[c](this)}})}}Ue(He,"close"),y(He);const W='[data-bs-toggle="button"]';class yt extends _e{static get NAME(){return"button"}toggle(){this._element.setAttribute("aria-pressed",this._element.classList.toggle("active"))}static jQueryInterface(c){return this.each(function(){const p=yt.getOrCreateInstance(this);c==="toggle"&&p[c]()})}}U.on(document,"click.bs.button.data-api",W,x=>{x.preventDefault();const c=x.target.closest(W);yt.getOrCreateInstance(c).toggle()}),y(yt);const Le=".bs.swipe",Ge=`touchstart${Le}`,Be=`touchmove${Le}`,mt=`touchend${Le}`,$e=`pointerdown${Le}`,Ve=`pointerup${Le}`,st={endCallback:null,leftCallback:null,rightCallback:null},Rt={endCallback:"(function|null)",leftCallback:"(function|null)",rightCallback:"(function|null)"};class bt extends ve{constructor(c,p){super(),this._element=c,c&&bt.isSupported()&&(this._config=this._getConfig(p),this._deltaX=0,this._supportPointerEvents=!!window.PointerEvent,this._initEvents())}static get Default(){return st}static get DefaultType(){return Rt}static get NAME(){return"swipe"}dispose(){U.off(this._element,Le)}_start(c){this._supportPointerEvents?this._eventIsPointerPenTouch(c)&&(this._deltaX=c.clientX):this._deltaX=c.touches[0].clientX}_end(c){this._eventIsPointerPenTouch(c)&&(this._deltaX=c.clientX-this._deltaX),this._handleSwipe(),g(this._config.endCallback)}_move(c){this._deltaX=c.touches&&c.touches.length>1?0:c.touches[0].clientX-this._deltaX}_handleSwipe(){const c=Math.abs(this._deltaX);if(c<=40)return;const p=c/this._deltaX;this._deltaX=0,p&&g(p>0?this._config.rightCallback:this._config.leftCallback)}_initEvents(){this._supportPointerEvents?(U.on(this._element,$e,c=>this._start(c)),U.on(this._element,Ve,c=>this._end(c)),this._element.classList.add("pointer-event")):(U.on(this._element,Ge,c=>this._start(c)),U.on(this._element,Be,c=>this._move(c)),U.on(this._element,mt,c=>this._end(c)))}_eventIsPointerPenTouch(c){return this._supportPointerEvents&&(c.pointerType==="pen"||c.pointerType==="touch")}static isSupported(){return"ontouchstart"in document.documentElement||navigator.maxTouchPoints>0}}const P=".bs.carousel",b=".data-api",j="next",ue="prev",le="left",de="right",Ce=`slide${P}`,fe=`slid${P}`,Z=`keydown${P}`,I=`mouseenter${P}`,oe=`mouseleave${P}`,Se=`dragstart${P}`,me=`load${P}${b}`,Me=`click${P}${b}`,ze="carousel",Ke="active",O=".active",xe=".carousel-item",J=O+xe,he={ArrowLeft:de,ArrowRight:le},pe={interval:5e3,keyboard:!0,pause:"hover",ride:!1,touch:!0,wrap:!0},Qe={interval:"(number|boolean)",keyboard:"boolean",pause:"(string|boolean)",ride:"(boolean|string)",touch:"boolean",wrap:"boolean"};class it extends _e{constructor(c,p){super(c,p),this._interval=null,this._activeElement=null,this._isSliding=!1,this.touchTimeout=null,this._swipeHelper=null,this._indicatorsElement=ce.findOne(".carousel-indicators",this._element),this._addEventListeners(),this._config.ride===ze&&this.cycle()}static get Default(){return pe}static get DefaultType(){return Qe}static get NAME(){return"carousel"}next(){this._slide(j)}nextWhenVisible(){!document.hidden&&o(this._element)&&this.next()}prev(){this._slide(ue)}pause(){this._isSliding&&r(this._element),this._clearInterval()}cycle(){this._clearInterval(),this._updateInterval(),this._interval=setInterval(()=>this.nextWhenVisible(),this._config.interval)}_maybeEnableCycle(){this._config.ride&&(this._isSliding?U.one(this._element,fe,()=>this.cycle()):this.cycle())}to(c){const p=this._getItems();if(c>p.length-1||c<0)return;if(this._isSliding)return void U.one(this._element,fe,()=>this.to(c));const S=this._getItemIndex(this._getActive());if(S===c)return;const B=c>S?j:ue;this._slide(B,p[c])}dispose(){this._swipeHelper&&this._swipeHelper.dispose(),super.dispose()}_configAfterMerge(c){return c.defaultInterval=c.interval,c}_addEventListeners(){this._config.keyboard&&U.on(this._element,Z,c=>this._keydown(c)),this._config.pause==="hover"&&(U.on(this._element,I,()=>this.pause()),U.on(this._element,oe,()=>this._maybeEnableCycle())),this._config.touch&&bt.isSupported()&&this._addTouchEventListeners()}_addTouchEventListeners(){for(const p of ce.find(".carousel-item img",this._element))U.on(p,Se,S=>S.preventDefault());const c={leftCallback:()=>this._slide(this._directionToOrder(le)),rightCallback:()=>this._slide(this._directionToOrder(de)),endCallback:()=>{this._config.pause==="hover"&&(this.pause(),this.touchTimeout&&clearTimeout(this.touchTimeout),this.touchTimeout=setTimeout(()=>this._maybeEnableCycle(),500+this._config.interval))}};this._swipeHelper=new bt(this._element,c)}_keydown(c){if(/input|textarea/i.test(c.target.tagName))return;const p=he[c.key];p&&(c.preventDefault(),this._slide(this._directionToOrder(p)))}_getItemIndex(c){return this._getItems().indexOf(c)}_setActiveIndicatorElement(c){if(!this._indicatorsElement)return;const p=ce.findOne(O,this._indicatorsElement);p.classList.remove(Ke),p.removeAttribute("aria-current");const S=ce.findOne(`[data-bs-slide-to="${c}"]`,this._indicatorsElement);S&&(S.classList.add(Ke),S.setAttribute("aria-current","true"))}_updateInterval(){const c=this._activeElement||this._getActive();if(!c)return;const p=Number.parseInt(c.getAttribute("data-bs-interval"),10);this._config.interval=p||this._config.defaultInterval}_slide(c,p=null){if(this._isSliding)return;const S=this._getActive(),B=c===j,z=p||D(this._getItems(),S,B,this._config.wrap);if(z===S)return;const te=this._getItemIndex(z),ae=Ee=>U.trigger(this._element,Ee,{relatedTarget:z,direction:this._orderToDirection(c),from:this._getItemIndex(S),to:te});if(ae(Ce).defaultPrevented||!S||!z)return;const ge=!!this._interval;this.pause(),this._isSliding=!0,this._setActiveIndicatorElement(te),this._activeElement=z;const Ae=B?"carousel-item-start":"carousel-item-end",we=B?"carousel-item-next":"carousel-item-prev";z.classList.add(we),d(z),S.classList.add(Ae),z.classList.add(Ae),this._queueCallback(()=>{z.classList.remove(Ae,we),z.classList.add(Ke),S.classList.remove(Ke,we,Ae),this._isSliding=!1,ae(fe)},S,this._isAnimated()),ge&&this.cycle()}_isAnimated(){return this._element.classList.contains("slide")}_getActive(){return ce.findOne(J,this._element)}_getItems(){return ce.find(xe,this._element)}_clearInterval(){this._interval&&(clearInterval(this._interval),this._interval=null)}_directionToOrder(c){return v()?c===le?ue:j:c===le?j:ue}_orderToDirection(c){return v()?c===ue?le:de:c===ue?de:le}static jQueryInterface(c){return this.each(function(){const p=it.getOrCreateInstance(this,c);if(typeof c!="number"){if(typeof c=="string"){if(p[c]===void 0||c.startsWith("_")||c==="constructor")throw new TypeError(`No method named "${c}"`);p[c]()}}else p.to(c)})}}U.on(document,Me,"[data-bs-slide], [data-bs-slide-to]",function(x){const c=ce.getElementFromSelector(this);if(!c||!c.classList.contains(ze))return;x.preventDefault();const p=it.getOrCreateInstance(c),S=this.getAttribute("data-bs-slide-to");return S?(p.to(S),void p._maybeEnableCycle()):ee.getDataAttribute(this,"slide")==="next"?(p.next(),void p._maybeEnableCycle()):(p.prev(),void p._maybeEnableCycle())}),U.on(window,me,()=>{const x=ce.find('[data-bs-ride="carousel"]');for(const c of x)it.getOrCreateInstance(c)}),y(it);const at=".bs.collapse",$t=`show${at}`,gt=`shown${at}`,hn=`hide${at}`,kt=`hidden${at}`,ls=`click${at}.data-api`,Vi="show",ti="collapse",Hn="collapsing",us=`:scope .${ti} .${ti}`,ni='[data-bs-toggle="collapse"]',hs={parent:null,toggle:!0},mo={parent:"(null|element)",toggle:"boolean"};class ii extends _e{constructor(c,p){super(c,p),this._isTransitioning=!1,this._triggerArray=[];const S=ce.find(ni);for(const B of S){const z=ce.getSelectorFromElement(B),te=ce.find(z).filter(ae=>ae===this._element);z!==null&&te.length&&this._triggerArray.push(B)}this._initializeChildren(),this._config.parent||this._addAriaAndCollapsedClass(this._triggerArray,this._isShown()),this._config.toggle&&this.toggle()}static get Default(){return hs}static get DefaultType(){return mo}static get NAME(){return"collapse"}toggle(){this._isShown()?this.hide():this.show()}show(){if(this._isTransitioning||this._isShown())return;let c=[];if(this._config.parent&&(c=this._getFirstLevelChildren(".collapse.show, .collapse.collapsing").filter(B=>B!==this._element).map(B=>ii.getOrCreateInstance(B,{toggle:!1}))),c.length&&c[0]._isTransitioning||U.trigger(this._element,$t).defaultPrevented)return;for(const B of c)B.hide();const p=this._getDimension();this._element.classList.remove(ti),this._element.classList.add(Hn),this._element.style[p]=0,this._addAriaAndCollapsedClass(this._triggerArray,!0),this._isTransitioning=!0;const S=`scroll${p[0].toUpperCase()+p.slice(1)}`;this._queueCallback(()=>{this._isTransitioning=!1,this._element.classList.remove(Hn),this._element.classList.add(ti,Vi),this._element.style[p]="",U.trigger(this._element,gt)},this._element,!0),this._element.style[p]=`${this._element[S]}px`}hide(){if(this._isTransitioning||!this._isShown()||U.trigger(this._element,hn).defaultPrevented)return;const c=this._getDimension();this._element.style[c]=`${this._element.getBoundingClientRect()[c]}px`,d(this._element),this._element.classList.add(Hn),this._element.classList.remove(ti,Vi);for(const p of this._triggerArray){const S=ce.getElementFromSelector(p);S&&!this._isShown(S)&&this._addAriaAndCollapsedClass([p],!1)}this._isTransitioning=!0,this._element.style[c]="",this._queueCallback(()=>{this._isTransitioning=!1,this._element.classList.remove(Hn),this._element.classList.add(ti),U.trigger(this._element,kt)},this._element,!0)}_isShown(c=this._element){return c.classList.contains(Vi)}_configAfterMerge(c){return c.toggle=!!c.toggle,c.parent=a(c.parent),c}_getDimension(){return this._element.classList.contains("collapse-horizontal")?"width":"height"}_initializeChildren(){if(!this._config.parent)return;const c=this._getFirstLevelChildren(ni);for(const p of c){const S=ce.getElementFromSelector(p);S&&this._addAriaAndCollapsedClass([p],this._isShown(S))}}_getFirstLevelChildren(c){const p=ce.find(us,this._config.parent);return ce.find(c,this._config.parent).filter(S=>!p.includes(S))}_addAriaAndCollapsedClass(c,p){if(c.length)for(const S of c)S.classList.toggle("collapsed",!p),S.setAttribute("aria-expanded",p)}static jQueryInterface(c){const p={};return typeof c=="string"&&/show|hide/.test(c)&&(p.toggle=!1),this.each(function(){const S=ii.getOrCreateInstance(this,p);if(typeof c=="string"){if(S[c]===void 0)throw new TypeError(`No method named "${c}"`);S[c]()}})}}U.on(document,ls,ni,function(x){(x.target.tagName==="A"||x.delegateTarget&&x.delegateTarget.tagName==="A")&&x.preventDefault();for(const c of ce.getMultipleElementsFromSelector(this))ii.getOrCreateInstance(c,{toggle:!1}).toggle()}),y(ii);var Gt="top",R="bottom",G="right",K="left",X="auto",ne=[Gt,R,G,K],be="start",Pe="end",Fe="clippingParents",Ie="viewport",We="popper",Ne="reference",Xe=ne.reduce(function(x,c){return x.concat([c+"-"+be,c+"-"+Pe])},[]),vt=[].concat(ne,[X]).reduce(function(x,c){return x.concat([c,c+"-"+be,c+"-"+Pe])},[]),Mt="beforeRead",Kt="read",dn="afterRead",Tt="beforeMain",et="main",Wi="afterMain",At="beforeWrite",Un="write",Ir="afterWrite",ri=[Mt,Kt,dn,Tt,et,Wi,At,Un,Ir];function rn(x){return x?(x.nodeName||"").toLowerCase():null}function lt(x){if(x==null)return window;if(x.toString()!=="[object Window]"){var c=x.ownerDocument;return c&&c.defaultView||window}return x}function Zt(x){return x instanceof lt(x).Element||x instanceof Element}function qt(x){return x instanceof lt(x).HTMLElement||x instanceof HTMLElement}function Vt(x){return typeof ShadowRoot<"u"&&(x instanceof lt(x).ShadowRoot||x instanceof ShadowRoot)}const yi={name:"applyStyles",enabled:!0,phase:"write",fn:function(x){var c=x.state;Object.keys(c.elements).forEach(function(p){var S=c.styles[p]||{},B=c.attributes[p]||{},z=c.elements[p];qt(z)&&rn(z)&&(Object.assign(z.style,S),Object.keys(B).forEach(function(te){var ae=B[te];ae===!1?z.removeAttribute(te):z.setAttribute(te,ae===!0?"":ae)}))})},effect:function(x){var c=x.state,p={popper:{position:c.options.strategy,left:"0",top:"0",margin:"0"},arrow:{position:"absolute"},reference:{}};return Object.assign(c.elements.popper.style,p.popper),c.styles=p,c.elements.arrow&&Object.assign(c.elements.arrow.style,p.arrow),function(){Object.keys(c.elements).forEach(function(S){var B=c.elements[S],z=c.attributes[S]||{},te=Object.keys(c.styles.hasOwnProperty(S)?c.styles[S]:p[S]).reduce(function(ae,ge){return ae[ge]="",ae},{});qt(B)&&rn(B)&&(Object.assign(B.style,te),Object.keys(z).forEach(function(ae){B.removeAttribute(ae)}))})}},requires:["computeStyles"]};function fn(x){return x.split("-")[0]}var In=Math.max,ds=Math.min,Xi=Math.round;function go(){var x=navigator.userAgentData;return x!=null&&x.brands&&Array.isArray(x.brands)?x.brands.map(function(c){return c.brand+"/"+c.version}).join(" "):navigator.userAgent}function Xa(){return!/^((?!chrome|android).)*safari/i.test(go())}function qi(x,c,p){c===void 0&&(c=!1),p===void 0&&(p=!1);var S=x.getBoundingClientRect(),B=1,z=1;c&&qt(x)&&(B=x.offsetWidth>0&&Xi(S.width)/x.offsetWidth||1,z=x.offsetHeight>0&&Xi(S.height)/x.offsetHeight||1);var te=(Zt(x)?lt(x):window).visualViewport,ae=!Xa()&&p,ge=(S.left+(ae&&te?te.offsetLeft:0))/B,Ae=(S.top+(ae&&te?te.offsetTop:0))/z,we=S.width/B,Ee=S.height/z;return{width:we,height:Ee,top:Ae,right:ge+we,bottom:Ae+Ee,left:ge,x:ge,y:Ae}}function _o(x){var c=qi(x),p=x.offsetWidth,S=x.offsetHeight;return Math.abs(c.width-p)<=1&&(p=c.width),Math.abs(c.height-S)<=1&&(S=c.height),{x:x.offsetLeft,y:x.offsetTop,width:p,height:S}}function qa(x,c){var p=c.getRootNode&&c.getRootNode();if(x.contains(c))return!0;if(p&&Vt(p)){var S=c;do{if(S&&x.isSameNode(S))return!0;S=S.parentNode||S.host}while(S)}return!1}function kn(x){return lt(x).getComputedStyle(x)}function Dh(x){return["table","td","th"].indexOf(rn(x))>=0}function si(x){return((Zt(x)?x.ownerDocument:x.document)||window.document).documentElement}function fs(x){return rn(x)==="html"?x:x.assignedSlot||x.parentNode||(Vt(x)?x.host:null)||si(x)}function ja(x){return qt(x)&&kn(x).position!=="fixed"?x.offsetParent:null}function Nr(x){for(var c=lt(x),p=ja(x);p&&Dh(p)&&kn(p).position==="static";)p=ja(p);return p&&(rn(p)==="html"||rn(p)==="body"&&kn(p).position==="static")?c:p||function(S){var B=/firefox/i.test(go());if(/Trident/i.test(go())&&qt(S)&&kn(S).position==="fixed")return null;var z=fs(S);for(Vt(z)&&(z=z.host);qt(z)&&["html","body"].indexOf(rn(z))<0;){var te=kn(z);if(te.transform!=="none"||te.perspective!=="none"||te.contain==="paint"||["transform","perspective"].indexOf(te.willChange)!==-1||B&&te.willChange==="filter"||B&&te.filter&&te.filter!=="none")return z;z=z.parentNode}return null}(x)||c}function vo(x){return["top","bottom"].indexOf(x)>=0?"x":"y"}function Or(x,c,p){return In(x,ds(c,p))}function Ya(x){return Object.assign({},{top:0,right:0,bottom:0,left:0},x)}function $a(x,c){return c.reduce(function(p,S){return p[S]=x,p},{})}const Ka={name:"arrow",enabled:!0,phase:"main",fn:function(x){var c,p=x.state,S=x.name,B=x.options,z=p.elements.arrow,te=p.modifiersData.popperOffsets,ae=fn(p.placement),ge=vo(ae),Ae=[K,G].indexOf(ae)>=0?"height":"width";if(z&&te){var we=function(pt,ht){return Ya(typeof(pt=typeof pt=="function"?pt(Object.assign({},ht.rects,{placement:ht.placement})):pt)!="number"?pt:$a(pt,ne))}(B.padding,p),Ee=_o(z),Ye=ge==="y"?Gt:K,Oe=ge==="y"?R:G,qe=p.rects.reference[Ae]+p.rects.reference[ge]-te[ge]-p.rects.popper[Ae],ke=te[ge]-p.rects.reference[ge],je=Nr(z),ft=je?ge==="y"?je.clientHeight||0:je.clientWidth||0:0,xt=qe/2-ke/2,tt=we[Ye],ct=ft-Ee[Ae]-we[Oe],Ze=ft/2-Ee[Ae]/2+xt,ot=Or(tt,Ze,ct),ut=ge;p.modifiersData[S]=((c={})[ut]=ot,c.centerOffset=ot-Ze,c)}},effect:function(x){var c=x.state,p=x.options.element,S=p===void 0?"[data-popper-arrow]":p;S!=null&&(typeof S!="string"||(S=c.elements.popper.querySelector(S)))&&qa(c.elements.popper,S)&&(c.elements.arrow=S)},requires:["popperOffsets"],requiresIfExists:["preventOverflow"]};function ji(x){return x.split("-")[1]}var Uh={top:"auto",right:"auto",bottom:"auto",left:"auto"};function Za(x){var c,p=x.popper,S=x.popperRect,B=x.placement,z=x.variation,te=x.offsets,ae=x.position,ge=x.gpuAcceleration,Ae=x.adaptive,we=x.roundOffsets,Ee=x.isFixed,Ye=te.x,Oe=Ye===void 0?0:Ye,qe=te.y,ke=qe===void 0?0:qe,je=typeof we=="function"?we({x:Oe,y:ke}):{x:Oe,y:ke};Oe=je.x,ke=je.y;var ft=te.hasOwnProperty("x"),xt=te.hasOwnProperty("y"),tt=K,ct=Gt,Ze=window;if(Ae){var ot=Nr(p),ut="clientHeight",pt="clientWidth";ot===lt(p)&&kn(ot=si(p)).position!=="static"&&ae==="absolute"&&(ut="scrollHeight",pt="scrollWidth"),(B===Gt||(B===K||B===G)&&z===Pe)&&(ct=R,ke-=(Ee&&ot===Ze&&Ze.visualViewport?Ze.visualViewport.height:ot[ut])-S.height,ke*=ge?1:-1),B!==K&&(B!==Gt&&B!==R||z!==Pe)||(tt=G,Oe-=(Ee&&ot===Ze&&Ze.visualViewport?Ze.visualViewport.width:ot[pt])-S.width,Oe*=ge?1:-1)}var ht,Ct=Object.assign({position:ae},Ae&&Uh),an=we===!0?function(bn,Jt){var mn=bn.x,gn=bn.y,wt=Jt.devicePixelRatio||1;return{x:Xi(mn*wt)/wt||0,y:Xi(gn*wt)/wt||0}}({x:Oe,y:ke},lt(p)):{x:Oe,y:ke};return Oe=an.x,ke=an.y,ge?Object.assign({},Ct,((ht={})[ct]=xt?"0":"",ht[tt]=ft?"0":"",ht.transform=(Ze.devicePixelRatio||1)<=1?"translate("+Oe+"px, "+ke+"px)":"translate3d("+Oe+"px, "+ke+"px, 0)",ht)):Object.assign({},Ct,((c={})[ct]=xt?ke+"px":"",c[tt]=ft?Oe+"px":"",c.transform="",c))}const xo={name:"computeStyles",enabled:!0,phase:"beforeWrite",fn:function(x){var c=x.state,p=x.options,S=p.gpuAcceleration,B=S===void 0||S,z=p.adaptive,te=z===void 0||z,ae=p.roundOffsets,ge=ae===void 0||ae,Ae={placement:fn(c.placement),variation:ji(c.placement),popper:c.elements.popper,popperRect:c.rects.popper,gpuAcceleration:B,isFixed:c.options.strategy==="fixed"};c.modifiersData.popperOffsets!=null&&(c.styles.popper=Object.assign({},c.styles.popper,Za(Object.assign({},Ae,{offsets:c.modifiersData.popperOffsets,position:c.options.strategy,adaptive:te,roundOffsets:ge})))),c.modifiersData.arrow!=null&&(c.styles.arrow=Object.assign({},c.styles.arrow,Za(Object.assign({},Ae,{offsets:c.modifiersData.arrow,position:"absolute",adaptive:!1,roundOffsets:ge})))),c.attributes.popper=Object.assign({},c.attributes.popper,{"data-popper-placement":c.placement})},data:{}};var ps={passive:!0};const yo={name:"eventListeners",enabled:!0,phase:"write",fn:function(){},effect:function(x){var c=x.state,p=x.instance,S=x.options,B=S.scroll,z=B===void 0||B,te=S.resize,ae=te===void 0||te,ge=lt(c.elements.popper),Ae=[].concat(c.scrollParents.reference,c.scrollParents.popper);return z&&Ae.forEach(function(we){we.addEventListener("scroll",p.update,ps)}),ae&&ge.addEventListener("resize",p.update,ps),function(){z&&Ae.forEach(function(we){we.removeEventListener("scroll",p.update,ps)}),ae&&ge.removeEventListener("resize",p.update,ps)}},data:{}};var Ih={left:"right",right:"left",bottom:"top",top:"bottom"};function ms(x){return x.replace(/left|right|bottom|top/g,function(c){return Ih[c]})}var Nh={start:"end",end:"start"};function Ja(x){return x.replace(/start|end/g,function(c){return Nh[c]})}function Mo(x){var c=lt(x);return{scrollLeft:c.pageXOffset,scrollTop:c.pageYOffset}}function So(x){return qi(si(x)).left+Mo(x).scrollLeft}function Eo(x){var c=kn(x),p=c.overflow,S=c.overflowX,B=c.overflowY;return/auto|scroll|overlay|hidden/.test(p+B+S)}function Qa(x){return["html","body","#document"].indexOf(rn(x))>=0?x.ownerDocument.body:qt(x)&&Eo(x)?x:Qa(fs(x))}function Fr(x,c){var p;c===void 0&&(c=[]);var S=Qa(x),B=S===((p=x.ownerDocument)==null?void 0:p.body),z=lt(S),te=B?[z].concat(z.visualViewport||[],Eo(S)?S:[]):S,ae=c.concat(te);return B?ae:ae.concat(Fr(fs(te)))}function bo(x){return Object.assign({},x,{left:x.x,top:x.y,right:x.x+x.width,bottom:x.y+x.height})}function ec(x,c,p){return c===Ie?bo(function(S,B){var z=lt(S),te=si(S),ae=z.visualViewport,ge=te.clientWidth,Ae=te.clientHeight,we=0,Ee=0;if(ae){ge=ae.width,Ae=ae.height;var Ye=Xa();(Ye||!Ye&&B==="fixed")&&(we=ae.offsetLeft,Ee=ae.offsetTop)}return{width:ge,height:Ae,x:we+So(S),y:Ee}}(x,p)):Zt(c)?function(S,B){var z=qi(S,!1,B==="fixed");return z.top=z.top+S.clientTop,z.left=z.left+S.clientLeft,z.bottom=z.top+S.clientHeight,z.right=z.left+S.clientWidth,z.width=S.clientWidth,z.height=S.clientHeight,z.x=z.left,z.y=z.top,z}(c,p):bo(function(S){var B,z=si(S),te=Mo(S),ae=(B=S.ownerDocument)==null?void 0:B.body,ge=In(z.scrollWidth,z.clientWidth,ae?ae.scrollWidth:0,ae?ae.clientWidth:0),Ae=In(z.scrollHeight,z.clientHeight,ae?ae.scrollHeight:0,ae?ae.clientHeight:0),we=-te.scrollLeft+So(S),Ee=-te.scrollTop;return kn(ae||z).direction==="rtl"&&(we+=In(z.clientWidth,ae?ae.clientWidth:0)-ge),{width:ge,height:Ae,x:we,y:Ee}}(si(x)))}function tc(x){var c,p=x.reference,S=x.element,B=x.placement,z=B?fn(B):null,te=B?ji(B):null,ae=p.x+p.width/2-S.width/2,ge=p.y+p.height/2-S.height/2;switch(z){case Gt:c={x:ae,y:p.y-S.height};break;case R:c={x:ae,y:p.y+p.height};break;case G:c={x:p.x+p.width,y:ge};break;case K:c={x:p.x-S.width,y:ge};break;default:c={x:p.x,y:p.y}}var Ae=z?vo(z):null;if(Ae!=null){var we=Ae==="y"?"height":"width";switch(te){case be:c[Ae]=c[Ae]-(p[we]/2-S[we]/2);break;case Pe:c[Ae]=c[Ae]+(p[we]/2-S[we]/2)}}return c}function Yi(x,c){c===void 0&&(c={});var p=c,S=p.placement,B=S===void 0?x.placement:S,z=p.strategy,te=z===void 0?x.strategy:z,ae=p.boundary,ge=ae===void 0?Fe:ae,Ae=p.rootBoundary,we=Ae===void 0?Ie:Ae,Ee=p.elementContext,Ye=Ee===void 0?We:Ee,Oe=p.altBoundary,qe=Oe!==void 0&&Oe,ke=p.padding,je=ke===void 0?0:ke,ft=Ya(typeof je!="number"?je:$a(je,ne)),xt=Ye===We?Ne:We,tt=x.rects.popper,ct=x.elements[qe?xt:Ye],Ze=function(Jt,mn,gn,wt){var Nn=mn==="clippingParents"?function(_t){var Qt=Fr(fs(_t)),_n=["absolute","fixed"].indexOf(kn(_t).position)>=0&&qt(_t)?Nr(_t):_t;return Zt(_n)?Qt.filter(function(ai){return Zt(ai)&&qa(ai,_n)&&rn(ai)!=="body"}):[]}(Jt):[].concat(mn),On=[].concat(Nn,[gn]),Zi=On[0],Ft=On.reduce(function(_t,Qt){var _n=ec(Jt,Qt,wt);return _t.top=In(_n.top,_t.top),_t.right=ds(_n.right,_t.right),_t.bottom=ds(_n.bottom,_t.bottom),_t.left=In(_n.left,_t.left),_t},ec(Jt,Zi,wt));return Ft.width=Ft.right-Ft.left,Ft.height=Ft.bottom-Ft.top,Ft.x=Ft.left,Ft.y=Ft.top,Ft}(Zt(ct)?ct:ct.contextElement||si(x.elements.popper),ge,we,te),ot=qi(x.elements.reference),ut=tc({reference:ot,element:tt,strategy:"absolute",placement:B}),pt=bo(Object.assign({},tt,ut)),ht=Ye===We?pt:ot,Ct={top:Ze.top-ht.top+ft.top,bottom:ht.bottom-Ze.bottom+ft.bottom,left:Ze.left-ht.left+ft.left,right:ht.right-Ze.right+ft.right},an=x.modifiersData.offset;if(Ye===We&&an){var bn=an[B];Object.keys(Ct).forEach(function(Jt){var mn=[G,R].indexOf(Jt)>=0?1:-1,gn=[Gt,R].indexOf(Jt)>=0?"y":"x";Ct[Jt]+=bn[gn]*mn})}return Ct}function Oh(x,c){c===void 0&&(c={});var p=c,S=p.placement,B=p.boundary,z=p.rootBoundary,te=p.padding,ae=p.flipVariations,ge=p.allowedAutoPlacements,Ae=ge===void 0?vt:ge,we=ji(S),Ee=we?ae?Xe:Xe.filter(function(qe){return ji(qe)===we}):ne,Ye=Ee.filter(function(qe){return Ae.indexOf(qe)>=0});Ye.length===0&&(Ye=Ee);var Oe=Ye.reduce(function(qe,ke){return qe[ke]=Yi(x,{placement:ke,boundary:B,rootBoundary:z,padding:te})[fn(ke)],qe},{});return Object.keys(Oe).sort(function(qe,ke){return Oe[qe]-Oe[ke]})}const nc={name:"flip",enabled:!0,phase:"main",fn:function(x){var c=x.state,p=x.options,S=x.name;if(!c.modifiersData[S]._skip){for(var B=p.mainAxis,z=B===void 0||B,te=p.altAxis,ae=te===void 0||te,ge=p.fallbackPlacements,Ae=p.padding,we=p.boundary,Ee=p.rootBoundary,Ye=p.altBoundary,Oe=p.flipVariations,qe=Oe===void 0||Oe,ke=p.allowedAutoPlacements,je=c.options.placement,ft=fn(je),xt=ge||(ft!==je&&qe?function(_t){if(fn(_t)===X)return[];var Qt=ms(_t);return[Ja(_t),Qt,Ja(Qt)]}(je):[ms(je)]),tt=[je].concat(xt).reduce(function(_t,Qt){return _t.concat(fn(Qt)===X?Oh(c,{placement:Qt,boundary:we,rootBoundary:Ee,padding:Ae,flipVariations:qe,allowedAutoPlacements:ke}):Qt)},[]),ct=c.rects.reference,Ze=c.rects.popper,ot=new Map,ut=!0,pt=tt[0],ht=0;ht<tt.length;ht++){var Ct=tt[ht],an=fn(Ct),bn=ji(Ct)===be,Jt=[Gt,R].indexOf(an)>=0,mn=Jt?"width":"height",gn=Yi(c,{placement:Ct,boundary:we,rootBoundary:Ee,altBoundary:Ye,padding:Ae}),wt=Jt?bn?G:K:bn?R:Gt;ct[mn]>Ze[mn]&&(wt=ms(wt));var Nn=ms(wt),On=[];if(z&&On.push(gn[an]<=0),ae&&On.push(gn[wt]<=0,gn[Nn]<=0),On.every(function(_t){return _t})){pt=Ct,ut=!1;break}ot.set(Ct,On)}if(ut)for(var Zi=function(_t){var Qt=tt.find(function(_n){var ai=ot.get(_n);if(ai)return ai.slice(0,_t).every(function(bs){return bs})});if(Qt)return pt=Qt,"break"},Ft=qe?3:1;Ft>0&&Zi(Ft)!=="break";Ft--);c.placement!==pt&&(c.modifiersData[S]._skip=!0,c.placement=pt,c.reset=!0)}},requiresIfExists:["offset"],data:{_skip:!1}};function ic(x,c,p){return p===void 0&&(p={x:0,y:0}),{top:x.top-c.height-p.y,right:x.right-c.width+p.x,bottom:x.bottom-c.height+p.y,left:x.left-c.width-p.x}}function rc(x){return[Gt,G,R,K].some(function(c){return x[c]>=0})}const sc={name:"hide",enabled:!0,phase:"main",requiresIfExists:["preventOverflow"],fn:function(x){var c=x.state,p=x.name,S=c.rects.reference,B=c.rects.popper,z=c.modifiersData.preventOverflow,te=Yi(c,{elementContext:"reference"}),ae=Yi(c,{altBoundary:!0}),ge=ic(te,S),Ae=ic(ae,B,z),we=rc(ge),Ee=rc(Ae);c.modifiersData[p]={referenceClippingOffsets:ge,popperEscapeOffsets:Ae,isReferenceHidden:we,hasPopperEscaped:Ee},c.attributes.popper=Object.assign({},c.attributes.popper,{"data-popper-reference-hidden":we,"data-popper-escaped":Ee})}},oc={name:"offset",enabled:!0,phase:"main",requires:["popperOffsets"],fn:function(x){var c=x.state,p=x.options,S=x.name,B=p.offset,z=B===void 0?[0,0]:B,te=vt.reduce(function(we,Ee){return we[Ee]=function(Ye,Oe,qe){var ke=fn(Ye),je=[K,Gt].indexOf(ke)>=0?-1:1,ft=typeof qe=="function"?qe(Object.assign({},Oe,{placement:Ye})):qe,xt=ft[0],tt=ft[1];return xt=xt||0,tt=(tt||0)*je,[K,G].indexOf(ke)>=0?{x:tt,y:xt}:{x:xt,y:tt}}(Ee,c.rects,z),we},{}),ae=te[c.placement],ge=ae.x,Ae=ae.y;c.modifiersData.popperOffsets!=null&&(c.modifiersData.popperOffsets.x+=ge,c.modifiersData.popperOffsets.y+=Ae),c.modifiersData[S]=te}},To={name:"popperOffsets",enabled:!0,phase:"read",fn:function(x){var c=x.state,p=x.name;c.modifiersData[p]=tc({reference:c.rects.reference,element:c.rects.popper,strategy:"absolute",placement:c.placement})},data:{}},ac={name:"preventOverflow",enabled:!0,phase:"main",fn:function(x){var c=x.state,p=x.options,S=x.name,B=p.mainAxis,z=B===void 0||B,te=p.altAxis,ae=te!==void 0&&te,ge=p.boundary,Ae=p.rootBoundary,we=p.altBoundary,Ee=p.padding,Ye=p.tether,Oe=Ye===void 0||Ye,qe=p.tetherOffset,ke=qe===void 0?0:qe,je=Yi(c,{boundary:ge,rootBoundary:Ae,padding:Ee,altBoundary:we}),ft=fn(c.placement),xt=ji(c.placement),tt=!xt,ct=vo(ft),Ze=ct==="x"?"y":"x",ot=c.modifiersData.popperOffsets,ut=c.rects.reference,pt=c.rects.popper,ht=typeof ke=="function"?ke(Object.assign({},c.rects,{placement:c.placement})):ke,Ct=typeof ht=="number"?{mainAxis:ht,altAxis:ht}:Object.assign({mainAxis:0,altAxis:0},ht),an=c.modifiersData.offset?c.modifiersData.offset[c.placement]:null,bn={x:0,y:0};if(ot){if(z){var Jt,mn=ct==="y"?Gt:K,gn=ct==="y"?R:G,wt=ct==="y"?"height":"width",Nn=ot[ct],On=Nn+je[mn],Zi=Nn-je[gn],Ft=Oe?-pt[wt]/2:0,_t=xt===be?ut[wt]:pt[wt],Qt=xt===be?-pt[wt]:-ut[wt],_n=c.elements.arrow,ai=Oe&&_n?_o(_n):{width:0,height:0},bs=c.modifiersData["arrow#persistent"]?c.modifiersData["arrow#persistent"].padding:{top:0,right:0,bottom:0,left:0},jc=bs[mn],Yc=bs[gn],Ts=Or(0,ut[wt],ai[wt]),df=tt?ut[wt]/2-Ft-Ts-jc-Ct.mainAxis:_t-Ts-jc-Ct.mainAxis,ff=tt?-ut[wt]/2+Ft+Ts+Yc+Ct.mainAxis:Qt+Ts+Yc+Ct.mainAxis,Bo=c.elements.arrow&&Nr(c.elements.arrow),pf=Bo?ct==="y"?Bo.clientTop||0:Bo.clientLeft||0:0,$c=(Jt=an==null?void 0:an[ct])!=null?Jt:0,mf=Nn+ff-$c,Kc=Or(Oe?ds(On,Nn+df-$c-pf):On,Nn,Oe?In(Zi,mf):Zi);ot[ct]=Kc,bn[ct]=Kc-Nn}if(ae){var Zc,gf=ct==="x"?Gt:K,_f=ct==="x"?R:G,Ri=ot[Ze],As=Ze==="y"?"height":"width",Jc=Ri+je[gf],Qc=Ri-je[_f],zo=[Gt,K].indexOf(ft)!==-1,el=(Zc=an==null?void 0:an[Ze])!=null?Zc:0,tl=zo?Jc:Ri-ut[As]-pt[As]-el+Ct.altAxis,nl=zo?Ri+ut[As]+pt[As]-el-Ct.altAxis:Qc,il=Oe&&zo?function(vf,xf,Ho){var rl=Or(vf,xf,Ho);return rl>Ho?Ho:rl}(tl,Ri,nl):Or(Oe?tl:Jc,Ri,Oe?nl:Qc);ot[Ze]=il,bn[Ze]=il-Ri}c.modifiersData[S]=bn}},requiresIfExists:["offset"]};function Fh(x,c,p){p===void 0&&(p=!1);var S,B,z=qt(c),te=qt(c)&&function(Ee){var Ye=Ee.getBoundingClientRect(),Oe=Xi(Ye.width)/Ee.offsetWidth||1,qe=Xi(Ye.height)/Ee.offsetHeight||1;return Oe!==1||qe!==1}(c),ae=si(c),ge=qi(x,te,p),Ae={scrollLeft:0,scrollTop:0},we={x:0,y:0};return(z||!z&&!p)&&((rn(c)!=="body"||Eo(ae))&&(Ae=(S=c)!==lt(S)&&qt(S)?{scrollLeft:(B=S).scrollLeft,scrollTop:B.scrollTop}:Mo(S)),qt(c)?((we=qi(c,!0)).x+=c.clientLeft,we.y+=c.clientTop):ae&&(we.x=So(ae))),{x:ge.left+Ae.scrollLeft-we.x,y:ge.top+Ae.scrollTop-we.y,width:ge.width,height:ge.height}}function Bh(x){var c=new Map,p=new Set,S=[];function B(z){p.add(z.name),[].concat(z.requires||[],z.requiresIfExists||[]).forEach(function(te){if(!p.has(te)){var ae=c.get(te);ae&&B(ae)}}),S.push(z)}return x.forEach(function(z){c.set(z.name,z)}),x.forEach(function(z){p.has(z.name)||B(z)}),S}var cc={placement:"bottom",modifiers:[],strategy:"absolute"};function lc(){for(var x=arguments.length,c=new Array(x),p=0;p<x;p++)c[p]=arguments[p];return!c.some(function(S){return!(S&&typeof S.getBoundingClientRect=="function")})}function gs(x){x===void 0&&(x={});var c=x,p=c.defaultModifiers,S=p===void 0?[]:p,B=c.defaultOptions,z=B===void 0?cc:B;return function(te,ae,ge){ge===void 0&&(ge=z);var Ae,we,Ee={placement:"bottom",orderedModifiers:[],options:Object.assign({},cc,z),modifiersData:{},elements:{reference:te,popper:ae},attributes:{},styles:{}},Ye=[],Oe=!1,qe={state:Ee,setOptions:function(je){var ft=typeof je=="function"?je(Ee.options):je;ke(),Ee.options=Object.assign({},z,Ee.options,ft),Ee.scrollParents={reference:Zt(te)?Fr(te):te.contextElement?Fr(te.contextElement):[],popper:Fr(ae)};var xt,tt,ct=function(Ze){var ot=Bh(Ze);return ri.reduce(function(ut,pt){return ut.concat(ot.filter(function(ht){return ht.phase===pt}))},[])}((xt=[].concat(S,Ee.options.modifiers),tt=xt.reduce(function(Ze,ot){var ut=Ze[ot.name];return Ze[ot.name]=ut?Object.assign({},ut,ot,{options:Object.assign({},ut.options,ot.options),data:Object.assign({},ut.data,ot.data)}):ot,Ze},{}),Object.keys(tt).map(function(Ze){return tt[Ze]})));return Ee.orderedModifiers=ct.filter(function(Ze){return Ze.enabled}),Ee.orderedModifiers.forEach(function(Ze){var ot=Ze.name,ut=Ze.options,pt=ut===void 0?{}:ut,ht=Ze.effect;if(typeof ht=="function"){var Ct=ht({state:Ee,name:ot,instance:qe,options:pt});Ye.push(Ct||function(){})}}),qe.update()},forceUpdate:function(){if(!Oe){var je=Ee.elements,ft=je.reference,xt=je.popper;if(lc(ft,xt)){Ee.rects={reference:Fh(ft,Nr(xt),Ee.options.strategy==="fixed"),popper:_o(xt)},Ee.reset=!1,Ee.placement=Ee.options.placement,Ee.orderedModifiers.forEach(function(ht){return Ee.modifiersData[ht.name]=Object.assign({},ht.data)});for(var tt=0;tt<Ee.orderedModifiers.length;tt++)if(Ee.reset!==!0){var ct=Ee.orderedModifiers[tt],Ze=ct.fn,ot=ct.options,ut=ot===void 0?{}:ot,pt=ct.name;typeof Ze=="function"&&(Ee=Ze({state:Ee,options:ut,name:pt,instance:qe})||Ee)}else Ee.reset=!1,tt=-1}}},update:(Ae=function(){return new Promise(function(je){qe.forceUpdate(),je(Ee)})},function(){return we||(we=new Promise(function(je){Promise.resolve().then(function(){we=void 0,je(Ae())})})),we}),destroy:function(){ke(),Oe=!0}};if(!lc(te,ae))return qe;function ke(){Ye.forEach(function(je){return je()}),Ye=[]}return qe.setOptions(ge).then(function(je){!Oe&&ge.onFirstUpdate&&ge.onFirstUpdate(je)}),qe}}var zh=gs(),Hh=gs({defaultModifiers:[yo,To,xo,yi]}),Ao=gs({defaultModifiers:[yo,To,xo,yi,oc,nc,ac,Ka,sc]});const uc=Object.freeze(Object.defineProperty({__proto__:null,afterMain:Wi,afterRead:dn,afterWrite:Ir,applyStyles:yi,arrow:Ka,auto:X,basePlacements:ne,beforeMain:Tt,beforeRead:Mt,beforeWrite:At,bottom:R,clippingParents:Fe,computeStyles:xo,createPopper:Ao,createPopperBase:zh,createPopperLite:Hh,detectOverflow:Yi,end:Pe,eventListeners:yo,flip:nc,hide:sc,left:K,main:et,modifierPhases:ri,offset:oc,placements:vt,popper:We,popperGenerator:gs,popperOffsets:To,preventOverflow:ac,read:Kt,reference:Ne,right:G,start:be,top:Gt,variationPlacements:Xe,viewport:Ie,write:Un},Symbol.toStringTag,{value:"Module"})),hc="dropdown",Mi=".bs.dropdown",wo=".data-api",kh="ArrowUp",dc="ArrowDown",Gh=`hide${Mi}`,Vh=`hidden${Mi}`,Wh=`show${Mi}`,Xh=`shown${Mi}`,fc=`click${Mi}${wo}`,pc=`keydown${Mi}${wo}`,qh=`keyup${Mi}${wo}`,$i="show",Si='[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)',jh=`${Si}.${$i}`,_s=".dropdown-menu",Yh=v()?"top-end":"top-start",$h=v()?"top-start":"top-end",Kh=v()?"bottom-end":"bottom-start",Zh=v()?"bottom-start":"bottom-end",Jh=v()?"left-start":"right-start",Qh=v()?"right-start":"left-start",ed={autoClose:!0,boundary:"clippingParents",display:"dynamic",offset:[0,2],popperConfig:null,reference:"toggle"},td={autoClose:"(boolean|string)",boundary:"(string|element)",display:"string",offset:"(array|string|function)",popperConfig:"(null|object|function)",reference:"(string|element|object)"};class En extends _e{constructor(c,p){super(c,p),this._popper=null,this._parent=this._element.parentNode,this._menu=ce.next(this._element,_s)[0]||ce.prev(this._element,_s)[0]||ce.findOne(_s,this._parent),this._inNavbar=this._detectNavbar()}static get Default(){return ed}static get DefaultType(){return td}static get NAME(){return hc}toggle(){return this._isShown()?this.hide():this.show()}show(){if(l(this._element)||this._isShown())return;const c={relatedTarget:this._element};if(!U.trigger(this._element,Wh,c).defaultPrevented){if(this._createPopper(),"ontouchstart"in document.documentElement&&!this._parent.closest(".navbar-nav"))for(const p of[].concat(...document.body.children))U.on(p,"mouseover",h);this._element.focus(),this._element.setAttribute("aria-expanded",!0),this._menu.classList.add($i),this._element.classList.add($i),U.trigger(this._element,Xh,c)}}hide(){if(l(this._element)||!this._isShown())return;const c={relatedTarget:this._element};this._completeHide(c)}dispose(){this._popper&&this._popper.destroy(),super.dispose()}update(){this._inNavbar=this._detectNavbar(),this._popper&&this._popper.update()}_completeHide(c){if(!U.trigger(this._element,Gh,c).defaultPrevented){if("ontouchstart"in document.documentElement)for(const p of[].concat(...document.body.children))U.off(p,"mouseover",h);this._popper&&this._popper.destroy(),this._menu.classList.remove($i),this._element.classList.remove($i),this._element.setAttribute("aria-expanded","false"),ee.removeDataAttribute(this._menu,"popper"),U.trigger(this._element,Vh,c)}}_getConfig(c){if(typeof(c=super._getConfig(c)).reference=="object"&&!s(c.reference)&&typeof c.reference.getBoundingClientRect!="function")throw new TypeError(`${hc.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);return c}_createPopper(){if(uc===void 0)throw new TypeError("Bootstrap's dropdowns require Popper (https://popper.js.org)");let c=this._element;this._config.reference==="parent"?c=this._parent:s(this._config.reference)?c=a(this._config.reference):typeof this._config.reference=="object"&&(c=this._config.reference);const p=this._getPopperConfig();this._popper=Ao(c,this._menu,p)}_isShown(){return this._menu.classList.contains($i)}_getPlacement(){const c=this._parent;if(c.classList.contains("dropend"))return Jh;if(c.classList.contains("dropstart"))return Qh;if(c.classList.contains("dropup-center"))return"top";if(c.classList.contains("dropdown-center"))return"bottom";const p=getComputedStyle(this._menu).getPropertyValue("--bs-position").trim()==="end";return c.classList.contains("dropup")?p?$h:Yh:p?Zh:Kh}_detectNavbar(){return this._element.closest(".navbar")!==null}_getOffset(){const{offset:c}=this._config;return typeof c=="string"?c.split(",").map(p=>Number.parseInt(p,10)):typeof c=="function"?p=>c(p,this._element):c}_getPopperConfig(){const c={placement:this._getPlacement(),modifiers:[{name:"preventOverflow",options:{boundary:this._config.boundary}},{name:"offset",options:{offset:this._getOffset()}}]};return(this._inNavbar||this._config.display==="static")&&(ee.setDataAttribute(this._menu,"popper","static"),c.modifiers=[{name:"applyStyles",enabled:!1}]),{...c,...g(this._config.popperConfig,[c])}}_selectMenuItem({key:c,target:p}){const S=ce.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)",this._menu).filter(B=>o(B));S.length&&D(S,p,c===dc,!S.includes(p)).focus()}static jQueryInterface(c){return this.each(function(){const p=En.getOrCreateInstance(this,c);if(typeof c=="string"){if(p[c]===void 0)throw new TypeError(`No method named "${c}"`);p[c]()}})}static clearMenus(c){if(c.button===2||c.type==="keyup"&&c.key!=="Tab")return;const p=ce.find(jh);for(const S of p){const B=En.getInstance(S);if(!B||B._config.autoClose===!1)continue;const z=c.composedPath(),te=z.includes(B._menu);if(z.includes(B._element)||B._config.autoClose==="inside"&&!te||B._config.autoClose==="outside"&&te||B._menu.contains(c.target)&&(c.type==="keyup"&&c.key==="Tab"||/input|select|option|textarea|form/i.test(c.target.tagName)))continue;const ae={relatedTarget:B._element};c.type==="click"&&(ae.clickEvent=c),B._completeHide(ae)}}static dataApiKeydownHandler(c){const p=/input|textarea/i.test(c.target.tagName),S=c.key==="Escape",B=[kh,dc].includes(c.key);if(!B&&!S||p&&!S)return;c.preventDefault();const z=this.matches(Si)?this:ce.prev(this,Si)[0]||ce.next(this,Si)[0]||ce.findOne(Si,c.delegateTarget.parentNode),te=En.getOrCreateInstance(z);if(B)return c.stopPropagation(),te.show(),void te._selectMenuItem(c);te._isShown()&&(c.stopPropagation(),te.hide(),z.focus())}}U.on(document,pc,Si,En.dataApiKeydownHandler),U.on(document,pc,_s,En.dataApiKeydownHandler),U.on(document,fc,En.clearMenus),U.on(document,qh,En.clearMenus),U.on(document,fc,Si,function(x){x.preventDefault(),En.getOrCreateInstance(this).toggle()}),y(En);const mc="backdrop",gc="show",_c=`mousedown.bs.${mc}`,nd={className:"modal-backdrop",clickCallback:null,isAnimated:!1,isVisible:!0,rootElement:"body"},id={className:"string",clickCallback:"(function|null)",isAnimated:"boolean",isVisible:"boolean",rootElement:"(element|string)"};class vc extends ve{constructor(c){super(),this._config=this._getConfig(c),this._isAppended=!1,this._element=null}static get Default(){return nd}static get DefaultType(){return id}static get NAME(){return mc}show(c){if(!this._config.isVisible)return void g(c);this._append();const p=this._getElement();this._config.isAnimated&&d(p),p.classList.add(gc),this._emulateAnimation(()=>{g(c)})}hide(c){this._config.isVisible?(this._getElement().classList.remove(gc),this._emulateAnimation(()=>{this.dispose(),g(c)})):g(c)}dispose(){this._isAppended&&(U.off(this._element,_c),this._element.remove(),this._isAppended=!1)}_getElement(){if(!this._element){const c=document.createElement("div");c.className=this._config.className,this._config.isAnimated&&c.classList.add("fade"),this._element=c}return this._element}_configAfterMerge(c){return c.rootElement=a(c.rootElement),c}_append(){if(this._isAppended)return;const c=this._getElement();this._config.rootElement.append(c),U.on(c,_c,()=>{g(this._config.clickCallback)}),this._isAppended=!0}_emulateAnimation(c){m(c,this._getElement(),this._config.isAnimated)}}const vs=".bs.focustrap",rd=`focusin${vs}`,sd=`keydown.tab${vs}`,xc="backward",od={autofocus:!0,trapElement:null},ad={autofocus:"boolean",trapElement:"element"};class yc extends ve{constructor(c){super(),this._config=this._getConfig(c),this._isActive=!1,this._lastTabNavDirection=null}static get Default(){return od}static get DefaultType(){return ad}static get NAME(){return"focustrap"}activate(){this._isActive||(this._config.autofocus&&this._config.trapElement.focus(),U.off(document,vs),U.on(document,rd,c=>this._handleFocusin(c)),U.on(document,sd,c=>this._handleKeydown(c)),this._isActive=!0)}deactivate(){this._isActive&&(this._isActive=!1,U.off(document,vs))}_handleFocusin(c){const{trapElement:p}=this._config;if(c.target===document||c.target===p||p.contains(c.target))return;const S=ce.focusableChildren(p);S.length===0?p.focus():this._lastTabNavDirection===xc?S[S.length-1].focus():S[0].focus()}_handleKeydown(c){c.key==="Tab"&&(this._lastTabNavDirection=c.shiftKey?xc:"forward")}}const Mc=".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",Sc=".sticky-top",xs="padding-right",Ec="margin-right";class Ro{constructor(){this._element=document.body}getWidth(){const c=document.documentElement.clientWidth;return Math.abs(window.innerWidth-c)}hide(){const c=this.getWidth();this._disableOverFlow(),this._setElementAttributes(this._element,xs,p=>p+c),this._setElementAttributes(Mc,xs,p=>p+c),this._setElementAttributes(Sc,Ec,p=>p-c)}reset(){this._resetElementAttributes(this._element,"overflow"),this._resetElementAttributes(this._element,xs),this._resetElementAttributes(Mc,xs),this._resetElementAttributes(Sc,Ec)}isOverflowing(){return this.getWidth()>0}_disableOverFlow(){this._saveInitialAttribute(this._element,"overflow"),this._element.style.overflow="hidden"}_setElementAttributes(c,p,S){const B=this.getWidth();this._applyManipulationCallback(c,z=>{if(z!==this._element&&window.innerWidth>z.clientWidth+B)return;this._saveInitialAttribute(z,p);const te=window.getComputedStyle(z).getPropertyValue(p);z.style.setProperty(p,`${S(Number.parseFloat(te))}px`)})}_saveInitialAttribute(c,p){const S=c.style.getPropertyValue(p);S&&ee.setDataAttribute(c,p,S)}_resetElementAttributes(c,p){this._applyManipulationCallback(c,S=>{const B=ee.getDataAttribute(S,p);B!==null?(ee.removeDataAttribute(S,p),S.style.setProperty(p,B)):S.style.removeProperty(p)})}_applyManipulationCallback(c,p){if(s(c))p(c);else for(const S of ce.find(c,this._element))p(S)}}const pn=".bs.modal",cd=`hide${pn}`,ld=`hidePrevented${pn}`,bc=`hidden${pn}`,Tc=`show${pn}`,ud=`shown${pn}`,hd=`resize${pn}`,dd=`click.dismiss${pn}`,fd=`mousedown.dismiss${pn}`,pd=`keydown.dismiss${pn}`,md=`click${pn}.data-api`,Ac="modal-open",wc="show",Co="modal-static",gd={backdrop:!0,focus:!0,keyboard:!0},_d={backdrop:"(boolean|string)",focus:"boolean",keyboard:"boolean"};class Ei extends _e{constructor(c,p){super(c,p),this._dialog=ce.findOne(".modal-dialog",this._element),this._backdrop=this._initializeBackDrop(),this._focustrap=this._initializeFocusTrap(),this._isShown=!1,this._isTransitioning=!1,this._scrollBar=new Ro,this._addEventListeners()}static get Default(){return gd}static get DefaultType(){return _d}static get NAME(){return"modal"}toggle(c){return this._isShown?this.hide():this.show(c)}show(c){this._isShown||this._isTransitioning||U.trigger(this._element,Tc,{relatedTarget:c}).defaultPrevented||(this._isShown=!0,this._isTransitioning=!0,this._scrollBar.hide(),document.body.classList.add(Ac),this._adjustDialog(),this._backdrop.show(()=>this._showElement(c)))}hide(){this._isShown&&!this._isTransitioning&&(U.trigger(this._element,cd).defaultPrevented||(this._isShown=!1,this._isTransitioning=!0,this._focustrap.deactivate(),this._element.classList.remove(wc),this._queueCallback(()=>this._hideModal(),this._element,this._isAnimated())))}dispose(){U.off(window,pn),U.off(this._dialog,pn),this._backdrop.dispose(),this._focustrap.deactivate(),super.dispose()}handleUpdate(){this._adjustDialog()}_initializeBackDrop(){return new vc({isVisible:!!this._config.backdrop,isAnimated:this._isAnimated()})}_initializeFocusTrap(){return new yc({trapElement:this._element})}_showElement(c){document.body.contains(this._element)||document.body.append(this._element),this._element.style.display="block",this._element.removeAttribute("aria-hidden"),this._element.setAttribute("aria-modal",!0),this._element.setAttribute("role","dialog"),this._element.scrollTop=0;const p=ce.findOne(".modal-body",this._dialog);p&&(p.scrollTop=0),d(this._element),this._element.classList.add(wc),this._queueCallback(()=>{this._config.focus&&this._focustrap.activate(),this._isTransitioning=!1,U.trigger(this._element,ud,{relatedTarget:c})},this._dialog,this._isAnimated())}_addEventListeners(){U.on(this._element,pd,c=>{c.key==="Escape"&&(this._config.keyboard?this.hide():this._triggerBackdropTransition())}),U.on(window,hd,()=>{this._isShown&&!this._isTransitioning&&this._adjustDialog()}),U.on(this._element,fd,c=>{U.one(this._element,dd,p=>{this._element===c.target&&this._element===p.target&&(this._config.backdrop!=="static"?this._config.backdrop&&this.hide():this._triggerBackdropTransition())})})}_hideModal(){this._element.style.display="none",this._element.setAttribute("aria-hidden",!0),this._element.removeAttribute("aria-modal"),this._element.removeAttribute("role"),this._isTransitioning=!1,this._backdrop.hide(()=>{document.body.classList.remove(Ac),this._resetAdjustments(),this._scrollBar.reset(),U.trigger(this._element,bc)})}_isAnimated(){return this._element.classList.contains("fade")}_triggerBackdropTransition(){if(U.trigger(this._element,ld).defaultPrevented)return;const c=this._element.scrollHeight>document.documentElement.clientHeight,p=this._element.style.overflowY;p==="hidden"||this._element.classList.contains(Co)||(c||(this._element.style.overflowY="hidden"),this._element.classList.add(Co),this._queueCallback(()=>{this._element.classList.remove(Co),this._queueCallback(()=>{this._element.style.overflowY=p},this._dialog)},this._dialog),this._element.focus())}_adjustDialog(){const c=this._element.scrollHeight>document.documentElement.clientHeight,p=this._scrollBar.getWidth(),S=p>0;if(S&&!c){const B=v()?"paddingLeft":"paddingRight";this._element.style[B]=`${p}px`}if(!S&&c){const B=v()?"paddingRight":"paddingLeft";this._element.style[B]=`${p}px`}}_resetAdjustments(){this._element.style.paddingLeft="",this._element.style.paddingRight=""}static jQueryInterface(c,p){return this.each(function(){const S=Ei.getOrCreateInstance(this,c);if(typeof c=="string"){if(S[c]===void 0)throw new TypeError(`No method named "${c}"`);S[c](p)}})}}U.on(document,md,'[data-bs-toggle="modal"]',function(x){const c=ce.getElementFromSelector(this);["A","AREA"].includes(this.tagName)&&x.preventDefault(),U.one(c,Tc,S=>{S.defaultPrevented||U.one(c,bc,()=>{o(this)&&this.focus()})});const p=ce.findOne(".modal.show");p&&Ei.getInstance(p).hide(),Ei.getOrCreateInstance(c).toggle(this)}),Ue(Ei),y(Ei);const Gn=".bs.offcanvas",Rc=".data-api",vd=`load${Gn}${Rc}`,Cc="show",Lc="showing",Pc="hiding",Dc=".offcanvas.show",xd=`show${Gn}`,yd=`shown${Gn}`,Md=`hide${Gn}`,Uc=`hidePrevented${Gn}`,Ic=`hidden${Gn}`,Sd=`resize${Gn}`,Ed=`click${Gn}${Rc}`,bd=`keydown.dismiss${Gn}`,Td={backdrop:!0,keyboard:!0,scroll:!1},Ad={backdrop:"(boolean|string)",keyboard:"boolean",scroll:"boolean"};class Vn extends _e{constructor(c,p){super(c,p),this._isShown=!1,this._backdrop=this._initializeBackDrop(),this._focustrap=this._initializeFocusTrap(),this._addEventListeners()}static get Default(){return Td}static get DefaultType(){return Ad}static get NAME(){return"offcanvas"}toggle(c){return this._isShown?this.hide():this.show(c)}show(c){this._isShown||U.trigger(this._element,xd,{relatedTarget:c}).defaultPrevented||(this._isShown=!0,this._backdrop.show(),this._config.scroll||new Ro().hide(),this._element.setAttribute("aria-modal",!0),this._element.setAttribute("role","dialog"),this._element.classList.add(Lc),this._queueCallback(()=>{this._config.scroll&&!this._config.backdrop||this._focustrap.activate(),this._element.classList.add(Cc),this._element.classList.remove(Lc),U.trigger(this._element,yd,{relatedTarget:c})},this._element,!0))}hide(){this._isShown&&(U.trigger(this._element,Md).defaultPrevented||(this._focustrap.deactivate(),this._element.blur(),this._isShown=!1,this._element.classList.add(Pc),this._backdrop.hide(),this._queueCallback(()=>{this._element.classList.remove(Cc,Pc),this._element.removeAttribute("aria-modal"),this._element.removeAttribute("role"),this._config.scroll||new Ro().reset(),U.trigger(this._element,Ic)},this._element,!0)))}dispose(){this._backdrop.dispose(),this._focustrap.deactivate(),super.dispose()}_initializeBackDrop(){const c=!!this._config.backdrop;return new vc({className:"offcanvas-backdrop",isVisible:c,isAnimated:!0,rootElement:this._element.parentNode,clickCallback:c?()=>{this._config.backdrop!=="static"?this.hide():U.trigger(this._element,Uc)}:null})}_initializeFocusTrap(){return new yc({trapElement:this._element})}_addEventListeners(){U.on(this._element,bd,c=>{c.key==="Escape"&&(this._config.keyboard?this.hide():U.trigger(this._element,Uc))})}static jQueryInterface(c){return this.each(function(){const p=Vn.getOrCreateInstance(this,c);if(typeof c=="string"){if(p[c]===void 0||c.startsWith("_")||c==="constructor")throw new TypeError(`No method named "${c}"`);p[c](this)}})}}U.on(document,Ed,'[data-bs-toggle="offcanvas"]',function(x){const c=ce.getElementFromSelector(this);if(["A","AREA"].includes(this.tagName)&&x.preventDefault(),l(this))return;U.one(c,Ic,()=>{o(this)&&this.focus()});const p=ce.findOne(Dc);p&&p!==c&&Vn.getInstance(p).hide(),Vn.getOrCreateInstance(c).toggle(this)}),U.on(window,vd,()=>{for(const x of ce.find(Dc))Vn.getOrCreateInstance(x).show()}),U.on(window,Sd,()=>{for(const x of ce.find("[aria-modal][class*=show][class*=offcanvas-]"))getComputedStyle(x).position!=="fixed"&&Vn.getOrCreateInstance(x).hide()}),Ue(Vn),y(Vn);const Nc={"*":["class","dir","id","lang","role",/^aria-[\w-]*$/i],a:["target","href","title","rel"],area:[],b:[],br:[],col:[],code:[],div:[],em:[],hr:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],i:[],img:["src","srcset","alt","title","width","height"],li:[],ol:[],p:[],pre:[],s:[],small:[],span:[],sub:[],sup:[],strong:[],u:[],ul:[]},wd=new Set(["background","cite","href","itemtype","longdesc","poster","src","xlink:href"]),Rd=/^(?!javascript:)(?:[a-z0-9+.-]+:|[^&:/?#]*(?:[/?#]|$))/i,Cd=(x,c)=>{const p=x.nodeName.toLowerCase();return c.includes(p)?!wd.has(p)||!!Rd.test(x.nodeValue):c.filter(S=>S instanceof RegExp).some(S=>S.test(p))},Ld={allowList:Nc,content:{},extraClass:"",html:!1,sanitize:!0,sanitizeFn:null,template:"<div></div>"},Pd={allowList:"object",content:"object",extraClass:"(string|function)",html:"boolean",sanitize:"boolean",sanitizeFn:"(null|function)",template:"string"},Dd={entry:"(string|element|function|null)",selector:"(string|element)"};class Ud extends ve{constructor(c){super(),this._config=this._getConfig(c)}static get Default(){return Ld}static get DefaultType(){return Pd}static get NAME(){return"TemplateFactory"}getContent(){return Object.values(this._config.content).map(c=>this._resolvePossibleFunction(c)).filter(Boolean)}hasContent(){return this.getContent().length>0}changeContent(c){return this._checkContent(c),this._config.content={...this._config.content,...c},this}toHtml(){const c=document.createElement("div");c.innerHTML=this._maybeSanitize(this._config.template);for(const[B,z]of Object.entries(this._config.content))this._setContent(c,z,B);const p=c.children[0],S=this._resolvePossibleFunction(this._config.extraClass);return S&&p.classList.add(...S.split(" ")),p}_typeCheckConfig(c){super._typeCheckConfig(c),this._checkContent(c.content)}_checkContent(c){for(const[p,S]of Object.entries(c))super._typeCheckConfig({selector:p,entry:S},Dd)}_setContent(c,p,S){const B=ce.findOne(S,c);B&&((p=this._resolvePossibleFunction(p))?s(p)?this._putElementInTemplate(a(p),B):this._config.html?B.innerHTML=this._maybeSanitize(p):B.textContent=p:B.remove())}_maybeSanitize(c){return this._config.sanitize?function(p,S,B){if(!p.length)return p;if(B&&typeof B=="function")return B(p);const z=new window.DOMParser().parseFromString(p,"text/html"),te=[].concat(...z.body.querySelectorAll("*"));for(const ae of te){const ge=ae.nodeName.toLowerCase();if(!Object.keys(S).includes(ge)){ae.remove();continue}const Ae=[].concat(...ae.attributes),we=[].concat(S["*"]||[],S[ge]||[]);for(const Ee of Ae)Cd(Ee,we)||ae.removeAttribute(Ee.nodeName)}return z.body.innerHTML}(c,this._config.allowList,this._config.sanitizeFn):c}_resolvePossibleFunction(c){return g(c,[this])}_putElementInTemplate(c,p){if(this._config.html)return p.innerHTML="",void p.append(c);p.textContent=c.textContent}}const Id=new Set(["sanitize","allowList","sanitizeFn"]),Lo="fade",ys="show",Oc=".modal",Fc="hide.bs.modal",Br="hover",Po="focus",Nd={AUTO:"auto",TOP:"top",RIGHT:v()?"left":"right",BOTTOM:"bottom",LEFT:v()?"right":"left"},Od={allowList:Nc,animation:!0,boundary:"clippingParents",container:!1,customClass:"",delay:0,fallbackPlacements:["top","right","bottom","left"],html:!1,offset:[0,6],placement:"top",popperConfig:null,sanitize:!0,sanitizeFn:null,selector:!1,template:'<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',title:"",trigger:"hover focus"},Fd={allowList:"object",animation:"boolean",boundary:"(string|element)",container:"(string|element|boolean)",customClass:"(string|function)",delay:"(number|object)",fallbackPlacements:"array",html:"boolean",offset:"(array|string|function)",placement:"(string|function)",popperConfig:"(null|object|function)",sanitize:"boolean",sanitizeFn:"(null|function)",selector:"(string|boolean)",template:"string",title:"(string|element|function)",trigger:"string"};class bi extends _e{constructor(c,p){if(uc===void 0)throw new TypeError("Bootstrap's tooltips require Popper (https://popper.js.org)");super(c,p),this._isEnabled=!0,this._timeout=0,this._isHovered=null,this._activeTrigger={},this._popper=null,this._templateFactory=null,this._newContent=null,this.tip=null,this._setListeners(),this._config.selector||this._fixTitle()}static get Default(){return Od}static get DefaultType(){return Fd}static get NAME(){return"tooltip"}enable(){this._isEnabled=!0}disable(){this._isEnabled=!1}toggleEnabled(){this._isEnabled=!this._isEnabled}toggle(){this._isEnabled&&(this._activeTrigger.click=!this._activeTrigger.click,this._isShown()?this._leave():this._enter())}dispose(){clearTimeout(this._timeout),U.off(this._element.closest(Oc),Fc,this._hideModalHandler),this._element.getAttribute("data-bs-original-title")&&this._element.setAttribute("title",this._element.getAttribute("data-bs-original-title")),this._disposePopper(),super.dispose()}show(){if(this._element.style.display==="none")throw new Error("Please use show on visible elements");if(!this._isWithContent()||!this._isEnabled)return;const c=U.trigger(this._element,this.constructor.eventName("show")),p=(u(this._element)||this._element.ownerDocument.documentElement).contains(this._element);if(c.defaultPrevented||!p)return;this._disposePopper();const S=this._getTipElement();this._element.setAttribute("aria-describedby",S.getAttribute("id"));const{container:B}=this._config;if(this._element.ownerDocument.documentElement.contains(this.tip)||(B.append(S),U.trigger(this._element,this.constructor.eventName("inserted"))),this._popper=this._createPopper(S),S.classList.add(ys),"ontouchstart"in document.documentElement)for(const z of[].concat(...document.body.children))U.on(z,"mouseover",h);this._queueCallback(()=>{U.trigger(this._element,this.constructor.eventName("shown")),this._isHovered===!1&&this._leave(),this._isHovered=!1},this.tip,this._isAnimated())}hide(){if(this._isShown()&&!U.trigger(this._element,this.constructor.eventName("hide")).defaultPrevented){if(this._getTipElement().classList.remove(ys),"ontouchstart"in document.documentElement)for(const c of[].concat(...document.body.children))U.off(c,"mouseover",h);this._activeTrigger.click=!1,this._activeTrigger[Po]=!1,this._activeTrigger[Br]=!1,this._isHovered=null,this._queueCallback(()=>{this._isWithActiveTrigger()||(this._isHovered||this._disposePopper(),this._element.removeAttribute("aria-describedby"),U.trigger(this._element,this.constructor.eventName("hidden")))},this.tip,this._isAnimated())}}update(){this._popper&&this._popper.update()}_isWithContent(){return!!this._getTitle()}_getTipElement(){return this.tip||(this.tip=this._createTipElement(this._newContent||this._getContentForTemplate())),this.tip}_createTipElement(c){const p=this._getTemplateFactory(c).toHtml();if(!p)return null;p.classList.remove(Lo,ys),p.classList.add(`bs-${this.constructor.NAME}-auto`);const S=(B=>{do B+=Math.floor(1e6*Math.random());while(document.getElementById(B));return B})(this.constructor.NAME).toString();return p.setAttribute("id",S),this._isAnimated()&&p.classList.add(Lo),p}setContent(c){this._newContent=c,this._isShown()&&(this._disposePopper(),this.show())}_getTemplateFactory(c){return this._templateFactory?this._templateFactory.changeContent(c):this._templateFactory=new Ud({...this._config,content:c,extraClass:this._resolvePossibleFunction(this._config.customClass)}),this._templateFactory}_getContentForTemplate(){return{".tooltip-inner":this._getTitle()}}_getTitle(){return this._resolvePossibleFunction(this._config.title)||this._element.getAttribute("data-bs-original-title")}_initializeOnDelegatedTarget(c){return this.constructor.getOrCreateInstance(c.delegateTarget,this._getDelegateConfig())}_isAnimated(){return this._config.animation||this.tip&&this.tip.classList.contains(Lo)}_isShown(){return this.tip&&this.tip.classList.contains(ys)}_createPopper(c){const p=g(this._config.placement,[this,c,this._element]),S=Nd[p.toUpperCase()];return Ao(this._element,c,this._getPopperConfig(S))}_getOffset(){const{offset:c}=this._config;return typeof c=="string"?c.split(",").map(p=>Number.parseInt(p,10)):typeof c=="function"?p=>c(p,this._element):c}_resolvePossibleFunction(c){return g(c,[this._element])}_getPopperConfig(c){const p={placement:c,modifiers:[{name:"flip",options:{fallbackPlacements:this._config.fallbackPlacements}},{name:"offset",options:{offset:this._getOffset()}},{name:"preventOverflow",options:{boundary:this._config.boundary}},{name:"arrow",options:{element:`.${this.constructor.NAME}-arrow`}},{name:"preSetPlacement",enabled:!0,phase:"beforeMain",fn:S=>{this._getTipElement().setAttribute("data-popper-placement",S.state.placement)}}]};return{...p,...g(this._config.popperConfig,[p])}}_setListeners(){const c=this._config.trigger.split(" ");for(const p of c)if(p==="click")U.on(this._element,this.constructor.eventName("click"),this._config.selector,S=>{this._initializeOnDelegatedTarget(S).toggle()});else if(p!=="manual"){const S=p===Br?this.constructor.eventName("mouseenter"):this.constructor.eventName("focusin"),B=p===Br?this.constructor.eventName("mouseleave"):this.constructor.eventName("focusout");U.on(this._element,S,this._config.selector,z=>{const te=this._initializeOnDelegatedTarget(z);te._activeTrigger[z.type==="focusin"?Po:Br]=!0,te._enter()}),U.on(this._element,B,this._config.selector,z=>{const te=this._initializeOnDelegatedTarget(z);te._activeTrigger[z.type==="focusout"?Po:Br]=te._element.contains(z.relatedTarget),te._leave()})}this._hideModalHandler=()=>{this._element&&this.hide()},U.on(this._element.closest(Oc),Fc,this._hideModalHandler)}_fixTitle(){const c=this._element.getAttribute("title");c&&(this._element.getAttribute("aria-label")||this._element.textContent.trim()||this._element.setAttribute("aria-label",c),this._element.setAttribute("data-bs-original-title",c),this._element.removeAttribute("title"))}_enter(){this._isShown()||this._isHovered?this._isHovered=!0:(this._isHovered=!0,this._setTimeout(()=>{this._isHovered&&this.show()},this._config.delay.show))}_leave(){this._isWithActiveTrigger()||(this._isHovered=!1,this._setTimeout(()=>{this._isHovered||this.hide()},this._config.delay.hide))}_setTimeout(c,p){clearTimeout(this._timeout),this._timeout=setTimeout(c,p)}_isWithActiveTrigger(){return Object.values(this._activeTrigger).includes(!0)}_getConfig(c){const p=ee.getDataAttributes(this._element);for(const S of Object.keys(p))Id.has(S)&&delete p[S];return c={...p,...typeof c=="object"&&c?c:{}},c=this._mergeConfigObj(c),c=this._configAfterMerge(c),this._typeCheckConfig(c),c}_configAfterMerge(c){return c.container=c.container===!1?document.body:a(c.container),typeof c.delay=="number"&&(c.delay={show:c.delay,hide:c.delay}),typeof c.title=="number"&&(c.title=c.title.toString()),typeof c.content=="number"&&(c.content=c.content.toString()),c}_getDelegateConfig(){const c={};for(const[p,S]of Object.entries(this._config))this.constructor.Default[p]!==S&&(c[p]=S);return c.selector=!1,c.trigger="manual",c}_disposePopper(){this._popper&&(this._popper.destroy(),this._popper=null),this.tip&&(this.tip.remove(),this.tip=null)}static jQueryInterface(c){return this.each(function(){const p=bi.getOrCreateInstance(this,c);if(typeof c=="string"){if(p[c]===void 0)throw new TypeError(`No method named "${c}"`);p[c]()}})}}y(bi);const Bd={...bi.Default,content:"",offset:[0,8],placement:"right",template:'<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>',trigger:"click"},zd={...bi.DefaultType,content:"(null|string|element|function)"};class Ms extends bi{static get Default(){return Bd}static get DefaultType(){return zd}static get NAME(){return"popover"}_isWithContent(){return this._getTitle()||this._getContent()}_getContentForTemplate(){return{".popover-header":this._getTitle(),".popover-body":this._getContent()}}_getContent(){return this._resolvePossibleFunction(this._config.content)}static jQueryInterface(c){return this.each(function(){const p=Ms.getOrCreateInstance(this,c);if(typeof c=="string"){if(p[c]===void 0)throw new TypeError(`No method named "${c}"`);p[c]()}})}}y(Ms);const Do=".bs.scrollspy",Hd=`activate${Do}`,Bc=`click${Do}`,kd=`load${Do}.data-api`,Ki="active",Uo="[href]",zc=".nav-link",Gd=`${zc}, .nav-item > ${zc}, .list-group-item`,Vd={offset:null,rootMargin:"0px 0px -25%",smoothScroll:!1,target:null,threshold:[.1,.5,1]},Wd={offset:"(number|null)",rootMargin:"string",smoothScroll:"boolean",target:"element",threshold:"array"};class zr extends _e{constructor(c,p){super(c,p),this._targetLinks=new Map,this._observableSections=new Map,this._rootElement=getComputedStyle(this._element).overflowY==="visible"?null:this._element,this._activeTarget=null,this._observer=null,this._previousScrollData={visibleEntryTop:0,parentScrollTop:0},this.refresh()}static get Default(){return Vd}static get DefaultType(){return Wd}static get NAME(){return"scrollspy"}refresh(){this._initializeTargetsAndObservables(),this._maybeEnableSmoothScroll(),this._observer?this._observer.disconnect():this._observer=this._getNewObserver();for(const c of this._observableSections.values())this._observer.observe(c)}dispose(){this._observer.disconnect(),super.dispose()}_configAfterMerge(c){return c.target=a(c.target)||document.body,c.rootMargin=c.offset?`${c.offset}px 0px -30%`:c.rootMargin,typeof c.threshold=="string"&&(c.threshold=c.threshold.split(",").map(p=>Number.parseFloat(p))),c}_maybeEnableSmoothScroll(){this._config.smoothScroll&&(U.off(this._config.target,Bc),U.on(this._config.target,Bc,Uo,c=>{const p=this._observableSections.get(c.target.hash);if(p){c.preventDefault();const S=this._rootElement||window,B=p.offsetTop-this._element.offsetTop;if(S.scrollTo)return void S.scrollTo({top:B,behavior:"smooth"});S.scrollTop=B}}))}_getNewObserver(){const c={root:this._rootElement,threshold:this._config.threshold,rootMargin:this._config.rootMargin};return new IntersectionObserver(p=>this._observerCallback(p),c)}_observerCallback(c){const p=te=>this._targetLinks.get(`#${te.target.id}`),S=te=>{this._previousScrollData.visibleEntryTop=te.target.offsetTop,this._process(p(te))},B=(this._rootElement||document.documentElement).scrollTop,z=B>=this._previousScrollData.parentScrollTop;this._previousScrollData.parentScrollTop=B;for(const te of c){if(!te.isIntersecting){this._activeTarget=null,this._clearActiveClass(p(te));continue}const ae=te.target.offsetTop>=this._previousScrollData.visibleEntryTop;if(z&&ae){if(S(te),!B)return}else z||ae||S(te)}}_initializeTargetsAndObservables(){this._targetLinks=new Map,this._observableSections=new Map;const c=ce.find(Uo,this._config.target);for(const p of c){if(!p.hash||l(p))continue;const S=ce.findOne(decodeURI(p.hash),this._element);o(S)&&(this._targetLinks.set(decodeURI(p.hash),p),this._observableSections.set(p.hash,S))}}_process(c){this._activeTarget!==c&&(this._clearActiveClass(this._config.target),this._activeTarget=c,c.classList.add(Ki),this._activateParents(c),U.trigger(this._element,Hd,{relatedTarget:c}))}_activateParents(c){if(c.classList.contains("dropdown-item"))ce.findOne(".dropdown-toggle",c.closest(".dropdown")).classList.add(Ki);else for(const p of ce.parents(c,".nav, .list-group"))for(const S of ce.prev(p,Gd))S.classList.add(Ki)}_clearActiveClass(c){c.classList.remove(Ki);const p=ce.find(`${Uo}.${Ki}`,c);for(const S of p)S.classList.remove(Ki)}static jQueryInterface(c){return this.each(function(){const p=zr.getOrCreateInstance(this,c);if(typeof c=="string"){if(p[c]===void 0||c.startsWith("_")||c==="constructor")throw new TypeError(`No method named "${c}"`);p[c]()}})}}U.on(window,kd,()=>{for(const x of ce.find('[data-bs-spy="scroll"]'))zr.getOrCreateInstance(x)}),y(zr);const Ti=".bs.tab",Xd=`hide${Ti}`,qd=`hidden${Ti}`,jd=`show${Ti}`,Yd=`shown${Ti}`,$d=`click${Ti}`,Kd=`keydown${Ti}`,Zd=`load${Ti}`,Jd="ArrowLeft",Hc="ArrowRight",Qd="ArrowUp",kc="ArrowDown",Io="Home",Gc="End",Ai="active",Vc="fade",No="show",Wc=".dropdown-toggle",Oo=`:not(${Wc})`,Xc='[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',Fo=`.nav-link${Oo}, .list-group-item${Oo}, [role="tab"]${Oo}, ${Xc}`,ef=`.${Ai}[data-bs-toggle="tab"], .${Ai}[data-bs-toggle="pill"], .${Ai}[data-bs-toggle="list"]`;class wi extends _e{constructor(c){super(c),this._parent=this._element.closest('.list-group, .nav, [role="tablist"]'),this._parent&&(this._setInitialAttributes(this._parent,this._getChildren()),U.on(this._element,Kd,p=>this._keydown(p)))}static get NAME(){return"tab"}show(){const c=this._element;if(this._elemIsActive(c))return;const p=this._getActiveElem(),S=p?U.trigger(p,Xd,{relatedTarget:c}):null;U.trigger(c,jd,{relatedTarget:p}).defaultPrevented||S&&S.defaultPrevented||(this._deactivate(p,c),this._activate(c,p))}_activate(c,p){c&&(c.classList.add(Ai),this._activate(ce.getElementFromSelector(c)),this._queueCallback(()=>{c.getAttribute("role")==="tab"?(c.removeAttribute("tabindex"),c.setAttribute("aria-selected",!0),this._toggleDropDown(c,!0),U.trigger(c,Yd,{relatedTarget:p})):c.classList.add(No)},c,c.classList.contains(Vc)))}_deactivate(c,p){c&&(c.classList.remove(Ai),c.blur(),this._deactivate(ce.getElementFromSelector(c)),this._queueCallback(()=>{c.getAttribute("role")==="tab"?(c.setAttribute("aria-selected",!1),c.setAttribute("tabindex","-1"),this._toggleDropDown(c,!1),U.trigger(c,qd,{relatedTarget:p})):c.classList.remove(No)},c,c.classList.contains(Vc)))}_keydown(c){if(![Jd,Hc,Qd,kc,Io,Gc].includes(c.key))return;c.stopPropagation(),c.preventDefault();const p=this._getChildren().filter(B=>!l(B));let S;if([Io,Gc].includes(c.key))S=p[c.key===Io?0:p.length-1];else{const B=[Hc,kc].includes(c.key);S=D(p,c.target,B,!0)}S&&(S.focus({preventScroll:!0}),wi.getOrCreateInstance(S).show())}_getChildren(){return ce.find(Fo,this._parent)}_getActiveElem(){return this._getChildren().find(c=>this._elemIsActive(c))||null}_setInitialAttributes(c,p){this._setAttributeIfNotExists(c,"role","tablist");for(const S of p)this._setInitialAttributesOnChild(S)}_setInitialAttributesOnChild(c){c=this._getInnerElement(c);const p=this._elemIsActive(c),S=this._getOuterElement(c);c.setAttribute("aria-selected",p),S!==c&&this._setAttributeIfNotExists(S,"role","presentation"),p||c.setAttribute("tabindex","-1"),this._setAttributeIfNotExists(c,"role","tab"),this._setInitialAttributesOnTargetPanel(c)}_setInitialAttributesOnTargetPanel(c){const p=ce.getElementFromSelector(c);p&&(this._setAttributeIfNotExists(p,"role","tabpanel"),c.id&&this._setAttributeIfNotExists(p,"aria-labelledby",`${c.id}`))}_toggleDropDown(c,p){const S=this._getOuterElement(c);if(!S.classList.contains("dropdown"))return;const B=(z,te)=>{const ae=ce.findOne(z,S);ae&&ae.classList.toggle(te,p)};B(Wc,Ai),B(".dropdown-menu",No),S.setAttribute("aria-expanded",p)}_setAttributeIfNotExists(c,p,S){c.hasAttribute(p)||c.setAttribute(p,S)}_elemIsActive(c){return c.classList.contains(Ai)}_getInnerElement(c){return c.matches(Fo)?c:ce.findOne(Fo,c)}_getOuterElement(c){return c.closest(".nav-item, .list-group-item")||c}static jQueryInterface(c){return this.each(function(){const p=wi.getOrCreateInstance(this);if(typeof c=="string"){if(p[c]===void 0||c.startsWith("_")||c==="constructor")throw new TypeError(`No method named "${c}"`);p[c]()}})}}U.on(document,$d,Xc,function(x){["A","AREA"].includes(this.tagName)&&x.preventDefault(),l(this)||wi.getOrCreateInstance(this).show()}),U.on(window,Zd,()=>{for(const x of ce.find(ef))wi.getOrCreateInstance(x)}),y(wi);const oi=".bs.toast",tf=`mouseover${oi}`,nf=`mouseout${oi}`,rf=`focusin${oi}`,sf=`focusout${oi}`,of=`hide${oi}`,af=`hidden${oi}`,cf=`show${oi}`,lf=`shown${oi}`,qc="hide",Ss="show",Es="showing",uf={animation:"boolean",autohide:"boolean",delay:"number"},hf={animation:!0,autohide:!0,delay:5e3};class Hr extends _e{constructor(c,p){super(c,p),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return hf}static get DefaultType(){return uf}static get NAME(){return"toast"}show(){U.trigger(this._element,cf).defaultPrevented||(this._clearTimeout(),this._config.animation&&this._element.classList.add("fade"),this._element.classList.remove(qc),d(this._element),this._element.classList.add(Ss,Es),this._queueCallback(()=>{this._element.classList.remove(Es),U.trigger(this._element,lf),this._maybeScheduleHide()},this._element,this._config.animation))}hide(){this.isShown()&&(U.trigger(this._element,of).defaultPrevented||(this._element.classList.add(Es),this._queueCallback(()=>{this._element.classList.add(qc),this._element.classList.remove(Es,Ss),U.trigger(this._element,af)},this._element,this._config.animation)))}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(Ss),super.dispose()}isShown(){return this._element.classList.contains(Ss)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout(()=>{this.hide()},this._config.delay)))}_onInteraction(c,p){switch(c.type){case"mouseover":case"mouseout":this._hasMouseInteraction=p;break;case"focusin":case"focusout":this._hasKeyboardInteraction=p}if(p)return void this._clearTimeout();const S=c.relatedTarget;this._element===S||this._element.contains(S)||this._maybeScheduleHide()}_setListeners(){U.on(this._element,tf,c=>this._onInteraction(c,!0)),U.on(this._element,nf,c=>this._onInteraction(c,!1)),U.on(this._element,rf,c=>this._onInteraction(c,!0)),U.on(this._element,sf,c=>this._onInteraction(c,!1))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(c){return this.each(function(){const p=Hr.getOrCreateInstance(this,c);if(typeof c=="string"){if(p[c]===void 0)throw new TypeError(`No method named "${c}"`);p[c](this)}})}}return Ue(Hr),y(Hr),{Alert:He,Button:yt,Carousel:it,Collapse:ii,Dropdown:En,Modal:Ei,Offcanvas:Vn,Popover:Ms,ScrollSpy:zr,Tab:wi,Toast:Hr,Tooltip:bi}});const Tr=[0,1,0],Ar=[0,0,1];function xr(i,e){return i[0]===e[0]&&i[1]===e[1]&&i[2]===e[2]}function Ef(i,e,t,n){return i*n*n+e*n+t}function ws(i,e){return i[0]*e[0]+i[1]*e[1]+i[2]*e[2]}function io(i,e){return[i[1]*e[2]-i[2]*e[1],i[2]*e[0]-i[0]*e[2],i[0]*e[1]-i[1]*e[0]]}function Go(i,e,t){const[n,r,s]=i,a=(t%360+360)%360,o=a===90?1:a===270?-1:0,l=a===0?1:a===180?-1:0,h=[[1,0,0,0,l,-o,0,o,l],[l,0,o,0,1,0,-o,0,l],[l,-o,0,o,l,0,0,0,1]][e];return[h[0]*n+h[1]*r+h[2]*s,h[3]*n+h[4]*r+h[5]*s,h[6]*n+h[7]*r+h[8]*s]}function sl(i,e,t){const[n,r,s]=t;if(r===1)return i;if(s===1)return e;if(n===-1)return io(e,i);if(n===1)return io(i,e);if(s===-1)return e.map(a=>-a);if(r===-1)return i.map(a=>-a);throw new Error("unreachable")}function Rs(i){const[e,t,n,r]=i;return[e,-t,n,r]}function ol(i,e){const t={R:[0,-90,-1],L:[0,90,1],U:[1,-90,-1],D:[1,90,1],F:[2,-90,-1],B:[2,90,1],M:[0,90,2],E:[1,90,2],S:[2,-90,2],x:[0,-90,0],y:[1,-90,0],z:[2,-90,0]},n=i.match(/^([0-9]+)?(-([0-9]+))?([A-Za-z])(w?)([0-9]+)?(')?$/);if(!n)throw`parse op [${i}] error`;let r=n[4],s=!1;(n[5]==="w"||"rludbfmes".indexOf(r)>=0)&&(r=r.toUpperCase(),s=!0);let a=0,o=1,l=n[1],u=n[3];u?(a=parseInt(l||"1")-1,o=parseInt(u)):s?(a=0,o=parseInt(l||"2")):(a=parseInt(l||"1")-1,o=a+1);const[h,d,f]=t[r],_=n[7]?-1:1,v=n[6]?parseInt(n[6]):1,y=d*_*v;let g=0,m=0;switch(f){case 1:g=a,m=o;break;case-1:m=e-a,g=e-o;break;case 0:g=0,m=e;break;case 2:{const D=s?e-2:1,T=(e-D)%2===1?D+1:D;g=(e-T)/2,m=g+T;break}}return[h,y,g,m]}function ro(i,e){let t=0,n=0;const r=[];for(;;){if(i[n]===" "||n>=i.length){const s=i.slice(t,n).trim();if(s.length>0&&r.push(ol(s,e)),n>=i.length)break;n++,t=n;continue}if(i[n]===","||i[n]===":"){const s=i.slice(t,n).trim();s.length>0&&r.push(ol(s,e));const a=ro(i.slice(n+1),e);return i[n]===","?[...r,...a,...r.reverse().map(Rs),...a.reverse().map(Rs)]:[...r,...a,...r.reverse().map(Rs)]}if(i[n]==="["||i[n]==="("){const s=i[n],a=i[n]==="["?"]":")";let o=1,l=n+1;for(;l<i.length&&(i[l]===s&&o++,i[l]===a&&o--,o!==0);)l++;let u=ro(i.slice(n+1,l),e);l++,l<i.length&&i[l]=="'"&&(l++,u=u.reverse().map(Rs));let h=1;if(l<i.length){let d=l;for(;d<i.length&&i[d]>="0"&&i[d]<="9";)d++;d>l&&(h=parseInt(i.slice(l,d))),l=d}for(let d=0;d<h;d++)r.push(...u);n=l,t=n;continue}n++}return r}function gr(i,e){return e.map(t=>t.opType==="commutator"?`(${gr(i,t.child1)}, ${gr(i,t.child2)})`:t.opType==="conjugate"?`(${gr(i,t.child1)}: ${gr(i,t.child2)})`:t.opType==="repeat"?`(${gr(i,t.child1)})${t.data}`:Xu(i,...t.op)).join(" ")}function ns(i){let e=0;for(const t of i)t.opType!=="simple"?(e+=ns(t.child1),e+=ns(t.child2)):e++;return e}function Ta(i,e){return i[0]===e[0]&&(i[1]+e[1])%360===0&&i[2]===e[2]&&i[3]===e[3]}function Vu(i,e){for(let t=0;t<i.length;t++)if(i[t]!==e[t])return!1;return!0}function bf(i,e){if(i.length!==e.length)return!1;for(let t=0;t<i.length;t++)if(!Vu(i[t],e[t]))return!1;return!0}function Tf(i,e){if(i.length%2===1)return!1;for(let t=0;t<e;t++)if(!Ta(i[t],i[i.length/2+e-1-t]))return!1;for(let t=e;t<i.length/2;t++)if(!Ta(i[t],i[i.length-1-(t-e)]))return!1;return!0}function Af(i,e){if(i.length%e!==0||e===1||e>i.length/2)return!1;const t=i.length/e;for(let n=0;n<e;n++){const r=i[n];for(let s=1;s<t;s++){const a=i[s*e+n];if(!Vu(r,a))return!1}}return!0}function wf(i){let e=0;for(;e<(i.length-1)/2&&Ta(i[e],i[i.length-1-e]);e++);return e}function Zn(i,e,t){if(e>i.maxDepth&&(i.maxDepth=e),t.length<=3||e>i.depthLimit)return t.map(o=>({opType:"simple",child1:[],child2:[],op:o,data:0}));const n=[];for(let o=2;o<=t.length/2;o++)Af(t,o)&&n.push([{opType:"repeat",child1:Zn(i,e+1,t.slice(0,o)),child2:[],op:[0,0,0,0],data:t.length/o}]);if(t.length%2===0)for(let o=1;o<=t.length/2-1;o++)Tf(t,o)&&n.push([{opType:"commutator",child1:Zn(i,e+1,t.slice(0,o)),child2:Zn(i,e+1,t.slice(o,t.length/2)),op:[0,0,0,0],data:0}]);let r=wf(t);r>1&&n.push([{opType:"conjugate",child1:Zn(i,e+1,t.slice(0,r)),child2:Zn(i,e+1,t.slice(r,t.length-r)),op:[0,0,0,0],data:0}]);for(let o=1;o<t.length;o++)n.push([...Zn(i,e+1,t.slice(0,t.length-o)),...Zn(i,e+1,t.slice(t.length-o))]);let s=-1,a=[];for(const o of n){const l=ns(o);(s===-1||l<s)&&(s=l,a=o)}return e===1&&console.log("cocandidates",n.length),a}function Rf(i,e,t){let n={depthLimit:e,maxDepth:0},r=Zn(n,1,t);const s=Wu(i,t);if(!bf(t,s)){const a=ns(r),o={depthLimit:e,maxDepth:0},l=Zn(o,1,s);ns(l)<a&&(r=l,n=o)}return{alg:gr(i,r),complete:n.maxDepth<=e}}function Wu(i,e){const t=[],n=r=>{const s=[],a=r[0][0];let o=-1,l=0;for(let u=0;u<i;u++){let h=0;for(const d of r){const[f,_,v,y]=d;u>=v&&u<y&&(h+=_)}h!==l&&(o>=0&&l!==0&&s.push([a,l,o,u]),o=u,l=h)}return o>=0&&l!==0&&s.push([a,l,o,i]),s};for(let r=0;r<e.length;){const s=e[r][0];let a=r+1;for(;a<e.length&&e[a][0]===s;a++);a===r+1?t.push(e[r]):t.push(...n(e.slice(r,a))),r=a}return t}function Xu(i,e,t,n,r){const s=(t/90%4+4)%4-2,a=l=>l===0?"2":l===1?"'":"";if(n===0&&r===i)return"xyz"[e].toLowerCase()+a(-s);const o="MES"[e];if(n*2===i-1&&r===n+1)return o+a(o==="S"?-s:s);if(n===1&&r===i-1)return o.toLowerCase()+a(o==="S"?-s:s);if(n+r>=i){const l="RUF"[e],u=i-r,h=i-n;return(h===1?"":h===u+1?`${u+1}`:`${u+1}-${h}`)+l+a(-s)}else{const l="LDB"[e],u=n,h=r;return(h===1?"":h===u+1?`${u+1}`:`${u+1}-${h}`)+l+a(s)}}function al(i,e){const t=[];for(const n of e){const[r,s,a,o]=n;s!==0&&t.push(Xu(i,r,s,a,o))}return t.join(" ")}function cl(i,e,t){const n=qu(i);for(const[r,s,a,o]of e)if(n.position[r]>=a&&n.position[r]<o){const[l,u,h]=n.position;n.F=Go(n.F,r,s),n.T=Go(n.T,r,s);const d=(t-1)/2,[f,_,v]=Go([l-d,u-d,h-d],r,s);n.position=[f+d,_+d,v+d]}return n}function ll(i,e){const[t,n,r]=e,s=(a,o,l,u,h,d,f,_)=>{const v=o*2===a-1,y=l*2===a-1,g=a===3?"":"-center";return o===0&&l===0?u+d+_:o===0&&l===a-1?u+d+h:o===a-1&&l===0?u+f+_:o===a-1&&l===a-1?u+f+h:o===0&&y?u+d+g:o===a-1&&y?u+f+g:l===0&&v?u+_+g:l===a-1&&v?u+h+g:v&&y?u+"-center":u+(o*2<a?o+1:o-a)+","+(l*2<a?l+1:l-a)};if(r===i-1)return s(i,t,n,"F","U","L","R","D");if(r===0)return s(i,i-1-t,n,"B","U","R","L","D");if(n===i-1)return s(i,t,i-1-r,"U","B","L","R","F");if(n===0)return s(i,t,r,"D","F","L","R","B");if(t===i-1)return s(i,i-1-r,n,"R","U","F","B","D");if(t===0)return s(i,r,n,"L","U","B","F","D")}function Cf(i,e){const t=io(Ar,i.F),n=io(Tr,i.T),r=i.position.reduce((s,a)=>s+(a===0||a===e-1?1:0),0);if(r===3){const s=i.position.map(o=>o===0?-1:1);return ws(n,s)<0?120:-120}else{if(r===2)return 180;if(ws(Ar,i.F)===-1||ws(Tr,i.T)===-1)return 180;{const s=(a,o,l)=>{const u=ws(a,o.map(h=>h===0?1:-1));if(u!==0)return u<0?-90:90};return s(t,i.position)||s(n,i.position)||0}}}function qu(i){return{F:[...i.F],T:[...i.T],position:[...i.position]}}function ul(i){const[e,t,n]=i;return{position:[e,t,n],T:Tr,F:Ar}}function Lf(i){let e=Tr,t=Ar;for(let n=1;;n++){for(const r of i)e=sl(r.nT,r.nF,e),t=sl(r.nT,r.nF,t);if(xr(e,Tr)&&xr(t,Ar))return n}}function Pf(i){const e=(r,s)=>{for(;s;){const a=s;s=r%s,r=a}return r},t=(r,s)=>r*s/e(r,s);let n=1;for(const r of i){const s=Lf(r);n=t(n,s*r.length)}return n}function Df(i,e=3,t=!1){let n=[];try{n=ro(i,e)}catch{i=i.replace(/([rludfbxyzmes])/ig," $1"),n=ro(i,e)}const r={},s=[],a=[],o=(l,u,h)=>{if(l*e*e+u*e+h in r)return;let f=cl(ul([l,u,h]),n,e);if(xr(f.position,[l,u,h]))(!xr(f.T,Tr)||!xr(f.F,Ar))&&(s.push({unit:qu(f),degree:Cf(f,e)}),a.push([{p1:f.position,p2:f.position,nT:f.T,nF:f.F}]));else{const _=[{p1:[l,u,h],p2:[...f.position],nT:f.T,nF:f.F}];for(;!xr(f.position,[l,u,h]);){r[Ef(...f.position,e)]=!0;const v=f.position;f=cl(ul(f.position),n,e),_.push({p1:v,p2:[...f.position],nT:f.T,nF:f.F})}a.push(_)}};if(t)for(let l=0;l<e;l++)for(let u=0;u<e;u++)for(let h=0;h<e;h++)o(l,u,h);else{for(let l=0;l<e;l++)for(let u=0;u<e;u++)o(l,u,0),o(l,u,e-1);for(let l=0;l<e;l++)for(let u=1;u<e-1;u++)o(l,0,u),o(l,e-1,u);for(let l=1;l<e-1;l++)for(let u=1;u<e-1;u++)o(0,l,u),o(e-1,l,u)}return{N:e,alg:i,regulatedAlg:al(e,n),simplifiedAlg:al(e,Wu(e,n)),ops:n,cycles:a.map(l=>l.map(u=>u.p1)).filter(l=>l.length>1),rotates:s,permutations:a,order:Pf(a)}}function Uf(i,e,t,n,r,s,a){const o=i.createLinearGradient(e,t,n,r);o.addColorStop(0,"rgba(255, 255, 255, 0)"),o.addColorStop(.2,s),o.addColorStop(1,s),i.strokeStyle=o;var l=n-e,u=r-t,h=Math.atan2(u,l);i.moveTo(e,t),i.lineTo(n,r),i.lineTo(n-a*Math.cos(h-Math.PI/6),r-a*Math.sin(h-Math.PI/6)),i.moveTo(n,r),i.lineTo(n-a*Math.cos(h+Math.PI/6),r-a*Math.sin(h+Math.PI/6))}function Cs(i,e,t,n,r){i.moveTo(e,t),i.lineTo(e-r*Math.cos(n-Math.PI/6),t-r*Math.sin(n-Math.PI/6)),i.moveTo(e,t),i.lineTo(e-r*Math.cos(n+Math.PI/6),t-r*Math.sin(n+Math.PI/6))}function If(i,e,t,n,r,s){const a=i.createLinearGradient(e,t-s,e,t+s);a.addColorStop(0,"rgba(255, 255, 255, 0)"),a.addColorStop(.2,r),a.addColorStop(1,r),i.strokeStyle=r;const o=s/2;n===180?(i.beginPath(),i.arc(e,t,s,-Math.PI*.3,Math.PI*.5,!1),Cs(i,e,t+s,-Math.PI*1.1,o),i.stroke(),i.beginPath(),i.arc(e,t,s,Math.PI*.7,Math.PI*1.5,!1),Cs(i,e,t-s,-Math.PI*.1,o),i.stroke()):n>0?(i.arc(e,t,s,-Math.PI/2,Math.PI,!1),Cs(i,e-s,t,-Math.PI*.6,o)):n<0&&(i.arc(e,t,s,-Math.PI/2,0,!0),Cs(i,e+s,t,-Math.PI*.4,o))}class ju{constructor(){ko(this,"palette",["rgb(0, 0, 255)","rgb(255, 0, 0)","rgb(0, 128, 0)","rgb(255, 0, 255)","rgb(0, 128, 255)","rgb(255, 128, 0)"]);ko(this,"index",0)}nextColor(){const e=this.palette[this.index];return this.index=(this.index+1)%this.palette.length,e}}function Yu(i,e){return i[0]*e[0]+i[1]*e[1]+i[2]*e[2]}function Nf(i){const e=Math.sqrt(Yu(i,i));return e===0?i:i.map(t=>t/e)}function so(i,e){return[i[1]*e[2]-i[2]*e[1],i[2]*e[0]-i[0]*e[2],i[0]*e[1]-i[1]*e[0]]}function hl(i,e){return i.map(t=>t*e)}function dl(i,e){return i.map((t,n)=>t+e[n])}function Of(i,e){return i.map((t,n)=>t-e[n])}function Ff(i){return Math.sqrt(Yu(i,i))}function Bf(i){const e=~~i.clientWidth,t=~~i.clientHeight,n=2;return i.width!==e*n||i.height!==t*n?(i.width=e*n,i.height=t*n,console.log("canvas resize",e,t),!0):!1}function zf(i){for(;i.firstChild;)i.removeChild(i.lastChild)}function Hf(...i){const e=[];console.log(i);for(let t=0;t+1<i.length;t+=2){const n=i[t].startsWith("*")?i[t].slice(1):i[t],r=!!i[t].startsWith("*"),s=i[t+1],a=document.createElement("span");a.style.color=n,r&&(a.style.fontWeight="700"),a.append(s),e.push(a)}return e}function Yr(i,e){const t=document.createElement(i);return e&&t.classList.add(...e.split(" ")),t}function un(i){return Yr("div",i)}const kf=`
[atom]
...
#endif`,ag="gl_FragColor = linearToOutputTexel( gl_FragColor );",cg=`vec4 LinearToLinear( in vec4 value ) {
	return value;
}
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:gi,depthTest:!1,depthWrite:!1})}function fu(){return new ki({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ka(),fragmentShader:`
		...
		`,blending:gi,depthTest:!1,depthWrite:!1})}function pu(){return new ki({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ka(),fragmentShader:`
	...
	`}function vv(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,u=l===wa||l===Ra,h=l===wr||l===Rr;if(u||h)if(o.isRenderTargetTexture&&o.needsPMREMUpdate===!0){o.needsPMREMUpdate=!1;let d=e.get(o);return t===null&&(t=new hu(i)),d=u?t.fromEquirectangular(o,d):t.fromCubemap(o,d),e.set(o,d),d.texture}else{if(e.has(o))return e.get(o).texture;{const d=o.image;if(u&&d&&d.height>0||h&&d&&r(d)){t===null&&(t=new hu(i));const f=u?t.fromEquirectangular(o):t.fromCubemap(o);return e.set(o,f),o.addEventListener("dispose",s),f.texture}else return null}}}return o}function r(o){let l=0;const u=6;for(let h=0;h<u;h++)o[h]!==void 0&&l++;return l===u}function s(o){const l=o.target;l.removeEventListener("dispose",s);const u=e.get(l);u!==void 0&&(e.delete(l),u.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function xv(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?t("EXT_color_buffer_float"):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const r=t(n);return r===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function yv(i,e,t,n){const r={},s=new WeakMap;function a(d){const f=d.target;f.index!==null&&e.remove(f.index);for(const v in f.attributes)e.remove(f.attributes[v]);for(const v in f.morphAttributes){const y=f.morphAttributes[v];for(let g=0,m=y.length;g<m;g++)e.remove(y[g])}f.removeEventListener("dispose",a),delete r[f.id];const _=s.get(f);_&&(e.remove(_),s.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(d,f){return r[f.id]===!0||(f.addEventListener("dispose",a),r[f.id]=!0,t.memory.geometries++),f}function l(d){const f=d.attributes;for(const v in f)e.update(f[v],i.ARRAY_BUFFER);const _=d.morphAttributes;for(const v in _){const y=_[v];for(let g=0,m=y.length;g<m;g++)e.update(y[g],i.ARRAY_BUFFER)}}function u(d){const f=[],_=d.index,v=d.attributes.position;let y=0;if(_!==null){const D=_.array;y=_.version;for(let T=0,C=D.length;T<C;T+=3){const E=D[T+0],L=D[T+1],w=D[T+2];f.push(E,L,L,w,w,E)}}else if(v!==void 0){const D=v.array;y=v.version;for(let T=0,C=D.length/3-1;T<C;T+=3){const E=T+0,L=T+1,w=T+2;f.push(E,L,L,w,w,E)}}else return;const g=new(ah(f)?ph:fh)(f,1);g.version=y;const m=s.get(d);m&&e.remove(m),s.set(d,g)}function h(d){const f=s.get(d);if(f){const _=d.index;_!==null&&f.version<_.version&&u(d)}else u(d);return s.get(d)}return{get:o,update:l,getWireframeAttribute:h}}function Mv(i,e,t,n){const r=n.isWebGL2;let s;function a(f){s=f}let o,l;function u(f){o=f.type,l=f.bytesPerElement}function h(f,_){i.drawElements(s,_,o,f*l),t.update(_,s,1)}function d(f,_,v){if(v===0)return;let y,g;if(r)y=i,g="drawElementsInstanced";else if(y=e.get("ANGLE_instanced_arrays"),g="drawElementsInstancedANGLE",y===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}y[g](s,_,o,f*l,v),t.update(_,s,v)}this.setMode=a,this.setIndex=u,this.render=h,this.renderInstances=d}function Sv(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Ev(i,e){return i[0]-e[0]}function bv(i,e){return Math.abs(e[1])-Math.abs(i[1])}function Tv(i,e,t){const n={},r=new Float32Array(8),s=new WeakMap,a=new Ht,o=[];for(let u=0;u<8;u++)o[u]=[u,0];function l(u,h,d){const f=u.morphTargetInfluences;if(e.isWebGL2===!0){const v=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,y=v!==void 0?v.length:0;let g=s.get(h);if(g===void 0||g.count!==y){let $=function(){H.dispose(),s.delete(h),h.removeEventListener("dispose",$)};var _=$;g!==void 0&&g.texture.dispose();const T=h.morphAttributes.position!==void 0,C=h.morphAttributes.normal!==void 0,E=h.morphAttributes.color!==void 0,L=h.morphAttributes.position||[],w=h.morphAttributes.normal||[],N=h.morphAttributes.color||[];let M=0;T===!0&&(M=1),C===!0&&(M=2),E===!0&&(M=3);let A=h.attributes.position.count*M,V=1;A>e.maxTextureSize&&(V=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const Q=new Float32Array(A*V*4*y),H=new uh(Q,A,V,y);H.type=mi,H.needsUpdate=!0;const Y=M*4;for(let re=0;re<y;re++){const k=L[re],U=w[re],se=N[re],ie=A*V*4*re;for(let q=0;q<k.count;q++){const ee=q*Y;T===!0&&(a.fromBufferAttribute(k,q),Q[ie+ee+0]=a.x,Q[ie+ee+1]=a.y,Q[ie+ee+2]=a.z,Q[ie+ee+3]=0),C===!0&&(a.fromBufferAttribute(U,q),Q[ie+ee+4]=a.x,Q[ie+ee+5]=a.y,Q[ie+ee+6]=a.z,Q[ie+ee+7]=0),E===!0&&(a.fromBufferAttribute(se,q),Q[ie+ee+8]=a.x,Q[ie+ee+9]=a.y,Q[ie+ee+10]=a.z,Q[ie+ee+11]=se.itemSize===4?a.w:1)}}g={count:y,texture:H,size:new Re(A,V)},s.set(h,g),h.addEventListener("dispose",$)}let m=0;for(let T=0;T<f.length;T++)m+=f[T];const D=h.morphTargetsRelative?1:1-m;d.getUniforms().setValue(i,"morphTargetBaseInfluence",D),d.getUniforms().setValue(i,"morphTargetInfluences",f),d.getUniforms().setValue(i,"morphTargetsTexture",g.texture,t),d.getUniforms().setValue(i,"morphTargetsTextureSize",g.size)}else{const v=f===void 0?0:f.length;let y=n[h.id];if(y===void 0||y.length!==v){y=[];for(let C=0;C<v;C++)y[C]=[C,0];n[h.id]=y}for(let C=0;C<v;C++){const E=y[C];E[0]=C,E[1]=f[C]}y.sort(bv);for(let C=0;C<8;C++)C<v&&y[C][1]?(o[C][0]=y[C][0],o[C][1]=y[C][1]):(o[C][0]=Number.MAX_SAFE_INTEGER,o[C][1]=0);o.sort(Ev);const g=h.morphAttributes.position,m=h.morphAttributes.normal;let D=0;for(let C=0;C<8;C++){const E=o[C],L=E[0],w=E[1];L!==Number.MAX_SAFE_INTEGER&&w?(g&&h.getAttribute("morphTarget"+C)!==g[L]&&h.setAttribute("morphTarget"+C,g[L]),m&&h.getAttribute("morphNormal"+C)!==m[L]&&h.setAttribute("morphNormal"+C,m[L]),r[C]=w,D+=w):(g&&h.hasAttribute("morphTarget"+C)===!0&&h.deleteAttribute("morphTarget"+C),m&&h.hasAttribute("morphNormal"+C)===!0&&h.deleteAttribute("morphNormal"+C),r[C]=0)}const T=h.morphTargetsRelative?1:1-D;d.getUniforms().setValue(i,"morphTargetBaseInfluence",T),d.getUniforms().setValue(i,"morphTargetInfluences",r)}}return{update:l}}function Av(i,e,t,n){let r=new WeakMap;function s(l){const u=n.render.frame,h=l.geometry,d=e.get(l,h);if(r.get(d)!==u&&(e.update(d),r.set(d,u)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==u&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,u))),l.isSkinnedMesh){const f=l.skeleton;r.get(f)!==u&&(f.update(),r.set(f,u))}return d}function a(){r=new WeakMap}function o(l){const u=l.target;u.removeEventListener("dispose",o),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:s,dispose:a}}const yh=new on,Mh=new uh,Sh=new dm,Eh=new _h,mu=[],gu=[],_u=new Float32Array(16),vu=new Float32Array(9),xu=new Float32Array(4);function Ur(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=mu[r];if(s===void 0&&(s=new Float32Array(r),mu[r]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(s,o)}return s}function Nt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Ot(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function po(i,e){let t=gu[e];t===void 0&&(t=new Int32Array(e),gu[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function wv(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Rv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Nt(t,e))return;i.uniform2fv(this.addr,e),Ot(t,e)}}function Cv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Nt(t,e))return;i.uniform3fv(this.addr,e),Ot(t,e)}}function Lv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Nt(t,e))return;i.uniform4fv(this.addr,e),Ot(t,e)}}function Pv(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Nt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Ot(t,e)}else{if(Nt(t,n))return;xu.set(n),i.uniformMatrix2fv(this.addr,!1,xu),Ot(t,n)}}function Dv(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Nt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Ot(t,e)}else{if(Nt(t,n))return;vu.set(n),i.uniformMatrix3fv(this.addr,!1,vu),Ot(t,n)}}function Uv(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Nt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Ot(t,e)}else{if(Nt(t,n))return;_u.set(n),i.uniformMatrix4fv(this.addr,!1,_u),Ot(t,n)}}function Iv(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Nv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Nt(t,e))return;i.uniform2iv(this.addr,e),Ot(t,e)}}function Ov(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Nt(t,e))return;i.uniform3iv(this.addr,e),Ot(t,e)}}function Fv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Nt(t,e))return;i.uniform4iv(this.addr,e),Ot(t,e)}}function Bv(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function zv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Nt(t,e))return;i.uniform2uiv(this.addr,e),Ot(t,e)}}function Hv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Nt(t,e))return;i.uniform3uiv(this.addr,e),Ot(t,e)}}function kv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Nt(t,e))return;i.uniform4uiv(this.addr,e),Ot(t,e)}}function Gv(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2D(e||yh,r)}function Vv(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Sh,r)}function Wv(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Eh,r)}function Xv(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||Mh,r)}function qv(i){switch(i){case 5126:return wv;case 35664:return Rv;case 35665:return Cv;case 35666:return Lv;case 35674:return Pv;case 35675:return Dv;case 35676:return Uv;case 5124:case 35670:return Iv;case 35667:case 35671:return Nv;case 35668:case 35672:return Ov;case 35669:case 35673:return Fv;case 5125:return Bv;case 36294:return zv;case 36295:return Hv;case 36296:return kv;case 35678:case 36198:case 36298:case 36306:case 35682:return Gv;case 35679:case 36299:case 36307:return Vv;case 35680:case 36300:case 36308:case 36293:return Wv;case 36289:case 36303:case 36311:case 36292:return Xv}}function jv(i,e){i.uniform1fv(this.addr,e)}function Yv(i,e){const t=Ur(e,this.size,2);i.uniform2fv(this.addr,t)}function $v(i,e){const t=Ur(e,this.size,3);i.uniform3fv(this.addr,t)}function Kv(i,e){const t=Ur(e,this.size,4);i.uniform4fv(this.addr,t)}function Zv(i,e){const t=Ur(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Jv(i,e){const t=Ur(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Qv(i,e){const t=Ur(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function e0(i,e){i.uniform1iv(this.addr,e)}function t0(i,e){i.uniform2iv(this.addr,e)}function n0(i,e){i.uniform3iv(this.addr,e)}function i0(i,e){i.uniform4iv(this.addr,e)}function r0(i,e){i.uniform1uiv(this.addr,e)}function s0(i,e){i.uniform2uiv(this.addr,e)}function o0(i,e){i.uniform3uiv(this.addr,e)}function a0(i,e){i.uniform4uiv(this.addr,e)}function c0(i,e,t){const n=this.cache,r=e.length,s=po(t,r);Nt(n,s)||(i.uniform1iv(this.addr,s),Ot(n,s));for(let a=0;a!==r;++a)t.setTexture2D(e[a]||yh,s[a])}function l0(i,e,t){const n=this.cache,r=e.length,s=po(t,r);Nt(n,s)||(i.uniform1iv(this.addr,s),Ot(n,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||Sh,s[a])}function u0(i,e,t){const n=this.cache,r=e.length,s=po(t,r);Nt(n,s)||(i.uniform1iv(this.addr,s),Ot(n,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||Eh,s[a])}function h0(i,e,t){const n=this.cache,r=e.length,s=po(t,r);Nt(n,s)||(i.uniform1iv(this.addr,s),Ot(n,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||Mh,s[a])}function d0(i){switch(i){case 5126:return jv;case 35664:return Yv;case 35665:return $v;case 35666:return Kv;case 35674:return Zv;case 35675:return Jv;case 35676:return Qv;case 5124:case 35670:return e0;case 35667:case 35671:return t0;case 35668:case 35672:return n0;case 35669:case 35673:return i0;case 5125:return r0;case 36294:return s0;case 36295:return o0;case 36296:return a0;case 35678:case 36198:case 36298:case 36306:case 35682:return c0;case 35679:case 36299:case 36307:return l0;case 35680:case 36300:case 36308:case 36293:return u0;case 36289:case 36303:case 36311:case 36292:return h0}}class f0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.setValue=qv(t.type)}}class p0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.size=t.size,this.setValue=d0(t.type)}}class m0{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],n)}}}const ma=/(\w+)(\])?(\[|\.)?/g;function yu(i,e){i.seq.push(e),i.map[e.id]=e}function g0(i,e,t){const n=i.name,r=n.length;for(ma.lastIndex=0;;){const s=ma.exec(n),a=ma.lastIndex;let o=s[1];const l=s[2]==="]",u=s[3];if(l&&(o=o|0),u===void 0||u==="["&&a+2===r){yu(t,u===void 0?new f0(o,i,e):new p0(o,i,e));break}else{let d=t.map[o];d===void 0&&(d=new m0(o),yu(t,d)),t=d}}}class to{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),a=e.getUniformLocation(t,s.name);g0(s,a,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&n.push(a)}return n}}function Mu(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}let _0=0;function v0(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}function x0(i){switch(i){case zn:return["Linear","( value )"];case Et:return["sRGB","( value )"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),["Linear","( value )"]}}function Su(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+v0(i.getShaderSource(e),a)}else return r}function y0(i,e){const t=x0(e);return"vec4 "+i+"( vec4 value ) { return LinearTo"+t[0]+t[1]+"; }"}function M0(i,e){let t;switch(e){case fp:t="Linear";break;case pp:t="Reinhard";break;case mp:t="OptimizedCineon";break;case gp:t="ACESFilmic";break;case _p:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function S0(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Xr).join(`
`)}function E0(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function b0(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Xr(i){return i!==""}function Eu(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function bu(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const T0=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ua(i){return i.replace(T0,w0)}const A0=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function w0(i,e){let t=Je[e];if(t===void 0){const n=A0.get(e);if(n!==void 0)t=Je[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Ua(t)}const R0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Tu(i){return i.replace(R0,C0)}function C0(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Au(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function L0(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===$u?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Xf?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Kn&&(e="SHADOWMAP_TYPE_VSM"),e}function P0(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case wr:case Rr:e="ENVMAP_TYPE_CUBE";break;case lo:e="ENVMAP_TYPE_CUBE_UV";break}return e}function D0(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Rr:e="ENVMAP_MODE_REFRACTION";break}return e}function U0(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ju:e="ENVMAP_BLENDING_MULTIPLY";break;case hp:e="ENVMAP_BLENDING_MIX";break;case dp:e="ENVMAP_BLENDING_ADD";break}return e}function I0(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function N0(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=L0(t),u=P0(t),h=D0(t),d=U0(t),f=I0(t),_=t.isWebGL2?"":S0(t),v=E0(s),y=r.createProgram();let g,m,D=t.glslVersion?"#version "+t.glslVersion+`
